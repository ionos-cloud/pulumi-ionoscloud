...
func GetApplicationLoadbalancerOutput(ctx *pulumi.Context, args GetApplicationLoadbalancerOutputArgs, opts ...pulumi.InvokeOption) GetApplicationLoadbalancerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetApplicationLoadbalancerResultOutput, error) {
			args := v.(GetApplicationLoadbalancerArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("ionoscloud:index/getApplicationLoadbalancer:getApplicationLoadbalancer", args, GetApplicationLoadbalancerResultOutput{}, options).(GetApplicationLoadbalancerResultOutput), nil
