...
func (o GetNodePoolNodesResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetNodePoolNodesResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
