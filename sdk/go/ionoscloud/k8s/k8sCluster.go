...
//			_, err := k8s.NewK8sCluster(ctx, "example", &k8s.K8sClusterArgs{
...
//
// ```sh
// $ pulumi import ionoscloud:k8s/k8sCluster:K8sCluster demo {k8s_cluster uuid}
// ```
//
...
func NewK8sCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("ionoscloud:index/k8sCluster:K8sCluster"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource K8sCluster
	err := ctx.RegisterResource("ionoscloud:k8s/k8sCluster:K8sCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetK8sCluster(ctx *pulumi.Context,
	...
	var resource K8sCluster
	err := ctx.ReadResource("ionoscloud:k8s/k8sCluster:K8sCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
