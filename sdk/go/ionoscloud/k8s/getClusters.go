...
func (o GetClustersResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetClustersResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
