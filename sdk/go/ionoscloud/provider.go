...
func NewProvider(ctx *pulumi.Context,
	...
	if args.S3SecretKey != nil {
		args.S3SecretKey = pulumi.ToSecret(args.S3SecretKey).(pulumi.StringPtrInput)
	}
	if args.Token != nil {
...
func (r *Provider) TerraformConfig(ctx *pulumi.Context) (ProviderTerraformConfigResultOutput, error) {
	out, err := ctx.Call("pulumi:providers:ionoscloud/terraformConfig", nil, ProviderTerraformConfigResultOutput{}, r)
	if err != nil {
