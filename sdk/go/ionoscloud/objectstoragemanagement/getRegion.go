...
func GetRegion(ctx *pulumi.Context, args *GetRegionArgs, opts ...pulumi.InvokeOption) (*GetRegionResult, error) {
	...
	err := ctx.Invoke("ionoscloud:objectstoragemanagement/getRegion:getRegion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetRegionOutput(ctx *pulumi.Context, args GetRegionOutputArgs, opts ...pulumi.InvokeOption) GetRegionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetRegionResultOutput, error) {
			...
			return ctx.InvokeOutput("ionoscloud:objectstoragemanagement/getRegion:getRegion", args, GetRegionResultOutput{}, options).(GetRegionResultOutput), nil
...
// The version of the region properties
func (o GetRegionResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v GetRegionResult) int { return v.Version }).(pulumi.IntOutput)
}
