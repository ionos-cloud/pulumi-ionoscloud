...
// The location of the resource. This field should be used only if you are also using a file configuration and should not be configured otherwise.
func (o DatacenterNsgSelectionOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DatacenterNsgSelection) pulumi.StringPtrOutput { return v.Location }).(pulumi.StringPtrOutput)
}
