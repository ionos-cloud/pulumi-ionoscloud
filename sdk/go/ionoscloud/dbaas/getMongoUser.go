...
func (o LookupMongoUserResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupMongoUserResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
