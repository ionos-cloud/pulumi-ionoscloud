...
// The location of the resource. This field should be used only if you are also using a file configuration and should not be configured otherwise.
func (o CrossconnectOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Crossconnect) pulumi.StringPtrOutput { return v.Location }).(pulumi.StringPtrOutput)
}
