...
func (o IPFailoverOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IPFailover) pulumi.StringPtrOutput { return v.Location }).(pulumi.StringPtrOutput)
}
