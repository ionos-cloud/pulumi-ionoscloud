...
type LookupGroupOutputArgs struct {
	...
	//
	// Either `name` or `id` must be provided. If none, or both are provided, the datasource will return an error.
	GetUsersData pulumi.BoolPtrInput `pulumi:"getUsersData"`
	// ID of the group you want to search for.
...
func (o LookupGroupResultOutput) GetUsersData() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupGroupResult) *bool { return v.GetUsersData }).(pulumi.BoolPtrOutput)
}
