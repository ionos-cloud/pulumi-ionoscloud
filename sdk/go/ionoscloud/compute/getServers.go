...
func GetServers(ctx *pulumi.Context, args *GetServersArgs, opts ...pulumi.InvokeOption) (*GetServersResult, error) {
	...
	err := ctx.Invoke("ionoscloud:compute/getServers:getServers", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetServersOutput(ctx *pulumi.Context, args GetServersOutputArgs, opts ...pulumi.InvokeOption) GetServersResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetServersResultOutput, error) {
			...
			return ctx.InvokeOutput("ionoscloud:compute/getServers:getServers", args, GetServersResultOutput{}, options).(GetServersResultOutput), nil
...
func (o GetServersResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetServersResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
