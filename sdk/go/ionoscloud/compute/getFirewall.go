...
func (o LookupFirewallResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFirewallResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
