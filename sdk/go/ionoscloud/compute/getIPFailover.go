...
func (o LookupIPFailoverResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupIPFailoverResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
