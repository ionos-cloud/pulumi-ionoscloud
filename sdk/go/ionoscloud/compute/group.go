...
type Group struct {
	...
	GetUsersData pulumi.BoolPtrOutput `pulumi:"getUsersData"`
...
type groupState struct {
	...
	// [Boolean] When set to true, information about users will be stored in state under `users` attribute, default value is `true`.
	GetUsersData *bool `pulumi:"getUsersData"`
	// [Boolean]  The group will be allowed to access and manage the Data Platform.
...
type GroupState struct {
	...
	// [Boolean] When set to true, information about users will be stored in state under `users` attribute, default value is `true`.
	GetUsersData pulumi.BoolPtrInput
	// [Boolean]  The group will be allowed to access and manage the Data Platform.
...
// [Boolean] When set to true, information about users will be stored in state under `users` attribute, default value is `true`.
func (o GroupOutput) GetUsersData() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.BoolPtrOutput { return v.GetUsersData }).(pulumi.BoolPtrOutput)
}
