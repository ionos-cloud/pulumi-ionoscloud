...
func (o LookupNatGatewayRuleResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupNatGatewayRuleResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
