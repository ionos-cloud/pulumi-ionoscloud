...
type GetTemplateArgs struct {
	...
	Gpuses []GetTemplateGpus `pulumi:"gpuses"`
...
type GetTemplateOutputArgs struct {
	...
	// List of GPUs in the template
	Gpuses GetTemplateGpusArrayInput `pulumi:"gpuses"`
	// A name of that resource.
...
// The category of the template
func (o GetTemplateResultOutput) Category() pulumi.StringOutput {
	return o.ApplyT(func(v GetTemplateResult) string { return v.Category }).(pulumi.StringOutput)
}
...
// List of GPUs in the template
func (o GetTemplateResultOutput) Gpuses() GetTemplateGpusArrayOutput {
	return o.ApplyT(func(v GetTemplateResult) []GetTemplateGpus { return v.Gpuses }).(GetTemplateGpusArrayOutput)
}
