...
// The location of the resource. This field should be used only if you are also using a file configuration and should not be configured otherwise.
func (o BootDeviceSelectionOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *BootDeviceSelection) pulumi.StringPtrOutput { return v.Location }).(pulumi.StringPtrOutput)
}
