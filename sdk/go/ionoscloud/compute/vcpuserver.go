...
// The location of the resource. This field should be used only if you are also using a file configuration and should not be configured otherwise.
func (o VCPUServerOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VCPUServer) pulumi.StringPtrOutput { return v.Location }).(pulumi.StringPtrOutput)
}
...
// >
// > sshKeys field is immutable.
func (o VCPUServerOutput) NicMultiQueue() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *VCPUServer) pulumi.BoolPtrOutput { return v.NicMultiQueue }).(pulumi.BoolPtrOutput)
}
