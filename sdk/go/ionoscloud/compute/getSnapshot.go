...
// Indicates if the image requires the legacy BIOS for compatibility or specific needs.
func (o LookupSnapshotResultOutput) RequireLegacyBios() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupSnapshotResult) bool { return v.RequireLegacyBios }).(pulumi.BoolOutput)
}
