...
// Location of that image/snapshot
func (o LookupCubeServerResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupCubeServerResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
