...
func NewBucketLifecycleConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ionoscloud:objectstorage/bucketLifecycleConfiguration:BucketLifecycleConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketLifecycleConfiguration(ctx *pulumi.Context,
	...
	var resource BucketLifecycleConfiguration
	err := ctx.ReadResource("ionoscloud:objectstorage/bucketLifecycleConfiguration:BucketLifecycleConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
