...
func NewMonitoringPipeline(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ionoscloud:objectstorage/monitoringPipeline:MonitoringPipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringPipeline(ctx *pulumi.Context,
	...
	var resource MonitoringPipeline
	err := ctx.ReadResource("ionoscloud:objectstorage/monitoringPipeline:MonitoringPipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
