...
type BucketVersioning struct {
	...
	VersioningConfiguration BucketVersioningVersioningConfigurationPtrOutput `pulumi:"versioningConfiguration"`
}
...
func NewBucketVersioning(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ionoscloud:objectstorage/bucketVersioning:BucketVersioning", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketVersioning(ctx *pulumi.Context,
	...
	var resource BucketVersioning
	err := ctx.ReadResource("ionoscloud:objectstorage/bucketVersioning:BucketVersioning", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// [block] A block of versioningConfiguration as defined below.
func (o BucketVersioningOutput) VersioningConfiguration() BucketVersioningVersioningConfigurationPtrOutput {
	return o.ApplyT(func(v *BucketVersioning) BucketVersioningVersioningConfigurationPtrOutput {
