...
//				return err
//			}
//			exampleApplicationLoadbalancer, err := alb.NewApplicationLoadbalancer(ctx, "exampleApplicationLoadbalancer", &alb.ApplicationLoadbalancerArgs{
//				DatacenterId: exampleDatacenter.ID(),
...
//				return err
//			}
//			_, err = alb.NewApplicationLoadbalancerForwardingrule(ctx, "exampleApplicationLoadbalancerForwardingrule", &alb.ApplicationLoadbalancerForwardingruleArgs{
//				DatacenterId:              exampleDatacenter.ID(),
...
//				HttpRules: alb.ApplicationLoadbalancerForwardingruleHttpRuleArray{
//					&alb.ApplicationLoadbalancerForwardingruleHttpRuleArgs{
//						Name:       pulumi.String("http_rule"),
//						Type:       pulumi.String("REDIRECT"),
//						DropQuery:  pulumi.Bool(true),
//						Location:   pulumi.String("www.ionos.com"),
//						StatusCode: pulumi.Int(301),
//						Conditions: alb.ApplicationLoadbalancerForwardingruleHttpRuleConditionArray{
//							&alb.ApplicationLoadbalancerForwardingruleHttpRuleConditionArgs{
...
func NewApplicationLoadbalancerForwardingrule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ionoscloud:alb/applicationLoadbalancerForwardingrule:ApplicationLoadbalancerForwardingrule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationLoadbalancerForwardingrule(ctx *pulumi.Context,
	...
	var resource ApplicationLoadbalancerForwardingrule
	err := ctx.ReadResource("ionoscloud:alb/applicationLoadbalancerForwardingrule:ApplicationLoadbalancerForwardingrule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
