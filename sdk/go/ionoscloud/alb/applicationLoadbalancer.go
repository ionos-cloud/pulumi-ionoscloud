...
//				return err
//			}
//			_, err = alb.NewApplicationLoadbalancer(ctx, "exampleApplicationLoadbalancer", &alb.ApplicationLoadbalancerArgs{
//				DatacenterId: exampleDatacenter.ID(),
...
func NewApplicationLoadbalancer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ionoscloud:alb/applicationLoadbalancer:ApplicationLoadbalancer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationLoadbalancer(ctx *pulumi.Context,
	...
	var resource ApplicationLoadbalancer
	err := ctx.ReadResource("ionoscloud:alb/applicationLoadbalancer:ApplicationLoadbalancer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
