...
namespace Pulumi.Ionoscloud
{
    public static class GetCubeServer
    {
        ...
        public static Task<GetCubeServerResult> InvokeAsync(GetCubeServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCubeServerResult>("ionoscloud:index/getCubeServer:getCubeServer", args ?? new GetCubeServerArgs(), options.WithDefaults());
