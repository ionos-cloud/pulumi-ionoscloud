...
namespace Pulumi.Ionoscloud
{
    ...
    /// ```
    /// </summary>
    [IonoscloudResourceType("ionoscloud:index/snapshot:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("ionoscloud:index/snapshot:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, SnapshotState? state = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/snapshot:Snapshot", name, state, MakeResourceOptions(options, id))
        {
        }
