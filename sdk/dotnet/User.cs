...
namespace Pulumi.Ionoscloud
{
    ...
    /// ```
    /// </summary>
    [IonoscloudResourceType("ionoscloud:index/user:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("ionoscloud:index/user:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, UserState? state = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/user:User", name, state, MakeResourceOptions(options, id))
        {
        }
