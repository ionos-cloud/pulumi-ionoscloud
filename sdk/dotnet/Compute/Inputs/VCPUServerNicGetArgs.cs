...
namespace Pulumi.Ionoscloud.Compute.Inputs
{
    ...
    public sealed class VCPUServerNicGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("deviceNumber")]
        ...
        [Input("firewalls")]
        private InputList<Inputs.VCPUServerNicFirewallGetArgs>? _firewalls;

        /// <summary>
        /// Allows to define firewall rules inline in the server. See the Firewall section.
        /// </summary>
        public InputList<Inputs.VCPUServerNicFirewallGetArgs> Firewalls
        {
            get => _firewalls ?? (_firewalls = new InputList<Inputs.VCPUServerNicFirewallGetArgs>());
        ...
        public VCPUServerNicGetArgs()
        {
        }
        public static new VCPUServerNicGetArgs Empty => new VCPUServerNicGetArgs();
    }
}
