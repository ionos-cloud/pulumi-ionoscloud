...
namespace Pulumi.Ionoscloud.Compute.Inputs
{
    ...
    public sealed class ServerNicGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("deviceNumber")]
        ...
        [Input("firewalls")]
        private InputList<Inputs.ServerNicFirewallGetArgs>? _firewalls;

        /// <summary>
        /// Allows to define firewall rules inline in the server. See the Firewall section.
        /// </summary>
        public InputList<Inputs.ServerNicFirewallGetArgs> Firewalls
        {
            get => _firewalls ?? (_firewalls = new InputList<Inputs.ServerNicFirewallGetArgs>());
        ...
        public ServerNicGetArgs()
        {
        }
        public static new ServerNicGetArgs Empty => new ServerNicGetArgs();
    }
}
