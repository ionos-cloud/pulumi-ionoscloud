...
namespace Pulumi.Ionoscloud.Alb.Inputs
{
    ...
    public sealed class ForwardingRuleHttpRuleArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Inputs.ForwardingRuleHttpRuleConditionArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Inputs.ForwardingRuleHttpRuleConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.ForwardingRuleHttpRuleConditionArgs>());
        ...
        public ForwardingRuleHttpRuleArgs()
        {
        }
        public static new ForwardingRuleHttpRuleArgs Empty => new ForwardingRuleHttpRuleArgs();
    }
}
