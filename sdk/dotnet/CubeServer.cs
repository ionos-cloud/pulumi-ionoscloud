...
namespace Pulumi.Ionoscloud
{
    ...
    /// ```
    /// </summary>
    [IonoscloudResourceType("ionoscloud:index/cubeServer:CubeServer")]
    public partial class CubeServer : global::Pulumi.CustomResource
    {
        ...
        public CubeServer(string name, CubeServerArgs args, CustomResourceOptions? options = null)
            : base("ionoscloud:index/cubeServer:CubeServer", name, args ?? new CubeServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CubeServer(string name, Input<string> id, CubeServerState? state = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/cubeServer:CubeServer", name, state, MakeResourceOptions(options, id))
        {
        }
