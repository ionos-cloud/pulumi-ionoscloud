...
namespace Pulumi.Ionoscloud.Outputs
{
    ...
    [OutputType]
    public sealed class GetNetworkloadbalancerForwardingruleTargetResult
    {
        /// <summary>
        /// Health check attributes for Network Load Balancer forwarding rule target.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetNetworkloadbalancerForwardingruleTargetHealthCheckResult> HealthChecks;
        /// <summary>
        ...
        [OutputConstructor]
        private GetNetworkloadbalancerForwardingruleTargetResult(
            ImmutableArray<Outputs.GetNetworkloadbalancerForwardingruleTargetHealthCheckResult> healthChecks,
