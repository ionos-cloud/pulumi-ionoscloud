...
namespace Pulumi.Ionoscloud.Outputs
{
    ...
    [OutputType]
    public sealed class GetLoggingPipelineLogResult
    {
        /// <summary>
        /// [list] The configuration of the logs datastore, a list that contains elements with the following structure:
        /// </summary>
        public readonly ImmutableArray<Outputs.GetLoggingPipelineLogDestinationResult> Destinations;
        /// <summary>
        ...
        [OutputConstructor]
        private GetLoggingPipelineLogResult(
            ImmutableArray<Outputs.GetLoggingPipelineLogDestinationResult> destinations,
