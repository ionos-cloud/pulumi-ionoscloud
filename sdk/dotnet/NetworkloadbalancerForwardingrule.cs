...
namespace Pulumi.Ionoscloud
{
    ...
    /// ```
    /// </summary>
    [IonoscloudResourceType("ionoscloud:index/networkloadbalancerForwardingrule:NetworkloadbalancerForwardingrule")]
    public partial class NetworkloadbalancerForwardingrule : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("targets")]
        public Output<ImmutableArray<Outputs.NetworkloadbalancerForwardingruleTarget>> Targets { get; private set; } = null!;
        ...
        public NetworkloadbalancerForwardingrule(string name, NetworkloadbalancerForwardingruleArgs args, CustomResourceOptions? options = null)
            : base("ionoscloud:index/networkloadbalancerForwardingrule:NetworkloadbalancerForwardingrule", name, args ?? new NetworkloadbalancerForwardingruleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkloadbalancerForwardingrule(string name, Input<string> id, NetworkloadbalancerForwardingruleState? state = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/networkloadbalancerForwardingrule:NetworkloadbalancerForwardingrule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkloadbalancerForwardingrule Get(string name, Input<string> id, NetworkloadbalancerForwardingruleState? state = null, CustomResourceOptions? options = null)
        {
            return new NetworkloadbalancerForwardingrule(name, id, state, options);
        }
    }

    public sealed class NetworkloadbalancerForwardingruleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// [string] Algorithm for the balancing.
        /// </summary>
        ...
        private InputList<Inputs.NetworkloadbalancerForwardingruleTargetArgs>? _targets;

        /// <summary>
        /// [Set] Array of items in that collection.
        /// </summary>
        public InputList<Inputs.NetworkloadbalancerForwardingruleTargetArgs> Targets
        {
            get => _targets ?? (_targets = new InputList<Inputs.NetworkloadbalancerForwardingruleTargetArgs>());
            set => _targets = value;
        }

        public NetworkloadbalancerForwardingruleArgs()
        {
        }
        public static new NetworkloadbalancerForwardingruleArgs Empty => new NetworkloadbalancerForwardingruleArgs();
    }

    public sealed class NetworkloadbalancerForwardingruleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// [string] Algorithm for the balancing.
        /// </summary>
        ...
        [Input("targets")]
        private InputList<Inputs.NetworkloadbalancerForwardingruleTargetGetArgs>? _targets;

        /// <summary>
        /// [Set] Array of items in that collection.
        /// </summary>
        public InputList<Inputs.NetworkloadbalancerForwardingruleTargetGetArgs> Targets
        {
            get => _targets ?? (_targets = new InputList<Inputs.NetworkloadbalancerForwardingruleTargetGetArgs>());
            set => _targets = value;
        }

        public NetworkloadbalancerForwardingruleState()
        {
        }
        public static new NetworkloadbalancerForwardingruleState Empty => new NetworkloadbalancerForwardingruleState();
    }
}
