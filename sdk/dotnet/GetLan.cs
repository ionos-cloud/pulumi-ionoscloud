...
namespace Pulumi.Ionoscloud
{
    public static class GetLan
    {
        ...
        public static Task<GetLanResult> InvokeAsync(GetLanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLanResult>("ionoscloud:index/getLan:getLan", args ?? new GetLanArgs(), options.WithDefaults());
        ...
        public static Output<GetLanResult> Invoke(GetLanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLanResult>("ionoscloud:index/getLan:getLan", args ?? new GetLanInvokeArgs(), options.WithDefaults());
