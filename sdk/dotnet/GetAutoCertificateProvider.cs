...
namespace Pulumi.Ionoscloud
{
    public static class GetAutoCertificateProvider
    {
        public static Task<GetAutoCertificateProviderResult> InvokeAsync(GetAutoCertificateProviderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutoCertificateProviderResult>("ionoscloud:index/getAutoCertificateProvider:getAutoCertificateProvider", args ?? new GetAutoCertificateProviderArgs(), options.WithDefaults());
        ...
        public static Output<GetAutoCertificateProviderResult> Invoke(GetAutoCertificateProviderInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAutoCertificateProviderResult>("ionoscloud:index/getAutoCertificateProvider:getAutoCertificateProvider", args ?? new GetAutoCertificateProviderInvokeArgs(), options.WithDefaults());
    }
