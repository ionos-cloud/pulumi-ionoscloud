...
namespace Pulumi.Ionoscloud
{
    ...
    /// </summary>
    [IonoscloudResourceType("ionoscloud:index/k8sCluster:K8sCluster")]
    public partial class K8sCluster : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.K8sClusterMaintenanceWindow> MaintenanceWindow { get; private set; } = null!;
        ...
        /// </summary>
        [Output("s3Buckets")]
        public Output<ImmutableArray<Outputs.K8sClusterS3Bucket>> S3Buckets { get; private set; } = null!;
        ...
        public K8sCluster(string name, K8sClusterArgs? args = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/k8sCluster:K8sCluster", name, args ?? new K8sClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private K8sCluster(string name, Input<string> id, K8sClusterState? state = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/k8sCluster:K8sCluster", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class K8sClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.K8sClusterMaintenanceWindowArgs>? MaintenanceWindow { get; set; }
        ...
        [Input("s3Buckets")]
        private InputList<Inputs.K8sClusterS3BucketArgs>? _s3Buckets;

        /// <summary>
        /// [list] List of S3 bucket configured for K8s usage. For now it contains only an S3 bucket used to store K8s API audit logs.
        /// </summary>
        public InputList<Inputs.K8sClusterS3BucketArgs> S3Buckets
        {
            get => _s3Buckets ?? (_s3Buckets = new InputList<Inputs.K8sClusterS3BucketArgs>());
    ...
    public sealed class K8sClusterState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("maintenanceWindow")]
        public Input<Inputs.K8sClusterMaintenanceWindowGetArgs>? MaintenanceWindow { get; set; }
        ...
        [Input("s3Buckets")]
        private InputList<Inputs.K8sClusterS3BucketGetArgs>? _s3Buckets;

        /// <summary>
        /// [list] List of S3 bucket configured for K8s usage. For now it contains only an S3 bucket used to store K8s API audit logs.
        /// </summary>
        public InputList<Inputs.K8sClusterS3BucketGetArgs> S3Buckets
        {
            get => _s3Buckets ?? (_s3Buckets = new InputList<Inputs.K8sClusterS3BucketGetArgs>());
            set => _s3Buckets = value;
        }
