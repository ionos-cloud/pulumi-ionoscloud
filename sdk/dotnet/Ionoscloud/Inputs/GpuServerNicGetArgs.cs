...
namespace Ionoscloud.Pulumi.Ionoscloud.Inputs
{
    ...
    public sealed class GpuServerNicGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("deviceNumber")]
        ...
        /// </summary>
        [Input("firewall")]
        public Input<Inputs.GpuServerNicFirewallGetArgs>? Firewall { get; set; }
        ...
        public GpuServerNicGetArgs()
        {
        }
        public static new GpuServerNicGetArgs Empty => new GpuServerNicGetArgs();
    }
}
