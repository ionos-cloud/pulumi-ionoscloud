...
namespace Ionoscloud.Pulumi.Ionoscloud.Inputs
{
    ...
    public sealed class GpuServerNicArgs : global::Pulumi.ResourceArgs
    {
        [Input("deviceNumber")]
        ...
        /// </summary>
        [Input("firewall")]
        public Input<Inputs.GpuServerNicFirewallArgs>? Firewall { get; set; }
        ...
        public GpuServerNicArgs()
        {
        }
        public static new GpuServerNicArgs Empty => new GpuServerNicArgs();
    }
}
