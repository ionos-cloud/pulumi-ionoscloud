...
namespace Ionoscloud.Pulumi.Ionoscloud.Dbaas.Inputs
{
    ...
    public sealed class MariaDBClusterV2RestoreFromBackupGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<string>? SourceBackupId { get; set; }

        public MariaDBClusterV2RestoreFromBackupGetArgs()
        {
        }
        public static new MariaDBClusterV2RestoreFromBackupGetArgs Empty => new MariaDBClusterV2RestoreFromBackupGetArgs();
    }
}
