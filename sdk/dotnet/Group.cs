...
namespace Pulumi.Ionoscloud
{
    ...
    /// </summary>
    [IonoscloudResourceType("ionoscloud:index/group:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs? args = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/group:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, GroupState? state = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/group:Group", name, state, MakeResourceOptions(options, id))
        {
        }
