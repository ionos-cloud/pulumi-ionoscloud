...
namespace Pulumi.Ionoscloud
{
    ...
    /// </summary>
    [IonoscloudResourceType("ionoscloud:index/backupUnit:BackupUnit")]
    public partial class BackupUnit : global::Pulumi.CustomResource
    {
        ...
        public BackupUnit(string name, BackupUnitArgs args, CustomResourceOptions? options = null)
            : base("ionoscloud:index/backupUnit:BackupUnit", name, args ?? new BackupUnitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupUnit(string name, Input<string> id, BackupUnitState? state = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/backupUnit:BackupUnit", name, state, MakeResourceOptions(options, id))
        {
        }
