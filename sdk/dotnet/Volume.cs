...
namespace Pulumi.Ionoscloud
{
    ...
    ///     });
    /// 
    ///     var exampleIndex_volumeVolume = new Ionoscloud.Volume("exampleIndex/volumeVolume", new()
    ///     {
    ///         DatacenterId = exampleDatacenter.Id,
    ///         ServerId = exampleServer.Id,
    ///         AvailabilityZone = "ZONE_1",
    ...
    /// ```
    /// </summary>
    [IonoscloudResourceType("ionoscloud:index/volume:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("ionoscloud:index/volume:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, VolumeState? state = null, CustomResourceOptions? options = null)
            : base("ionoscloud:index/volume:Volume", name, state, MakeResourceOptions(options, id))
        {
        }
