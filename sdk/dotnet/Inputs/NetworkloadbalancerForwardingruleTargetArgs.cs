...
namespace Pulumi.Ionoscloud.Inputs
{
    ...
    public sealed class NetworkloadbalancerForwardingruleTargetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Health check attributes for Network Load Balancer forwarding rule target.
        /// </summary>
        [Input("healthCheck")]
        public Input<Inputs.NetworkloadbalancerForwardingruleTargetHealthCheckArgs>? HealthCheck { get; set; }
        ...
        public NetworkloadbalancerForwardingruleTargetArgs()
        {
        }
        public static new NetworkloadbalancerForwardingruleTargetArgs Empty => new NetworkloadbalancerForwardingruleTargetArgs();
    }
}
