...
namespace Pulumi.Ionoscloud.Inputs
{
    ...
    public sealed class NetworkloadbalancerForwardingruleTargetGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Health check attributes for Network Load Balancer forwarding rule target.
        /// </summary>
        [Input("healthCheck")]
        public Input<Inputs.NetworkloadbalancerForwardingruleTargetHealthCheckGetArgs>? HealthCheck { get; set; }
        ...
        public NetworkloadbalancerForwardingruleTargetGetArgs()
        {
        }
        public static new NetworkloadbalancerForwardingruleTargetGetArgs Empty => new NetworkloadbalancerForwardingruleTargetGetArgs();
    }
}
