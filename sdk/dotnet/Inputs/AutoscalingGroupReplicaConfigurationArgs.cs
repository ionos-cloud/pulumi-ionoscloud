...
namespace Pulumi.Ionoscloud.Inputs
{
    ...
    public sealed class AutoscalingGroupReplicaConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nics")]
        private InputList<Inputs.AutoscalingGroupReplicaConfigurationNicArgs>? _nics;

        /// <summary>
        /// Set of NICs associated with this Replica.
        /// </summary>
        public InputList<Inputs.AutoscalingGroupReplicaConfigurationNicArgs> Nics
        {
            get => _nics ?? (_nics = new InputList<Inputs.AutoscalingGroupReplicaConfigurationNicArgs>());
            set => _nics = value;
        }
        ...
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.AutoscalingGroupReplicaConfigurationVolumeArgs>());
            set => _volumes = value;
        }

        public AutoscalingGroupReplicaConfigurationArgs()
        {
        }
        public static new AutoscalingGroupReplicaConfigurationArgs Empty => new AutoscalingGroupReplicaConfigurationArgs();
    }
}
