...
namespace Pulumi.Ionoscloud.Inputs
{
    ...
    public sealed class GetNfsShareClientGroupArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        private List<Inputs.GetNfsShareClientGroupNfArgs>? _nfs;

        /// <summary>
        /// The NFS configuration for the client group. Each NFS configuration supports the following:
        /// </summary>
        public List<Inputs.GetNfsShareClientGroupNfArgs> Nfs
        {
            get => _nfs ?? (_nfs = new List<Inputs.GetNfsShareClientGroupNfArgs>());
            set => _nfs = value;
        }

        public GetNfsShareClientGroupArgs()
        {
        }
        public static new GetNfsShareClientGroupArgs Empty => new GetNfsShareClientGroupArgs();
    }
}
