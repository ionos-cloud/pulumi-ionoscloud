...
import com.pulumi.ionoscloud.inputs.K8sClusterState;
import com.pulumi.ionoscloud.outputs.K8sClusterMaintenanceWindow;
import com.pulumi.ionoscloud.outputs.K8sClusterS3Bucket;
 ...
 * 
 */
@ResourceType(type="ionoscloud:index/k8sCluster:K8sCluster")
public class K8sCluster extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="maintenanceWindow", refs={K8sClusterMaintenanceWindow.class}, tree="[0]")
    private Output<K8sClusterMaintenanceWindow> maintenanceWindow;

    /**
     * @return A maintenance window comprise of a day of the week and a time for maintenance to be allowed
     * 
     */
    public Output<K8sClusterMaintenanceWindow> maintenanceWindow() {
     ...
     * 
     */
    @Export(name="s3Buckets", refs={List.class,K8sClusterS3Bucket.class}, tree="[0,1]")
    private Output</* @Nullable */ List<K8sClusterS3Bucket>> s3Buckets;

    /**
     * @return [list] List of S3 bucket configured for K8s usage. For now it contains only an S3 bucket used to store K8s API audit logs.
     * 
     */
    public Output<Optional<List<K8sClusterS3Bucket>>> s3Buckets() {
     ...
     */
    public K8sCluster(java.lang.String name, @Nullable K8sClusterArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public K8sCluster(java.lang.String name, @Nullable K8sClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/k8sCluster:K8sCluster", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private K8sCluster(java.lang.String name, Output<java.lang.String> id, @Nullable K8sClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/k8sCluster:K8sCluster", name, state, makeResourceOptions(options, id), false);
    }

    private static K8sClusterArgs makeArgs(@Nullable K8sClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
