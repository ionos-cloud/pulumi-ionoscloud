...
public final class GetContainerRegistryTokenArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetContainerRegistryTokenArgs Empty = new GetContainerRegistryTokenArgs();
    ...
    private GetContainerRegistryTokenArgs() {}

    private GetContainerRegistryTokenArgs(GetContainerRegistryTokenArgs $) {
        this.id = $.id;
        this.name = $.name;
    ...
    public static Builder builder(GetContainerRegistryTokenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetContainerRegistryTokenArgs();
        }

        public Builder(GetContainerRegistryTokenArgs defaults) {
            $ = new GetContainerRegistryTokenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetContainerRegistryTokenArgs build() {
            if ($.registryId == null) {
                throw new MissingRequiredPropertyException("GetContainerRegistryTokenArgs", "registryId");
            }
            return $;
        }
    }
