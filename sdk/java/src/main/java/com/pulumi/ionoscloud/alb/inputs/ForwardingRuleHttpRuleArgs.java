...
import com.pulumi.ionoscloud.alb.inputs.ForwardingRuleHttpRuleConditionArgs;
...
public final class ForwardingRuleHttpRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ForwardingRuleHttpRuleArgs Empty = new ForwardingRuleHttpRuleArgs();
    ...
    private @Nullable Output<List<ForwardingRuleHttpRuleConditionArgs>> conditions;
     ...
     * 
     */
    public Optional<Output<List<ForwardingRuleHttpRuleConditionArgs>>> conditions() {
    ...
    private ForwardingRuleHttpRuleArgs() {}

    private ForwardingRuleHttpRuleArgs(ForwardingRuleHttpRuleArgs $) {
    ...
    public static Builder builder(ForwardingRuleHttpRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ForwardingRuleHttpRuleArgs();
        }

        public Builder(ForwardingRuleHttpRuleArgs defaults) {
            $ = new ForwardingRuleHttpRuleArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder conditions(@Nullable Output<List<ForwardingRuleHttpRuleConditionArgs>> conditions) {
         ...
         * 
         */
        public Builder conditions(List<ForwardingRuleHttpRuleConditionArgs> conditions) {
         ...
         * 
         */
        public Builder conditions(ForwardingRuleHttpRuleConditionArgs... conditions) {
        ...
        /**
         * @param type [string] Type of the Http Rule.
         * 
         * @return builder
         * 
         */
        ...
        public ForwardingRuleHttpRuleArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ForwardingRuleHttpRuleArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ForwardingRuleHttpRuleArgs", "type");
            }
            return $;
        }
    }
