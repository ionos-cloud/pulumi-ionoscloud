...
public final class GetCdnDistributionArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCdnDistributionArgs Empty = new GetCdnDistributionArgs();
    ...
    private GetCdnDistributionArgs() {}

    private GetCdnDistributionArgs(GetCdnDistributionArgs $) {
        this.domain = $.domain;
        this.id = $.id;
    ...
    public static Builder builder(GetCdnDistributionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCdnDistributionArgs();
        }

        public Builder(GetCdnDistributionArgs defaults) {
            $ = new GetCdnDistributionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCdnDistributionArgs build() {
            return $;
        }
    }
