...
public final class GetApplicationLoadbalancerPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetApplicationLoadbalancerPlainArgs Empty = new GetApplicationLoadbalancerPlainArgs();
    ...
    private GetApplicationLoadbalancerPlainArgs() {}

    private GetApplicationLoadbalancerPlainArgs(GetApplicationLoadbalancerPlainArgs $) {
    ...
    public static Builder builder(GetApplicationLoadbalancerPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetApplicationLoadbalancerPlainArgs();
        }

        public Builder(GetApplicationLoadbalancerPlainArgs defaults) {
            $ = new GetApplicationLoadbalancerPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetApplicationLoadbalancerPlainArgs build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("GetApplicationLoadbalancerPlainArgs", "datacenterId");
            }
            return $;
        }
    }
