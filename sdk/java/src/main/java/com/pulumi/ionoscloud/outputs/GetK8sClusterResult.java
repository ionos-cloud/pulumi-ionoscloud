...
import com.pulumi.ionoscloud.outputs.GetK8sClusterConfig;
import com.pulumi.ionoscloud.outputs.GetK8sClusterMaintenanceWindow;
import com.pulumi.ionoscloud.outputs.GetK8sClusterS3Bucket;
...
public final class GetK8sClusterResult {
     ...
     * 
     */
    private List<GetK8sClusterConfig> configs;
    /**
     ...
     * 
     */
    private List<GetK8sClusterMaintenanceWindow> maintenanceWindows;
    /**
    ...
    /**
     * @return list of S3 bucket configured for K8s usage
     * 
     */
    private List<GetK8sClusterS3Bucket> s3Buckets;
    /**
     ...
     * 
     */
    public List<GetK8sClusterConfig> configs() {
        return this.configs;
    }
    /**
     * @return id of the cluster
     ...
     * 
     */
    public List<GetK8sClusterMaintenanceWindow> maintenanceWindows() {
     ...
     * 
     */
    public List<GetK8sClusterS3Bucket> s3Buckets() {
    ...
    public static final class Builder {
        ...
        public Builder apiSubnetAllowLists(List<String> apiSubnetAllowLists) {
            if (apiSubnetAllowLists == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "apiSubnetAllowLists");
            }
        ...
        public Builder availableUpgradeVersions(List<String> availableUpgradeVersions) {
            if (availableUpgradeVersions == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "availableUpgradeVersions");
            }
        ...
        public Builder caCrt(String caCrt) {
            if (caCrt == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "caCrt");
            }
            this.caCrt = caCrt;
            return this;
        }
        @CustomType.Setter
        public Builder configs(List<GetK8sClusterConfig> configs) {
            if (configs == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "configs");
            }
            this.configs = configs;
            return this;
        }
        public Builder configs(GetK8sClusterConfig... configs) {
        ...
        public Builder k8sVersion(String k8sVersion) {
            if (k8sVersion == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "k8sVersion");
            }
        ...
        public Builder kubeConfig(String kubeConfig) {
            if (kubeConfig == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "kubeConfig");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "location");
            }
            this.location = location;
            return this;
        }
        @CustomType.Setter
        public Builder maintenanceWindows(List<GetK8sClusterMaintenanceWindow> maintenanceWindows) {
            if (maintenanceWindows == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "maintenanceWindows");
            }
            this.maintenanceWindows = maintenanceWindows;
            return this;
        }
        public Builder maintenanceWindows(GetK8sClusterMaintenanceWindow... maintenanceWindows) {
        ...
        public Builder natGatewayIp(String natGatewayIp) {
            if (natGatewayIp == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "natGatewayIp");
            }
        ...
        public Builder nodePools(List<String> nodePools) {
            if (nodePools == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "nodePools");
            }
        ...
        public Builder nodeSubnet(String nodeSubnet) {
            if (nodeSubnet == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "nodeSubnet");
            }
        ...
        public Builder public_(Boolean public_) {
            if (public_ == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "public_");
            }
            this.public_ = public_;
            return this;
        }
        @CustomType.Setter
        public Builder s3Buckets(List<GetK8sClusterS3Bucket> s3Buckets) {
            if (s3Buckets == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "s3Buckets");
            }
            this.s3Buckets = s3Buckets;
            return this;
        }
        public Builder s3Buckets(GetK8sClusterS3Bucket... s3Buckets) {
            return s3Buckets(List.of(s3Buckets));
        }
        @CustomType.Setter
        public Builder server(String server) {
            if (server == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "server");
            }
            this.server = server;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder userTokens(Map<String,String> userTokens) {
            if (userTokens == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "userTokens");
            }
        ...
        public Builder viableNodePoolVersions(List<String> viableNodePoolVersions) {
            if (viableNodePoolVersions == null) {
              throw new MissingRequiredPropertyException("GetK8sClusterResult", "viableNodePoolVersions");
            }
        ...
        public GetK8sClusterResult build() {
            final var _resultValue = new GetK8sClusterResult();
