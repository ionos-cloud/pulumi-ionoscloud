...
@CustomType
public final class ApplicationLoadbalancerFlowlog {
    /**
    ...
    public static Builder builder(ApplicationLoadbalancerFlowlog defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(ApplicationLoadbalancerFlowlog defaults) {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("ApplicationLoadbalancerFlowlog", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("ApplicationLoadbalancerFlowlog", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder direction(String direction) {
            if (direction == null) {
              throw new MissingRequiredPropertyException("ApplicationLoadbalancerFlowlog", "direction");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ApplicationLoadbalancerFlowlog", "name");
            }
            this.name = name;
            return this;
        }
        public ApplicationLoadbalancerFlowlog build() {
            final var _resultValue = new ApplicationLoadbalancerFlowlog();
