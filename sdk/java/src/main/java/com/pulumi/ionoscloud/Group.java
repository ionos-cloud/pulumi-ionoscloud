...
import com.pulumi.ionoscloud.inputs.GroupState;
import com.pulumi.ionoscloud.outputs.GroupUser;
 ...
 * 
 */
@ResourceType(type="ionoscloud:index/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(java.lang.String name, @Nullable GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/group:Group", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Group(java.lang.String name, Output<java.lang.String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/group:Group", name, state, makeResourceOptions(options, id), false);
    }
