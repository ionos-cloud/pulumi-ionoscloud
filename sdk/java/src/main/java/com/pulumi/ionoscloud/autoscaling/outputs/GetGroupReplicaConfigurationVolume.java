...
@CustomType
public final class GetGroupReplicaConfigurationVolume {
    /**
    ...
    private GetGroupReplicaConfigurationVolume() {}
    /**
     * @return The uuid of the Backup Unit that user has access to.
     * 
     */
    ...
    public static Builder builder(GetGroupReplicaConfigurationVolume defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetGroupReplicaConfigurationVolume defaults) {
        ...
        public Builder backupUnitId(String backupUnitId) {
            if (backupUnitId == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "backupUnitId");
            }
        ...
        public Builder bootOrder(String bootOrder) {
            if (bootOrder == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "bootOrder");
            }
        ...
        public Builder bus(String bus) {
            if (bus == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "bus");
            }
            this.bus = bus;
            return this;
        }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "image");
            }
            this.image = image;
            return this;
        }
        ...
        public Builder imageAlias(String imageAlias) {
            if (imageAlias == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "imageAlias");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder size(Integer size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "size");
            }
            this.size = size;
            return this;
        }
        ...
        public Builder sshKeys(List<String> sshKeys) {
            if (sshKeys == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "sshKeys");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetGroupReplicaConfigurationVolume", "type");
            }
            this.type = type;
            return this;
        }
        public GetGroupReplicaConfigurationVolume build() {
            final var _resultValue = new GetGroupReplicaConfigurationVolume();
