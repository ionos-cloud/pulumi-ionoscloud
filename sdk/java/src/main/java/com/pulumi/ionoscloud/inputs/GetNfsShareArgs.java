...
import com.pulumi.ionoscloud.inputs.GetNfsShareClientGroupArgs;
...
public final class GetNfsShareArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetNfsShareArgs Empty = new GetNfsShareArgs();
    ...
    private @Nullable Output<List<GetNfsShareClientGroupArgs>> clientGroups;
     ...
     * 
     */
    public Optional<Output<List<GetNfsShareClientGroupArgs>>> clientGroups() {
    ...
    private GetNfsShareArgs() {}

    private GetNfsShareArgs(GetNfsShareArgs $) {
    ...
    public static Builder builder(GetNfsShareArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetNfsShareArgs defaults) {
            $ = new GetNfsShareArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder clientGroups(@Nullable Output<List<GetNfsShareClientGroupArgs>> clientGroups) {
         ...
         * 
         */
        public Builder clientGroups(List<GetNfsShareClientGroupArgs> clientGroups) {
         ...
         * 
         */
        public Builder clientGroups(GetNfsShareClientGroupArgs... clientGroups) {
        ...
        public GetNfsShareArgs build() {
            if ($.clusterId == null) {
                throw new MissingRequiredPropertyException("GetNfsShareArgs", "clusterId");
            }
            if ($.location == null) {
                throw new MissingRequiredPropertyException("GetNfsShareArgs", "location");
            }
            return $;
        }
    }
