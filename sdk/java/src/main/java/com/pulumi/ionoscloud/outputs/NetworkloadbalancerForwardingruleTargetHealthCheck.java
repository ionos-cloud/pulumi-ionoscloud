...
@CustomType
public final class NetworkloadbalancerForwardingruleTargetHealthCheck {
    /**
    ...
    private NetworkloadbalancerForwardingruleTargetHealthCheck() {}
    /**
     * @return [boolean] Check specifies whether the target VM&#39;s health is checked.
     * 
     */
    ...
    public static Builder builder(NetworkloadbalancerForwardingruleTargetHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean maintenance;
        public Builder() {}
        public Builder(NetworkloadbalancerForwardingruleTargetHealthCheck defaults) {
        ...
        public NetworkloadbalancerForwardingruleTargetHealthCheck build() {
            final var _resultValue = new NetworkloadbalancerForwardingruleTargetHealthCheck();
