...
import com.pulumi.ionoscloud.inputs.VpnWireguardPeerState;
import com.pulumi.ionoscloud.outputs.VpnWireguardPeerEndpoint;
 ...
 * 
 */
@ResourceType(type="ionoscloud:index/vpnWireguardPeer:VpnWireguardPeer")
public class VpnWireguardPeer extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="endpoint", refs={VpnWireguardPeerEndpoint.class}, tree="[0]")
    private Output</* @Nullable */ VpnWireguardPeerEndpoint> endpoint;

    /**
     * @return [block] An endpoint configuration block for the WireGuard Gateway. The structure of this block is as follows:
     * 
     */
    public Output<Optional<VpnWireguardPeerEndpoint>> endpoint() {
     ...
     */
    public VpnWireguardPeer(java.lang.String name) {
        this(name, VpnWireguardPeerArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VpnWireguardPeer(java.lang.String name, VpnWireguardPeerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VpnWireguardPeer(java.lang.String name, VpnWireguardPeerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/vpnWireguardPeer:VpnWireguardPeer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VpnWireguardPeer(java.lang.String name, Output<java.lang.String> id, @Nullable VpnWireguardPeerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/vpnWireguardPeer:VpnWireguardPeer", name, state, makeResourceOptions(options, id), false);
    }

    private static VpnWireguardPeerArgs makeArgs(VpnWireguardPeerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VpnWireguardPeerArgs.Empty : args;
    }
     ...
     */
    public static VpnWireguardPeer get(java.lang.String name, Output<java.lang.String> id, @Nullable VpnWireguardPeerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
