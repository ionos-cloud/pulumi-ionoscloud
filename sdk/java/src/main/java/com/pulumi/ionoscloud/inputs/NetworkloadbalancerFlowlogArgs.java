...
public final class NetworkloadbalancerFlowlogArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkloadbalancerFlowlogArgs Empty = new NetworkloadbalancerFlowlogArgs();
    ...
    private NetworkloadbalancerFlowlogArgs() {}

    private NetworkloadbalancerFlowlogArgs(NetworkloadbalancerFlowlogArgs $) {
        this.action = $.action;
        this.bucket = $.bucket;
    ...
    public static Builder builder(NetworkloadbalancerFlowlogArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkloadbalancerFlowlogArgs();
        }

        public Builder(NetworkloadbalancerFlowlogArgs defaults) {
            $ = new NetworkloadbalancerFlowlogArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkloadbalancerFlowlogArgs build() {
            if ($.action == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerFlowlogArgs", "action");
            }
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerFlowlogArgs", "bucket");
            }
            if ($.direction == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerFlowlogArgs", "direction");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerFlowlogArgs", "name");
            }
            return $;
        }
    }
