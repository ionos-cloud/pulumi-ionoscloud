...
@CustomType
public final class PrivateCrossconnectPeer {
    /**
    ...
    public static Builder builder(PrivateCrossconnectPeer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String location;
        public Builder() {}
        public Builder(PrivateCrossconnectPeer defaults) {
        ...
        public PrivateCrossconnectPeer build() {
            final var _resultValue = new PrivateCrossconnectPeer();
