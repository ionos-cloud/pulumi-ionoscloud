...
public final class GetContainerRegistryTokenPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetContainerRegistryTokenPlainArgs Empty = new GetContainerRegistryTokenPlainArgs();
    ...
    private GetContainerRegistryTokenPlainArgs() {}

    private GetContainerRegistryTokenPlainArgs(GetContainerRegistryTokenPlainArgs $) {
        this.id = $.id;
        this.name = $.name;
    ...
    public static Builder builder(GetContainerRegistryTokenPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetContainerRegistryTokenPlainArgs();
        }

        public Builder(GetContainerRegistryTokenPlainArgs defaults) {
            $ = new GetContainerRegistryTokenPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetContainerRegistryTokenPlainArgs build() {
            if ($.registryId == null) {
                throw new MissingRequiredPropertyException("GetContainerRegistryTokenPlainArgs", "registryId");
            }
            return $;
        }
    }
