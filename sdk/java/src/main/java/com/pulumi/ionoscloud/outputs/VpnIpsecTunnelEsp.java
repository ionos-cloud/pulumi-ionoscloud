...
@CustomType
public final class VpnIpsecTunnelEsp {
    /**
    ...
    public static Builder builder(VpnIpsecTunnelEsp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer lifetime;
        public Builder() {}
        public Builder(VpnIpsecTunnelEsp defaults) {
        ...
        public VpnIpsecTunnelEsp build() {
            final var _resultValue = new VpnIpsecTunnelEsp();
