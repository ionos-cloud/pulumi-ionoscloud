...
public final class LoggingPipelineLogDestinationArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoggingPipelineLogDestinationArgs Empty = new LoggingPipelineLogDestinationArgs();
    ...
    private LoggingPipelineLogDestinationArgs() {}

    private LoggingPipelineLogDestinationArgs(LoggingPipelineLogDestinationArgs $) {
    ...
    public static Builder builder(LoggingPipelineLogDestinationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoggingPipelineLogDestinationArgs();
        }

        public Builder(LoggingPipelineLogDestinationArgs defaults) {
            $ = new LoggingPipelineLogDestinationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoggingPipelineLogDestinationArgs build() {
            return $;
        }
    }
