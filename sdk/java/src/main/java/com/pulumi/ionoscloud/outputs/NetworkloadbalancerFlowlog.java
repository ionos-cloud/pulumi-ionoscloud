...
@CustomType
public final class NetworkloadbalancerFlowlog {
    /**
    ...
    public static Builder builder(NetworkloadbalancerFlowlog defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(NetworkloadbalancerFlowlog defaults) {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("NetworkloadbalancerFlowlog", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("NetworkloadbalancerFlowlog", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder direction(String direction) {
            if (direction == null) {
              throw new MissingRequiredPropertyException("NetworkloadbalancerFlowlog", "direction");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("NetworkloadbalancerFlowlog", "name");
            }
            this.name = name;
            return this;
        }
        public NetworkloadbalancerFlowlog build() {
            final var _resultValue = new NetworkloadbalancerFlowlog();
