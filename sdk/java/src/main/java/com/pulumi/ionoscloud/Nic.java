...
import com.pulumi.ionoscloud.inputs.NicState;
import com.pulumi.ionoscloud.outputs.NicFlowlog;
 ...
 * 
 */
@ResourceType(type="ionoscloud:index/nic:Nic")
public class Nic extends com.pulumi.resources.CustomResource {
    ...
    public Nic(java.lang.String name, NicArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/nic:Nic", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Nic(java.lang.String name, Output<java.lang.String> id, @Nullable NicState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/nic:Nic", name, state, makeResourceOptions(options, id), false);
    }
