...
import com.pulumi.ionoscloud.inputs.AutoscalingGroupReplicaConfigurationNicArgs;
import com.pulumi.ionoscloud.inputs.AutoscalingGroupReplicaConfigurationVolumeArgs;
...
public final class AutoscalingGroupReplicaConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutoscalingGroupReplicaConfigurationArgs Empty = new AutoscalingGroupReplicaConfigurationArgs();
     ...
     */
    @Import(name="nics")
    private @Nullable Output<List<AutoscalingGroupReplicaConfigurationNicArgs>> nics;

    /**
     * @return Set of NICs associated with this Replica.
     * 
     */
    public Optional<Output<List<AutoscalingGroupReplicaConfigurationNicArgs>>> nics() {
     ...
     */
    @Import(name="volumes")
    private @Nullable Output<List<AutoscalingGroupReplicaConfigurationVolumeArgs>> volumes;

    /**
     * @return [list] List of volumes associated with this Replica.
     * 
     */
    public Optional<Output<List<AutoscalingGroupReplicaConfigurationVolumeArgs>>> volumes() {
        return Optional.ofNullable(this.volumes);
    }

    private AutoscalingGroupReplicaConfigurationArgs() {}

    private AutoscalingGroupReplicaConfigurationArgs(AutoscalingGroupReplicaConfigurationArgs $) {
    ...
    public static Builder builder(AutoscalingGroupReplicaConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoscalingGroupReplicaConfigurationArgs();
        }

        public Builder(AutoscalingGroupReplicaConfigurationArgs defaults) {
            $ = new AutoscalingGroupReplicaConfigurationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder nics(@Nullable Output<List<AutoscalingGroupReplicaConfigurationNicArgs>> nics) {
            $.nics = nics;
            return this;
        }
         ...
         * 
         */
        public Builder nics(List<AutoscalingGroupReplicaConfigurationNicArgs> nics) {
         ...
         * 
         */
        public Builder nics(AutoscalingGroupReplicaConfigurationNicArgs... nics) {
         ...
         * 
         */
        public Builder volumes(@Nullable Output<List<AutoscalingGroupReplicaConfigurationVolumeArgs>> volumes) {
            $.volumes = volumes;
            return this;
        }
         ...
         * 
         */
        public Builder volumes(List<AutoscalingGroupReplicaConfigurationVolumeArgs> volumes) {
         ...
         * 
         */
        public Builder volumes(AutoscalingGroupReplicaConfigurationVolumeArgs... volumes) {
            return volumes(List.of(volumes));
        }

        public AutoscalingGroupReplicaConfigurationArgs build() {
            if ($.availabilityZone == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupReplicaConfigurationArgs", "availabilityZone");
            }
            if ($.cores == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupReplicaConfigurationArgs", "cores");
            }
            if ($.ram == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupReplicaConfigurationArgs", "ram");
            }
            return $;
        }
    }
