...
@CustomType
public final class GetAutoscalingGroupReplicaConfigurationNicFirewallRule {
    /**
    ...
    private GetAutoscalingGroupReplicaConfigurationNicFirewallRule() {}
    /**
     * @return Sets the allowed code (from 0 to 254) when ICMP protocol is selected. The value &#39;null&#39; allows all codes.
     * 
     */
    ...
    public static Builder builder(GetAutoscalingGroupReplicaConfigurationNicFirewallRule defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetAutoscalingGroupReplicaConfigurationNicFirewallRule defaults) {
        ...
        public Builder icmpCode(Integer icmpCode) {
            if (icmpCode == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "icmpCode");
            }
        ...
        public Builder icmpType(Integer icmpType) {
            if (icmpType == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "icmpType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder portRangeEnd(Integer portRangeEnd) {
            if (portRangeEnd == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "portRangeEnd");
            }
        ...
        public Builder portRangeStart(Integer portRangeStart) {
            if (portRangeStart == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "portRangeStart");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "protocol");
            }
        ...
        public Builder sourceIp(String sourceIp) {
            if (sourceIp == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "sourceIp");
            }
        ...
        public Builder sourceMac(String sourceMac) {
            if (sourceMac == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "sourceMac");
            }
        ...
        public Builder targetIp(String targetIp) {
            if (targetIp == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "targetIp");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupReplicaConfigurationNicFirewallRule", "type");
            }
            this.type = type;
            return this;
        }
        public GetAutoscalingGroupReplicaConfigurationNicFirewallRule build() {
            final var _resultValue = new GetAutoscalingGroupReplicaConfigurationNicFirewallRule();
