...
import com.pulumi.ionoscloud.dsaas.outputs.GetNodePoolAutoScaling;
import com.pulumi.ionoscloud.dsaas.outputs.GetNodePoolMaintenanceWindow;
...
public final class GetNodePoolResult {
    ...
    /**
     * @return Whether the Node Pool should autoscale. For more details, please check the API documentation
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetNodePoolResult", "version");
            }
