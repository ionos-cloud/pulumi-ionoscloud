...
import com.pulumi.ionoscloud.inputs.ServerLabelArgs;
...
public final class ServerState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param bootCdrom ***DEPRECATED*** Please refer to ionoscloud.ServerBootDeviceSelection (Optional)(Computed)[string] The associated boot drive, if any. Must be the UUID of a bootable CDROM image that can be retrieved using the ionoscloud.getImage data source.
         * 
         * @return builder
         * 
         * @deprecated
