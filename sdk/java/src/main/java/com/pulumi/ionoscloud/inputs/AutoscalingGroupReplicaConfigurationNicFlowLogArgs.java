...
public final class AutoscalingGroupReplicaConfigurationNicFlowLogArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutoscalingGroupReplicaConfigurationNicFlowLogArgs Empty = new AutoscalingGroupReplicaConfigurationNicFlowLogArgs();
    ...
    private AutoscalingGroupReplicaConfigurationNicFlowLogArgs() {}

    private AutoscalingGroupReplicaConfigurationNicFlowLogArgs(AutoscalingGroupReplicaConfigurationNicFlowLogArgs $) {
        this.action = $.action;
        this.bucket = $.bucket;
    ...
    public static Builder builder(AutoscalingGroupReplicaConfigurationNicFlowLogArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoscalingGroupReplicaConfigurationNicFlowLogArgs();
        }

        public Builder(AutoscalingGroupReplicaConfigurationNicFlowLogArgs defaults) {
            $ = new AutoscalingGroupReplicaConfigurationNicFlowLogArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AutoscalingGroupReplicaConfigurationNicFlowLogArgs build() {
            if ($.action == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupReplicaConfigurationNicFlowLogArgs", "action");
            }
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupReplicaConfigurationNicFlowLogArgs", "bucket");
            }
            if ($.direction == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupReplicaConfigurationNicFlowLogArgs", "direction");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupReplicaConfigurationNicFlowLogArgs", "name");
            }
            return $;
        }
    }
