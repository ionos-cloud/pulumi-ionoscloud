...
public final class NetworkloadbalancerForwardingruleTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkloadbalancerForwardingruleTargetArgs Empty = new NetworkloadbalancerForwardingruleTargetArgs();
    ...
    private @Nullable Output<NetworkloadbalancerForwardingruleTargetHealthCheckArgs> healthCheck;

    /**
     * @return Health check attributes for Network Load Balancer forwarding rule target.
     * 
     */
    public Optional<Output<NetworkloadbalancerForwardingruleTargetHealthCheckArgs>> healthCheck() {
    ...
    private NetworkloadbalancerForwardingruleTargetArgs() {}

    private NetworkloadbalancerForwardingruleTargetArgs(NetworkloadbalancerForwardingruleTargetArgs $) {
    ...
    public static Builder builder(NetworkloadbalancerForwardingruleTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkloadbalancerForwardingruleTargetArgs();
        }

        public Builder(NetworkloadbalancerForwardingruleTargetArgs defaults) {
            $ = new NetworkloadbalancerForwardingruleTargetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder healthCheck(@Nullable Output<NetworkloadbalancerForwardingruleTargetHealthCheckArgs> healthCheck) {
         ...
         * 
         */
        public Builder healthCheck(NetworkloadbalancerForwardingruleTargetHealthCheckArgs healthCheck) {
        ...
        public NetworkloadbalancerForwardingruleTargetArgs build() {
            if ($.ip == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerForwardingruleTargetArgs", "ip");
            }
            if ($.port == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerForwardingruleTargetArgs", "port");
            }
            if ($.weight == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerForwardingruleTargetArgs", "weight");
            }
            return $;
        }
    }
