...
import com.pulumi.ionoscloud.inputs.DataplatformNodePoolState;
import com.pulumi.ionoscloud.outputs.DataplatformNodePoolMaintenanceWindow;
 ...
 * 
 */
@ResourceType(type="ionoscloud:index/dataplatformNodePool:DataplatformNodePool")
public class DataplatformNodePool extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="maintenanceWindows", refs={List.class,DataplatformNodePoolMaintenanceWindow.class}, tree="[0,1]")
    private Output<List<DataplatformNodePoolMaintenanceWindow>> maintenanceWindows;

    /**
     * @return [string] Starting time of a weekly 4 hour-long window, during which maintenance might occur in hh:mm:ss format
     * 
     */
    public Output<List<DataplatformNodePoolMaintenanceWindow>> maintenanceWindows() {
     ...
     */
    public DataplatformNodePool(java.lang.String name) {
        this(name, DataplatformNodePoolArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DataplatformNodePool(java.lang.String name, DataplatformNodePoolArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DataplatformNodePool(java.lang.String name, DataplatformNodePoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/dataplatformNodePool:DataplatformNodePool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DataplatformNodePool(java.lang.String name, Output<java.lang.String> id, @Nullable DataplatformNodePoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/dataplatformNodePool:DataplatformNodePool", name, state, makeResourceOptions(options, id), false);
    }

    private static DataplatformNodePoolArgs makeArgs(DataplatformNodePoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DataplatformNodePoolArgs.Empty : args;
    }
     ...
     */
    public static DataplatformNodePool get(java.lang.String name, Output<java.lang.String> id, @Nullable DataplatformNodePoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
