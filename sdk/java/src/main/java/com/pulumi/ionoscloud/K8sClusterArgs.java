...
public final class K8sClusterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<K8sClusterMaintenanceWindowArgs> maintenanceWindow;

    /**
     * @return A maintenance window comprise of a day of the week and a time for maintenance to be allowed
     * 
     */
    public Optional<Output<K8sClusterMaintenanceWindowArgs>> maintenanceWindow() {
    ...
    private @Nullable Output<List<K8sClusterS3BucketArgs>> s3Buckets;
     ...
     * 
     */
    public Optional<Output<List<K8sClusterS3BucketArgs>>> s3Buckets() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder maintenanceWindow(@Nullable Output<K8sClusterMaintenanceWindowArgs> maintenanceWindow) {
         ...
         * 
         */
        public Builder maintenanceWindow(K8sClusterMaintenanceWindowArgs maintenanceWindow) {
        ...
        /**
         * @param s3Buckets [list] List of S3 bucket configured for K8s usage. For now it contains only an S3 bucket used to store K8s API audit logs.
         * 
         * @return builder
         * 
         */
        public Builder s3Buckets(@Nullable Output<List<K8sClusterS3BucketArgs>> s3Buckets) {
            $.s3Buckets = s3Buckets;
            return this;
        }
         ...
         * 
         */
        public Builder s3Buckets(List<K8sClusterS3BucketArgs> s3Buckets) {
         ...
         * 
         */
        public Builder s3Buckets(K8sClusterS3BucketArgs... s3Buckets) {
