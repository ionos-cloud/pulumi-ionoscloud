...
@CustomType
public final class PSQLClusterFromBackup {
    /**
    ...
    public static Builder builder(PSQLClusterFromBackup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String recoveryTargetTime;
        public Builder() {}
        public Builder(PSQLClusterFromBackup defaults) {
        ...
        public Builder backupId(String backupId) {
            if (backupId == null) {
              throw new MissingRequiredPropertyException("PSQLClusterFromBackup", "backupId");
            }
        ...
        public PSQLClusterFromBackup build() {
            final var _resultValue = new PSQLClusterFromBackup();
