...
public final class GetApplicationLoadbalancerForwardingrulePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetApplicationLoadbalancerForwardingrulePlainArgs Empty = new GetApplicationLoadbalancerForwardingrulePlainArgs();
    ...
    private GetApplicationLoadbalancerForwardingrulePlainArgs() {}

    private GetApplicationLoadbalancerForwardingrulePlainArgs(GetApplicationLoadbalancerForwardingrulePlainArgs $) {
    ...
    public static Builder builder(GetApplicationLoadbalancerForwardingrulePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetApplicationLoadbalancerForwardingrulePlainArgs();
        }

        public Builder(GetApplicationLoadbalancerForwardingrulePlainArgs defaults) {
            $ = new GetApplicationLoadbalancerForwardingrulePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetApplicationLoadbalancerForwardingrulePlainArgs build() {
            if ($.applicationLoadbalancerId == null) {
                throw new MissingRequiredPropertyException("GetApplicationLoadbalancerForwardingrulePlainArgs", "applicationLoadbalancerId");
            }
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("GetApplicationLoadbalancerForwardingrulePlainArgs", "datacenterId");
            }
            return $;
        }
    }
