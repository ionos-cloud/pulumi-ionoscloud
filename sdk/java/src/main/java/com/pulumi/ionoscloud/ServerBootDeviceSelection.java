...
import com.pulumi.ionoscloud.inputs.ServerBootDeviceSelectionState;
 ...
 * ## Example Usage
 * 
 * The boot device of a `ionoscloud.Server`, `ionoscloud.VcpuServer` or `ionoscloud.CubeServer` can be selected with this resource.
 ...
 * 
 */
@ResourceType(type="ionoscloud:index/serverBootDeviceSelection:ServerBootDeviceSelection")
public class ServerBootDeviceSelection extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ServerBootDeviceSelection(java.lang.String name) {
        this(name, ServerBootDeviceSelectionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServerBootDeviceSelection(java.lang.String name, ServerBootDeviceSelectionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServerBootDeviceSelection(java.lang.String name, ServerBootDeviceSelectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/serverBootDeviceSelection:ServerBootDeviceSelection", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ServerBootDeviceSelection(java.lang.String name, Output<java.lang.String> id, @Nullable ServerBootDeviceSelectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/serverBootDeviceSelection:ServerBootDeviceSelection", name, state, makeResourceOptions(options, id), false);
    }

    private static ServerBootDeviceSelectionArgs makeArgs(ServerBootDeviceSelectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ServerBootDeviceSelectionArgs.Empty : args;
    }
     ...
     */
    public static ServerBootDeviceSelection get(java.lang.String name, Output<java.lang.String> id, @Nullable ServerBootDeviceSelectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new ServerBootDeviceSelection(name, id, state, options);
    }
}
