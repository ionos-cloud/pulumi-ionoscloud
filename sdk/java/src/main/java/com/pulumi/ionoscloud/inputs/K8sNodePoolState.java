...
public final class K8sNodePoolState extends com.pulumi.resources.ResourceArgs {

    public static final K8sNodePoolState Empty = new K8sNodePoolState();
    ...
    private K8sNodePoolState() {}

    private K8sNodePoolState(K8sNodePoolState $) {
    ...
    public static Builder builder(K8sNodePoolState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sNodePoolState();
        }

        public Builder(K8sNodePoolState defaults) {
            $ = new K8sNodePoolState(Objects.requireNonNull(defaults));
        }
