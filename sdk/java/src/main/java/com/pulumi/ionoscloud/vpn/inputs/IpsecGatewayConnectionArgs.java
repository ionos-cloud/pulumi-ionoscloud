...
public final class IpsecGatewayConnectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpsecGatewayConnectionArgs Empty = new IpsecGatewayConnectionArgs();
    ...
    private IpsecGatewayConnectionArgs() {}

    private IpsecGatewayConnectionArgs(IpsecGatewayConnectionArgs $) {
    ...
    public static Builder builder(IpsecGatewayConnectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpsecGatewayConnectionArgs();
        }

        public Builder(IpsecGatewayConnectionArgs defaults) {
            $ = new IpsecGatewayConnectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IpsecGatewayConnectionArgs build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("IpsecGatewayConnectionArgs", "datacenterId");
            }
            if ($.ipv4Cidr == null) {
                throw new MissingRequiredPropertyException("IpsecGatewayConnectionArgs", "ipv4Cidr");
            }
            if ($.lanId == null) {
                throw new MissingRequiredPropertyException("IpsecGatewayConnectionArgs", "lanId");
            }
            return $;
        }
    }
