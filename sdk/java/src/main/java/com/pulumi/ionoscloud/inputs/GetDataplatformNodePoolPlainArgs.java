...
public final class GetDataplatformNodePoolPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDataplatformNodePoolPlainArgs Empty = new GetDataplatformNodePoolPlainArgs();
    ...
    private GetDataplatformNodePoolPlainArgs() {}

    private GetDataplatformNodePoolPlainArgs(GetDataplatformNodePoolPlainArgs $) {
    ...
    public static Builder builder(GetDataplatformNodePoolPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDataplatformNodePoolPlainArgs();
        }

        public Builder(GetDataplatformNodePoolPlainArgs defaults) {
            $ = new GetDataplatformNodePoolPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDataplatformNodePoolPlainArgs build() {
            if ($.clusterId == null) {
                throw new MissingRequiredPropertyException("GetDataplatformNodePoolPlainArgs", "clusterId");
            }
            return $;
        }
    }
