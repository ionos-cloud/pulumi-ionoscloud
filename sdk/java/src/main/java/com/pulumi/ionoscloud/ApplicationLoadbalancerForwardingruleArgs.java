...
public final class ApplicationLoadbalancerForwardingruleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationLoadbalancerForwardingruleArgs Empty = new ApplicationLoadbalancerForwardingruleArgs();
    ...
    private @Nullable Output<List<ApplicationLoadbalancerForwardingruleHttpRuleArgs>> httpRules;

    /**
     * @return [list] Array of items in that collection
     * 
     */
    public Optional<Output<List<ApplicationLoadbalancerForwardingruleHttpRuleArgs>>> httpRules() {
    ...
    private ApplicationLoadbalancerForwardingruleArgs() {}

    private ApplicationLoadbalancerForwardingruleArgs(ApplicationLoadbalancerForwardingruleArgs $) {
    ...
    public static Builder builder(ApplicationLoadbalancerForwardingruleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationLoadbalancerForwardingruleArgs();
        }

        public Builder(ApplicationLoadbalancerForwardingruleArgs defaults) {
            $ = new ApplicationLoadbalancerForwardingruleArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder httpRules(@Nullable Output<List<ApplicationLoadbalancerForwardingruleHttpRuleArgs>> httpRules) {
            $.httpRules = httpRules;
            return this;
        }
         ...
         * 
         */
        public Builder httpRules(List<ApplicationLoadbalancerForwardingruleHttpRuleArgs> httpRules) {
         ...
         * 
         */
        public Builder httpRules(ApplicationLoadbalancerForwardingruleHttpRuleArgs... httpRules) {
        ...
        public ApplicationLoadbalancerForwardingruleArgs build() {
            if ($.applicationLoadbalancerId == null) {
                throw new MissingRequiredPropertyException("ApplicationLoadbalancerForwardingruleArgs", "applicationLoadbalancerId");
            }
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("ApplicationLoadbalancerForwardingruleArgs", "datacenterId");
            }
            if ($.listenerIp == null) {
                throw new MissingRequiredPropertyException("ApplicationLoadbalancerForwardingruleArgs", "listenerIp");
            }
            if ($.listenerPort == null) {
                throw new MissingRequiredPropertyException("ApplicationLoadbalancerForwardingruleArgs", "listenerPort");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("ApplicationLoadbalancerForwardingruleArgs", "protocol");
            }
            return $;
        }
    }
