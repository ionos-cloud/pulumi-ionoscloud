...
public final class NetworkloadbalancerArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="flowlog")
    private @Nullable Output<NetworkloadbalancerFlowlogArgs> flowlog;

    /**
     * @return [list] Only 1 flow log can be configured. Only the name field can change as part of an update. Flow logs holistically capture network information such as source and destination IP addresses, source and destination ports, number of packets, amount of bytes, the start and end time of the recording, and the type of protocol – and log the extent to which your instances are being accessed.
     * 
     */
    public Optional<Output<NetworkloadbalancerFlowlogArgs>> flowlog() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder flowlog(@Nullable Output<NetworkloadbalancerFlowlogArgs> flowlog) {
            $.flowlog = flowlog;
            return this;
        }
         ...
         * 
         */
        public Builder flowlog(NetworkloadbalancerFlowlogArgs flowlog) {
        ...
        public NetworkloadbalancerArgs build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerArgs", "datacenterId");
            }
            if ($.listenerLan == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerArgs", "listenerLan");
            }
            if ($.targetLan == null) {
                throw new MissingRequiredPropertyException("NetworkloadbalancerArgs", "targetLan");
            }
            return $;
        }
    }
