...
@CustomType
public final class NetworkloadbalancerForwardingruleHealthCheck {
    /**
    ...
    private NetworkloadbalancerForwardingruleHealthCheck() {}
    /**
     * @return [int] ClientTimeout is expressed in milliseconds. This inactivity timeout applies when the client is expected to acknowledge or send data. If unset the default of 50 seconds will be used.
     * 
     */
    ...
    public static Builder builder(NetworkloadbalancerForwardingruleHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer targetTimeout;
        public Builder() {}
        public Builder(NetworkloadbalancerForwardingruleHealthCheck defaults) {
        ...
        public NetworkloadbalancerForwardingruleHealthCheck build() {
            final var _resultValue = new NetworkloadbalancerForwardingruleHealthCheck();
