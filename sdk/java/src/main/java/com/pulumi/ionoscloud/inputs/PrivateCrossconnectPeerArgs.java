...
public final class PrivateCrossconnectPeerArgs extends com.pulumi.resources.ResourceArgs {

    public static final PrivateCrossconnectPeerArgs Empty = new PrivateCrossconnectPeerArgs();
    ...
    private PrivateCrossconnectPeerArgs() {}

    private PrivateCrossconnectPeerArgs(PrivateCrossconnectPeerArgs $) {
    ...
    public static Builder builder(PrivateCrossconnectPeerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PrivateCrossconnectPeerArgs();
        }

        public Builder(PrivateCrossconnectPeerArgs defaults) {
            $ = new PrivateCrossconnectPeerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PrivateCrossconnectPeerArgs build() {
            return $;
        }
    }
