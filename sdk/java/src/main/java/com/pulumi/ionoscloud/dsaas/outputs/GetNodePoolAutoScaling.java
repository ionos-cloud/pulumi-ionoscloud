...
public final class GetNodePoolAutoScaling {
    /**
     * @return The maximum number of worker nodes that the node pool can scale to. Should be greater than min_node_count
     * 
     */
    private Integer maxNodeCount;
    /**
     * @return The minimum number of worker nodes the node pool can scale down to. Should be less than max_node_count
     * 
     */
