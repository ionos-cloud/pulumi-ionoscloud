...
public final class GetNetworkloadbalancerForwardingrulePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetNetworkloadbalancerForwardingrulePlainArgs Empty = new GetNetworkloadbalancerForwardingrulePlainArgs();
    ...
    private GetNetworkloadbalancerForwardingrulePlainArgs() {}

    private GetNetworkloadbalancerForwardingrulePlainArgs(GetNetworkloadbalancerForwardingrulePlainArgs $) {
    ...
    public static Builder builder(GetNetworkloadbalancerForwardingrulePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNetworkloadbalancerForwardingrulePlainArgs();
        }

        public Builder(GetNetworkloadbalancerForwardingrulePlainArgs defaults) {
            $ = new GetNetworkloadbalancerForwardingrulePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNetworkloadbalancerForwardingrulePlainArgs build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("GetNetworkloadbalancerForwardingrulePlainArgs", "datacenterId");
            }
            if ($.networkloadbalancerId == null) {
                throw new MissingRequiredPropertyException("GetNetworkloadbalancerForwardingrulePlainArgs", "networkloadbalancerId");
            }
            return $;
        }
    }
