...
public final class VpnWireguardGatewayConnectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final VpnWireguardGatewayConnectionArgs Empty = new VpnWireguardGatewayConnectionArgs();
    ...
    private VpnWireguardGatewayConnectionArgs() {}

    private VpnWireguardGatewayConnectionArgs(VpnWireguardGatewayConnectionArgs $) {
    ...
    public static Builder builder(VpnWireguardGatewayConnectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpnWireguardGatewayConnectionArgs();
        }

        public Builder(VpnWireguardGatewayConnectionArgs defaults) {
            $ = new VpnWireguardGatewayConnectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VpnWireguardGatewayConnectionArgs build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("VpnWireguardGatewayConnectionArgs", "datacenterId");
            }
            if ($.lanId == null) {
                throw new MissingRequiredPropertyException("VpnWireguardGatewayConnectionArgs", "lanId");
            }
            return $;
        }
    }
