...
public final class VpnWireguardPeerArgs extends com.pulumi.resources.ResourceArgs {

    public static final VpnWireguardPeerArgs Empty = new VpnWireguardPeerArgs();
    ...
    private VpnWireguardPeerArgs() {}

    private VpnWireguardPeerArgs(VpnWireguardPeerArgs $) {
    ...
    public static Builder builder(VpnWireguardPeerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpnWireguardPeerArgs();
        }

        public Builder(VpnWireguardPeerArgs defaults) {
            $ = new VpnWireguardPeerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VpnWireguardPeerArgs build() {
            if ($.allowedIps == null) {
                throw new MissingRequiredPropertyException("VpnWireguardPeerArgs", "allowedIps");
            }
            if ($.gatewayId == null) {
                throw new MissingRequiredPropertyException("VpnWireguardPeerArgs", "gatewayId");
            }
            if ($.location == null) {
                throw new MissingRequiredPropertyException("VpnWireguardPeerArgs", "location");
            }
            if ($.publicKey == null) {
                throw new MissingRequiredPropertyException("VpnWireguardPeerArgs", "publicKey");
            }
            return $;
        }
    }
