...
public final class ForwardingRuleHttpRuleConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ForwardingRuleHttpRuleConditionArgs Empty = new ForwardingRuleHttpRuleConditionArgs();
    ...
    private ForwardingRuleHttpRuleConditionArgs() {}

    private ForwardingRuleHttpRuleConditionArgs(ForwardingRuleHttpRuleConditionArgs $) {
    ...
    public static Builder builder(ForwardingRuleHttpRuleConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ForwardingRuleHttpRuleConditionArgs();
        }

        public Builder(ForwardingRuleHttpRuleConditionArgs defaults) {
            $ = new ForwardingRuleHttpRuleConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ForwardingRuleHttpRuleConditionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ForwardingRuleHttpRuleConditionArgs", "type");
            }
            return $;
        }
    }
