...
public final class AutoscalingGroupArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutoscalingGroupArgs Empty = new AutoscalingGroupArgs();
    ...
    private Output<AutoscalingGroupPolicyArgs> policy;

    /**
     * @return [List] Specifies the behavior of this Autoscaling Group. A policy consists of Triggers and Actions, whereby an Action is some kind of automated behavior, and a Trigger is defined by the circumstances under which the Action is triggered. Currently, two separate Actions, namely Scaling In and Out are supported, triggered through Thresholds defined on a given Metric.
     * 
     */
    public Output<AutoscalingGroupPolicyArgs> policy() {
        return this.policy;
    }
    ...
    private Output<AutoscalingGroupReplicaConfigurationArgs> replicaConfiguration;

    /**
     * @return [List]
     * 
     */
    public Output<AutoscalingGroupReplicaConfigurationArgs> replicaConfiguration() {
        return this.replicaConfiguration;
    }

    private AutoscalingGroupArgs() {}

    private AutoscalingGroupArgs(AutoscalingGroupArgs $) {
    ...
    public static Builder builder(AutoscalingGroupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoscalingGroupArgs();
        }

        public Builder(AutoscalingGroupArgs defaults) {
            $ = new AutoscalingGroupArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder policy(Output<AutoscalingGroupPolicyArgs> policy) {
            $.policy = policy;
            return this;
        }
         ...
         * 
         */
        public Builder replicaConfiguration(Output<AutoscalingGroupReplicaConfigurationArgs> replicaConfiguration) {
        ...
        public AutoscalingGroupArgs build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupArgs", "datacenterId");
            }
            if ($.maxReplicaCount == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupArgs", "maxReplicaCount");
            }
            if ($.minReplicaCount == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupArgs", "minReplicaCount");
            }
            if ($.policy == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupArgs", "policy");
            }
            if ($.replicaConfiguration == null) {
                throw new MissingRequiredPropertyException("AutoscalingGroupArgs", "replicaConfiguration");
            }
            return $;
        }
    }
