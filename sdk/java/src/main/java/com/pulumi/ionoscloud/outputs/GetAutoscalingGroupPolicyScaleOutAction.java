...
@CustomType
public final class GetAutoscalingGroupPolicyScaleOutAction {
    /**
    ...
    private GetAutoscalingGroupPolicyScaleOutAction() {}
    /**
     * @return When `amountType == ABSOLUTE`, this is the number of VMs added or removed in one step. When `amountType == PERCENTAGE`, this is a percentage value, which will be applied to the Autoscaling Group&#39;s current `targetReplicaCount` in order to derive the number of VMs that will be added or removed in one step. There will always be at least one VM added or removed.
     * 
     */
    ...
    public static Builder builder(GetAutoscalingGroupPolicyScaleOutAction defaults) {
    ...
    public static final class Builder {
        ...
        private String cooldownPeriod;
        public Builder() {}
        public Builder(GetAutoscalingGroupPolicyScaleOutAction defaults) {
        ...
        public Builder amount(Integer amount) {
            if (amount == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupPolicyScaleOutAction", "amount");
            }
            this.amount = amount;
            return this;
        }
        ...
        public Builder amountType(String amountType) {
            if (amountType == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupPolicyScaleOutAction", "amountType");
            }
        ...
        public Builder cooldownPeriod(String cooldownPeriod) {
            if (cooldownPeriod == null) {
              throw new MissingRequiredPropertyException("GetAutoscalingGroupPolicyScaleOutAction", "cooldownPeriod");
            }
            this.cooldownPeriod = cooldownPeriod;
            return this;
        }
        public GetAutoscalingGroupPolicyScaleOutAction build() {
            final var _resultValue = new GetAutoscalingGroupPolicyScaleOutAction();
