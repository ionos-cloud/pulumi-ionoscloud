...
@CustomType
public final class IpsecGatewayConnection {
    /**
    ...
    public static Builder builder(IpsecGatewayConnection defaults) {
    ...
    public static final class Builder {
        ...
        private String lanId;
        public Builder() {}
        public Builder(IpsecGatewayConnection defaults) {
        ...
        public Builder datacenterId(String datacenterId) {
            if (datacenterId == null) {
              throw new MissingRequiredPropertyException("IpsecGatewayConnection", "datacenterId");
            }
        ...
        public Builder ipv4Cidr(String ipv4Cidr) {
            if (ipv4Cidr == null) {
              throw new MissingRequiredPropertyException("IpsecGatewayConnection", "ipv4Cidr");
            }
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("IpsecGatewayConnection", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        public IpsecGatewayConnection build() {
            final var _resultValue = new IpsecGatewayConnection();
