...
import com.pulumi.ionoscloud.inputs.ApigatewayRouteState;
import com.pulumi.ionoscloud.outputs.ApigatewayRouteUpstream;
 ...
 * 
 */
@ResourceType(type="ionoscloud:index/apigatewayRoute:ApigatewayRoute")
public class ApigatewayRoute extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="upstreams", refs={List.class,ApigatewayRouteUpstream.class}, tree="[0,1]")
    private Output<List<ApigatewayRouteUpstream>> upstreams;

    /**
     * @return Upstreams information of the API Gateway Route. Minimum items: 1.
     * 
     */
    public Output<List<ApigatewayRouteUpstream>> upstreams() {
     ...
     */
    public ApigatewayRoute(java.lang.String name) {
        this(name, ApigatewayRouteArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ApigatewayRoute(java.lang.String name, ApigatewayRouteArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ApigatewayRoute(java.lang.String name, ApigatewayRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/apigatewayRoute:ApigatewayRoute", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ApigatewayRoute(java.lang.String name, Output<java.lang.String> id, @Nullable ApigatewayRouteState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:index/apigatewayRoute:ApigatewayRoute", name, state, makeResourceOptions(options, id), false);
    }

    private static ApigatewayRouteArgs makeArgs(ApigatewayRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ApigatewayRouteArgs.Empty : args;
    }
     ...
     */
    public static ApigatewayRoute get(java.lang.String name, Output<java.lang.String> id, @Nullable ApigatewayRouteState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
