...
@CustomType
public final class CdnDistributionRoutingRuleUpstreamGeoRestrictions {
    /**
    ...
    public static Builder builder(CdnDistributionRoutingRuleUpstreamGeoRestrictions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> blockLists;
        public Builder() {}
        public Builder(CdnDistributionRoutingRuleUpstreamGeoRestrictions defaults) {
        ...
        public CdnDistributionRoutingRuleUpstreamGeoRestrictions build() {
            final var _resultValue = new CdnDistributionRoutingRuleUpstreamGeoRestrictions();
