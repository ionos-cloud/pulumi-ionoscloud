...
import com.pulumi.ionoscloud.outputs.GetNetworkloadbalancerFlowlog;
...
public final class GetNetworkloadbalancerResult {
     ...
     * 
     */
    private List<GetNetworkloadbalancerFlowlog> flowlogs;
    /**
     ...
     * 
     */
    public List<GetNetworkloadbalancerFlowlog> flowlogs() {
    ...
    public static final class Builder {
        ...
        public Builder centralLogging(Boolean centralLogging) {
            if (centralLogging == null) {
              throw new MissingRequiredPropertyException("GetNetworkloadbalancerResult", "centralLogging");
            }
        ...
        public Builder datacenterId(String datacenterId) {
            if (datacenterId == null) {
              throw new MissingRequiredPropertyException("GetNetworkloadbalancerResult", "datacenterId");
            }
            this.datacenterId = datacenterId;
            return this;
        }
        @CustomType.Setter
        public Builder flowlogs(List<GetNetworkloadbalancerFlowlog> flowlogs) {
            if (flowlogs == null) {
              throw new MissingRequiredPropertyException("GetNetworkloadbalancerResult", "flowlogs");
            }
            this.flowlogs = flowlogs;
            return this;
        }
        public Builder flowlogs(GetNetworkloadbalancerFlowlog... flowlogs) {
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetNetworkloadbalancerResult", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder lbPrivateIps(List<String> lbPrivateIps) {
            if (lbPrivateIps == null) {
              throw new MissingRequiredPropertyException("GetNetworkloadbalancerResult", "lbPrivateIps");
            }
        ...
        public Builder listenerLan(Integer listenerLan) {
            if (listenerLan == null) {
              throw new MissingRequiredPropertyException("GetNetworkloadbalancerResult", "listenerLan");
            }
        ...
        public Builder loggingFormat(String loggingFormat) {
            if (loggingFormat == null) {
              throw new MissingRequiredPropertyException("GetNetworkloadbalancerResult", "loggingFormat");
            }
        ...
        public Builder targetLan(Integer targetLan) {
            if (targetLan == null) {
              throw new MissingRequiredPropertyException("GetNetworkloadbalancerResult", "targetLan");
            }
