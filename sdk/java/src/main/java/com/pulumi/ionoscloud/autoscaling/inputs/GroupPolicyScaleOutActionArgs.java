...
public final class GroupPolicyScaleOutActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupPolicyScaleOutActionArgs Empty = new GroupPolicyScaleOutActionArgs();
    ...
    private GroupPolicyScaleOutActionArgs() {}

    private GroupPolicyScaleOutActionArgs(GroupPolicyScaleOutActionArgs $) {
        this.amount = $.amount;
    ...
    public static Builder builder(GroupPolicyScaleOutActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupPolicyScaleOutActionArgs();
        }

        public Builder(GroupPolicyScaleOutActionArgs defaults) {
            $ = new GroupPolicyScaleOutActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupPolicyScaleOutActionArgs build() {
            if ($.amount == null) {
                throw new MissingRequiredPropertyException("GroupPolicyScaleOutActionArgs", "amount");
            }
            if ($.amountType == null) {
                throw new MissingRequiredPropertyException("GroupPolicyScaleOutActionArgs", "amountType");
            }
            return $;
        }
    }
