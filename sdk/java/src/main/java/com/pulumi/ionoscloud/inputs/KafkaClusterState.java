...
public final class KafkaClusterState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<KafkaClusterConnectionsArgs> connections;

    /**
     * @return Connection information of the Kafka Cluster. Minimum items: 1, maximum items: 1.
     * 
     */
    public Optional<Output<KafkaClusterConnectionsArgs>> connections() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder connections(@Nullable Output<KafkaClusterConnectionsArgs> connections) {
