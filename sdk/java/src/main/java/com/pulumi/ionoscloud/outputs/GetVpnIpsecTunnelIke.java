...
@CustomType
public final class GetVpnIpsecTunnelIke {
    /**
    ...
    public static Builder builder(GetVpnIpsecTunnelIke defaults) {
    ...
    public static final class Builder {
        ...
        private Integer lifetime;
        public Builder() {}
        public Builder(GetVpnIpsecTunnelIke defaults) {
        ...
        public Builder diffieHellmanGroup(String diffieHellmanGroup) {
            if (diffieHellmanGroup == null) {
              throw new MissingRequiredPropertyException("GetVpnIpsecTunnelIke", "diffieHellmanGroup");
            }
        ...
        public Builder encryptionAlgorithm(String encryptionAlgorithm) {
            if (encryptionAlgorithm == null) {
              throw new MissingRequiredPropertyException("GetVpnIpsecTunnelIke", "encryptionAlgorithm");
            }
        ...
        public Builder integrityAlgorithm(String integrityAlgorithm) {
            if (integrityAlgorithm == null) {
              throw new MissingRequiredPropertyException("GetVpnIpsecTunnelIke", "integrityAlgorithm");
            }
        ...
        public Builder lifetime(Integer lifetime) {
            if (lifetime == null) {
              throw new MissingRequiredPropertyException("GetVpnIpsecTunnelIke", "lifetime");
            }
            this.lifetime = lifetime;
            return this;
        }
        public GetVpnIpsecTunnelIke build() {
            final var _resultValue = new GetVpnIpsecTunnelIke();
