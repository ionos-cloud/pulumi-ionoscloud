...
public final class GetDataplatformClusterPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDataplatformClusterPlainArgs Empty = new GetDataplatformClusterPlainArgs();
    ...
    private GetDataplatformClusterPlainArgs() {}

    private GetDataplatformClusterPlainArgs(GetDataplatformClusterPlainArgs $) {
        this.id = $.id;
        this.name = $.name;
    ...
    public static Builder builder(GetDataplatformClusterPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDataplatformClusterPlainArgs();
        }

        public Builder(GetDataplatformClusterPlainArgs defaults) {
            $ = new GetDataplatformClusterPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDataplatformClusterPlainArgs build() {
            return $;
        }
    }
