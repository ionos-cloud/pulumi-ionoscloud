...
import com.ionoscloud.pulumi.ionoscloud.vpn.inputs.WireguardPeerEndpointArgs;
...
public final class WireguardPeerState extends com.pulumi.resources.ResourceArgs {

    public static final WireguardPeerState Empty = new WireguardPeerState();
    ...
    private WireguardPeerState() {}

    private WireguardPeerState(WireguardPeerState $) {
    ...
    public static Builder builder(WireguardPeerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WireguardPeerState();
        }

        public Builder(WireguardPeerState defaults) {
            $ = new WireguardPeerState(Objects.requireNonNull(defaults));
        }
        ...
        public WireguardPeerState build() {
            return $;
        }
    }
