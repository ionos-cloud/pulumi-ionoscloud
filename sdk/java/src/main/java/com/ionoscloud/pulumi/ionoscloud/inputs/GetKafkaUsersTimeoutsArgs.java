...
public final class GetKafkaUsersTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetKafkaUsersTimeoutsArgs Empty = new GetKafkaUsersTimeoutsArgs();
    ...
    private GetKafkaUsersTimeoutsArgs() {}

    private GetKafkaUsersTimeoutsArgs(GetKafkaUsersTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetKafkaUsersTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaUsersTimeoutsArgs();
        }

        public Builder(GetKafkaUsersTimeoutsArgs defaults) {
            $ = new GetKafkaUsersTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaUsersTimeoutsArgs build() {
            return $;
        }
    }
