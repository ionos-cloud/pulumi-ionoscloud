...
public final class RouteState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<RouteUpstreamArgs>> upstreams;

    /**
     * @return Upstreams information of the API Gateway Route. Minimum items: 1.
     * 
     */
    public Optional<Output<List<RouteUpstreamArgs>>> upstreams() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder upstreams(@Nullable Output<List<RouteUpstreamArgs>> upstreams) {
            $.upstreams = upstreams;
            return this;
        }
