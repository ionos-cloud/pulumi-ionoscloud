...
import com.ionoscloud.pulumi.ionoscloud.compute.outputs.GetServerNicFirewallRule;
...
@CustomType
public final class GetServerNic {
    /**
     ...
     * 
     */
    private List<GetServerNicFirewallRule> firewallRules;
    /**
     ...
     * 
     */
    public List<GetServerNicFirewallRule> firewallRules() {
    ...
    public static Builder builder(GetServerNic defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> securityGroupsIds;
        public Builder() {}
        public Builder(GetServerNic defaults) {
        ...
        public Builder deviceNumber(Integer deviceNumber) {
            if (deviceNumber == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "deviceNumber");
            }
        ...
        public Builder dhcp(Boolean dhcp) {
            if (dhcp == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "dhcp");
            }
            this.dhcp = dhcp;
            return this;
        }
        ...
        public Builder firewallActive(Boolean firewallActive) {
            if (firewallActive == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "firewallActive");
            }
            this.firewallActive = firewallActive;
            return this;
        }
        @CustomType.Setter
        public Builder firewallRules(List<GetServerNicFirewallRule> firewallRules) {
            if (firewallRules == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "firewallRules");
            }
            this.firewallRules = firewallRules;
            return this;
        }
        public Builder firewallRules(GetServerNicFirewallRule... firewallRules) {
            return firewallRules(List.of(firewallRules));
        }
        @CustomType.Setter
        public Builder firewallType(String firewallType) {
            if (firewallType == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "firewallType");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder ipv6CidrBlock(String ipv6CidrBlock) {
            if (ipv6CidrBlock == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "ipv6CidrBlock");
            }
        ...
        public Builder ipv6Ips(List<String> ipv6Ips) {
            if (ipv6Ips == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "ipv6Ips");
            }
        ...
        public Builder lan(Integer lan) {
            if (lan == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "lan");
            }
            this.lan = lan;
            return this;
        }
        ...
        public Builder mac(String mac) {
            if (mac == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "mac");
            }
            this.mac = mac;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder pciSlot(Integer pciSlot) {
            if (pciSlot == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "pciSlot");
            }
        ...
        public Builder securityGroupsIds(List<String> securityGroupsIds) {
            if (securityGroupsIds == null) {
              throw new MissingRequiredPropertyException("GetServerNic", "securityGroupsIds");
            }
        ...
        public GetServerNic build() {
            final var _resultValue = new GetServerNic();
