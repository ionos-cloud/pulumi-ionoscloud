...
@CustomType
public final class GetCrossconnectPeer {
    /**
    ...
    public static Builder builder(GetCrossconnectPeer defaults) {
    ...
    public static final class Builder {
        ...
        private String location;
        public Builder() {}
        public Builder(GetCrossconnectPeer defaults) {
        ...
        public Builder datacenterId(String datacenterId) {
            if (datacenterId == null) {
              throw new MissingRequiredPropertyException("GetCrossconnectPeer", "datacenterId");
            }
        ...
        public Builder datacenterName(String datacenterName) {
            if (datacenterName == null) {
              throw new MissingRequiredPropertyException("GetCrossconnectPeer", "datacenterName");
            }
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("GetCrossconnectPeer", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        public Builder lanName(String lanName) {
            if (lanName == null) {
              throw new MissingRequiredPropertyException("GetCrossconnectPeer", "lanName");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetCrossconnectPeer", "location");
            }
            this.location = location;
            return this;
        }
        public GetCrossconnectPeer build() {
            final var _resultValue = new GetCrossconnectPeer();
