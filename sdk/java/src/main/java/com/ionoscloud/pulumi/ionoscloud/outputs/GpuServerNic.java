...
import com.ionoscloud.pulumi.ionoscloud.outputs.GpuServerNicFirewall;
...
@CustomType
public final class GpuServerNic {
     ...
     * 
     */
    private @Nullable GpuServerNicFirewall firewall;
     ...
     * 
     */
    public Optional<GpuServerNicFirewall> firewall() {
    ...
    public static Builder builder(GpuServerNic defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> securityGroupsIds;
        public Builder() {}
        public Builder(GpuServerNic defaults) {
        ...
        @CustomType.Setter
        public Builder firewall(@Nullable GpuServerNicFirewall firewall) {
        ...
        public Builder lan(Integer lan) {
            if (lan == null) {
              throw new MissingRequiredPropertyException("GpuServerNic", "lan");
            }
            this.lan = lan;
            return this;
        }
        ...
        public GpuServerNic build() {
            final var _resultValue = new GpuServerNic();
