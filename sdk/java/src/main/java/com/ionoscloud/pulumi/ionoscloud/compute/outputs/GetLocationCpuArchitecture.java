...
@CustomType
public final class GetLocationCpuArchitecture {
    /**
    ...
    private GetLocationCpuArchitecture() {}
    /**
     * @return A valid CPU family name.
     * 
     */
    ...
    public static Builder builder(GetLocationCpuArchitecture defaults) {
    ...
    public static final class Builder {
        ...
        public Builder cpuFamily(String cpuFamily) {
            if (cpuFamily == null) {
              throw new MissingRequiredPropertyException("GetLocationCpuArchitecture", "cpuFamily");
            }
        ...
        public Builder maxCores(Integer maxCores) {
            if (maxCores == null) {
              throw new MissingRequiredPropertyException("GetLocationCpuArchitecture", "maxCores");
            }
        ...
        public Builder maxRam(Integer maxRam) {
            if (maxRam == null) {
              throw new MissingRequiredPropertyException("GetLocationCpuArchitecture", "maxRam");
            }
            this.maxRam = maxRam;
            return this;
        }
        ...
        public Builder vendor(String vendor) {
            if (vendor == null) {
              throw new MissingRequiredPropertyException("GetLocationCpuArchitecture", "vendor");
            }
            this.vendor = vendor;
            return this;
        }
