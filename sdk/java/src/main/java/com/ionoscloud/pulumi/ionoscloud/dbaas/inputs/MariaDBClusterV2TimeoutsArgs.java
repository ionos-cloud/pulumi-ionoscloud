...
public final class MariaDBClusterV2TimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final MariaDBClusterV2TimeoutsArgs Empty = new MariaDBClusterV2TimeoutsArgs();
    ...
    private MariaDBClusterV2TimeoutsArgs() {}

    private MariaDBClusterV2TimeoutsArgs(MariaDBClusterV2TimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(MariaDBClusterV2TimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MariaDBClusterV2TimeoutsArgs();
        }

        public Builder(MariaDBClusterV2TimeoutsArgs defaults) {
            $ = new MariaDBClusterV2TimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MariaDBClusterV2TimeoutsArgs build() {
            return $;
        }
    }
