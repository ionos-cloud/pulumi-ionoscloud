...
public final class CubeServerNicFirewall {
    ...
    public static Builder builder(CubeServerNicFirewall defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(CubeServerNicFirewall defaults) {
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("CubeServerNicFirewall", "protocol");
            }
        ...
        public CubeServerNicFirewall build() {
