...
@CustomType
public final class GpuServerVolume {
    /**
    ...
    public static Builder builder(GpuServerVolume defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userData;
        public Builder() {}
        public Builder(GpuServerVolume defaults) {
        ...
        public GpuServerVolume build() {
            final var _resultValue = new GpuServerVolume();
