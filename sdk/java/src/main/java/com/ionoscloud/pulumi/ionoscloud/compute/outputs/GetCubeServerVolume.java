...
@CustomType
public final class GetCubeServerVolume {
    /**
    ...
    public static Builder builder(GetCubeServerVolume defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userData;
        public Builder() {}
        public Builder(GetCubeServerVolume defaults) {
        ...
        public Builder availabilityZone(String availabilityZone) {
            if (availabilityZone == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "availabilityZone");
            }
        ...
        public Builder backupUnitId(String backupUnitId) {
            if (backupUnitId == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "backupUnitId");
            }
        ...
        public Builder bootServer(String bootServer) {
            if (bootServer == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "bootServer");
            }
        ...
        public Builder bus(String bus) {
            if (bus == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "bus");
            }
            this.bus = bus;
            return this;
        }
        ...
        public Builder cpuHotPlug(Boolean cpuHotPlug) {
            if (cpuHotPlug == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "cpuHotPlug");
            }
        ...
        public Builder deviceNumber(Integer deviceNumber) {
            if (deviceNumber == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "deviceNumber");
            }
        ...
        public Builder discVirtioHotPlug(Boolean discVirtioHotPlug) {
            if (discVirtioHotPlug == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "discVirtioHotPlug");
            }
        ...
        public Builder discVirtioHotUnplug(Boolean discVirtioHotUnplug) {
            if (discVirtioHotUnplug == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "discVirtioHotUnplug");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder imageName(String imageName) {
            if (imageName == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "imageName");
            }
        ...
        public Builder imagePassword(String imagePassword) {
            if (imagePassword == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "imagePassword");
            }
        ...
        public Builder licenceType(String licenceType) {
            if (licenceType == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "licenceType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder nicHotPlug(Boolean nicHotPlug) {
            if (nicHotPlug == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "nicHotPlug");
            }
        ...
        public Builder nicHotUnplug(Boolean nicHotUnplug) {
            if (nicHotUnplug == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "nicHotUnplug");
            }
        ...
        public Builder pciSlot(Integer pciSlot) {
            if (pciSlot == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "pciSlot");
            }
        ...
        public Builder ramHotPlug(Boolean ramHotPlug) {
            if (ramHotPlug == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "ramHotPlug");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetCubeServerVolume", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public GetCubeServerVolume build() {
            final var _resultValue = new GetCubeServerVolume();
