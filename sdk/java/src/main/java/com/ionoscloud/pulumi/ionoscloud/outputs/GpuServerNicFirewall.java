...
@CustomType
public final class GpuServerNicFirewall {
    ...
    public static Builder builder(GpuServerNicFirewall defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(GpuServerNicFirewall defaults) {
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GpuServerNicFirewall", "protocol");
            }
        ...
        public GpuServerNicFirewall build() {
            final var _resultValue = new GpuServerNicFirewall();
