...
public final class MariaDBClusterV2InstancesArgs extends com.pulumi.resources.ResourceArgs {

    public static final MariaDBClusterV2InstancesArgs Empty = new MariaDBClusterV2InstancesArgs();
    ...
    private MariaDBClusterV2InstancesArgs() {}

    private MariaDBClusterV2InstancesArgs(MariaDBClusterV2InstancesArgs $) {
        this.cores = $.cores;
        this.count = $.count;
        this.ram = $.ram;
    ...
    public static Builder builder(MariaDBClusterV2InstancesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MariaDBClusterV2InstancesArgs();
        }

        public Builder(MariaDBClusterV2InstancesArgs defaults) {
            $ = new MariaDBClusterV2InstancesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MariaDBClusterV2InstancesArgs build() {
            if ($.cores == null) {
                throw new MissingRequiredPropertyException("MariaDBClusterV2InstancesArgs", "cores");
            }
            if ($.count == null) {
                throw new MissingRequiredPropertyException("MariaDBClusterV2InstancesArgs", "count");
            }
            if ($.ram == null) {
                throw new MissingRequiredPropertyException("MariaDBClusterV2InstancesArgs", "ram");
            }
            if ($.storageSize == null) {
                throw new MissingRequiredPropertyException("MariaDBClusterV2InstancesArgs", "storageSize");
            }
            return $;
        }
    }
