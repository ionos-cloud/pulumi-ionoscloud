...
public final class IpsecGatewayArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpsecGatewayArgs Empty = new IpsecGatewayArgs();
    ...
    private Output<List<IpsecGatewayConnectionArgs>> connections;
     ...
     * 
     */
    public Output<List<IpsecGatewayConnectionArgs>> connections() {
    ...
    private IpsecGatewayArgs() {}

    private IpsecGatewayArgs(IpsecGatewayArgs $) {
    ...
    public static Builder builder(IpsecGatewayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpsecGatewayArgs();
        }

        public Builder(IpsecGatewayArgs defaults) {
            $ = new IpsecGatewayArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder connections(Output<List<IpsecGatewayConnectionArgs>> connections) {
        ...
        /**
         * @param location [string] The location of the IPSec Gateway. Supported locations: de/fra, de/fra/1, de/fra/2, de/txl, es/vit, gb/bhx, gb/lhr, us/ewr, us/las, us/mci, fr/par.
         * 
         * @return builder
         * 
         */
        ...
        public IpsecGatewayArgs build() {
            if ($.connections == null) {
                throw new MissingRequiredPropertyException("IpsecGatewayArgs", "connections");
            }
            if ($.gatewayIp == null) {
                throw new MissingRequiredPropertyException("IpsecGatewayArgs", "gatewayIp");
            }
            return $;
        }
    }
