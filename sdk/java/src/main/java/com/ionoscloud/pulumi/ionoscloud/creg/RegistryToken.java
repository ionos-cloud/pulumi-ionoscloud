...
import com.ionoscloud.pulumi.ionoscloud.creg.inputs.RegistryTokenState;
import com.ionoscloud.pulumi.ionoscloud.creg.outputs.RegistryTokenCredential;
import com.ionoscloud.pulumi.ionoscloud.creg.outputs.RegistryTokenScope;
...
public class RegistryToken extends com.pulumi.resources.CustomResource {
    ...
    public RegistryToken(java.lang.String name, RegistryTokenArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:creg/registryToken:RegistryToken", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RegistryToken(java.lang.String name, Output<java.lang.String> id, @Nullable RegistryTokenState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ionoscloud:creg/registryToken:RegistryToken", name, state, makeResourceOptions(options, id), false);
    }
