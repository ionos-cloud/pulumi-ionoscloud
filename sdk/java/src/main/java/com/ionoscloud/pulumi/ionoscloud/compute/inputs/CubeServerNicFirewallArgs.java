...
public final class CubeServerNicFirewallArgs extends com.pulumi.resources.ResourceArgs {

    public static final CubeServerNicFirewallArgs Empty = new CubeServerNicFirewallArgs();
    ...
    private CubeServerNicFirewallArgs() {}
    ...
    public static Builder builder(CubeServerNicFirewallArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CubeServerNicFirewallArgs();
        }

        public Builder(CubeServerNicFirewallArgs defaults) {
            $ = new CubeServerNicFirewallArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CubeServerNicFirewallArgs build() {
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("CubeServerNicFirewallArgs", "protocol");
            }
            return $;
        }
    }
