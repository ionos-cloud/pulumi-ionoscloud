...
import com.ionoscloud.pulumi.ionoscloud.compute.outputs.GetCubeServerNicFirewallRule;
...
@CustomType
public final class GetCubeServerNic {
    /**
     ...
     * 
     */
    private List<GetCubeServerNicFirewallRule> firewallRules;
    /**
     ...
     * 
     */
    public List<GetCubeServerNicFirewallRule> firewallRules() {
    ...
    public static Builder builder(GetCubeServerNic defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> securityGroupsIds;
        public Builder() {}
        public Builder(GetCubeServerNic defaults) {
        ...
        public Builder deviceNumber(Integer deviceNumber) {
            if (deviceNumber == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "deviceNumber");
            }
        ...
        public Builder dhcp(Boolean dhcp) {
            if (dhcp == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "dhcp");
            }
            this.dhcp = dhcp;
            return this;
        }
        ...
        public Builder firewallActive(Boolean firewallActive) {
            if (firewallActive == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "firewallActive");
            }
            this.firewallActive = firewallActive;
            return this;
        }
        @CustomType.Setter
        public Builder firewallRules(List<GetCubeServerNicFirewallRule> firewallRules) {
            if (firewallRules == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "firewallRules");
            }
            this.firewallRules = firewallRules;
            return this;
        }
        public Builder firewallRules(GetCubeServerNicFirewallRule... firewallRules) {
            return firewallRules(List.of(firewallRules));
        }
        @CustomType.Setter
        public Builder firewallType(String firewallType) {
            if (firewallType == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "firewallType");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder ipv6CidrBlock(String ipv6CidrBlock) {
            if (ipv6CidrBlock == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "ipv6CidrBlock");
            }
        ...
        public Builder ipv6Ips(List<String> ipv6Ips) {
            if (ipv6Ips == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "ipv6Ips");
            }
        ...
        public Builder lan(Integer lan) {
            if (lan == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "lan");
            }
            this.lan = lan;
            return this;
        }
        ...
        public Builder mac(String mac) {
            if (mac == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "mac");
            }
            this.mac = mac;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder pciSlot(Integer pciSlot) {
            if (pciSlot == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "pciSlot");
            }
        ...
        public Builder securityGroupsIds(List<String> securityGroupsIds) {
            if (securityGroupsIds == null) {
              throw new MissingRequiredPropertyException("GetCubeServerNic", "securityGroupsIds");
            }
        ...
        public GetCubeServerNic build() {
            final var _resultValue = new GetCubeServerNic();
