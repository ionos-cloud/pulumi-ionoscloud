...
import com.ionoscloud.pulumi.ionoscloud.dsaas.inputs.NodePoolAutoScalingArgs;
import com.ionoscloud.pulumi.ionoscloud.dsaas.inputs.NodePoolMaintenanceWindowArgs;
...
public final class NodePoolState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<NodePoolMaintenanceWindowArgs>> maintenanceWindows;

    /**
     * @return Starting time of a weekly 4 hour-long window, during which maintenance might occur in hh:mm:ss format
     * 
     */
    public Optional<Output<List<NodePoolMaintenanceWindowArgs>>> maintenanceWindows() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder maintenanceWindows(@Nullable Output<List<NodePoolMaintenanceWindowArgs>> maintenanceWindows) {
         ...
         * 
         */
        public Builder maintenanceWindows(List<NodePoolMaintenanceWindowArgs> maintenanceWindows) {
         ...
         * 
         */
        public Builder maintenanceWindows(NodePoolMaintenanceWindowArgs... maintenanceWindows) {
