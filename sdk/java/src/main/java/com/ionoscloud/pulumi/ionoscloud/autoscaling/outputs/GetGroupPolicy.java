...
public final class GetGroupPolicy {
    ...
    /**
     * @return The upper threshold for the value of the &lt;span pulumi-lang-nodejs=&#34;`metric`&#34; pulumi-lang-dotnet=&#34;`Metric`&#34; pulumi-lang-go=&#34;`metric`&#34; pulumi-lang-python=&#34;`metric`&#34; pulumi-lang-yaml=&#34;`metric`&#34; pulumi-lang-java=&#34;`metric`&#34;&gt;`metric`&lt;/span&gt;. Used with the `greater than` (&gt;) operator. A scale-out action is triggered when this value is exceeded, specified by the `scaleOutAction` property. The value must have a lower minimum delta to the `scaleInThreshold`, depending on the metric, to avoid competing for actions simultaneously. If `properties.policy.unit=TOTAL`, a value &gt;= 40 must be chosen.
     * 
     */
