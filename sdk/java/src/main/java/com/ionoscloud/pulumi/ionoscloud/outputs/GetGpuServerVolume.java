...
@CustomType
public final class GetGpuServerVolume {
    /**
    ...
    /**
     * @return The Logical Unit Number of the storage volume
     * 
     */
    ...
    /**
     * @return The PCI slot number of the storage volume
     * 
     */
    ...
    public static Builder builder(GetGpuServerVolume defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userData;
        public Builder() {}
        public Builder(GetGpuServerVolume defaults) {
        ...
        public Builder availabilityZone(String availabilityZone) {
            if (availabilityZone == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "availabilityZone");
            }
        ...
        public Builder backupUnitId(String backupUnitId) {
            if (backupUnitId == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "backupUnitId");
            }
        ...
        public Builder bootServer(String bootServer) {
            if (bootServer == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "bootServer");
            }
        ...
        public Builder bus(String bus) {
            if (bus == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "bus");
            }
            this.bus = bus;
            return this;
        }
        ...
        public Builder cpuHotPlug(Boolean cpuHotPlug) {
            if (cpuHotPlug == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "cpuHotPlug");
            }
        ...
        public Builder deviceNumber(Integer deviceNumber) {
            if (deviceNumber == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "deviceNumber");
            }
        ...
        public Builder discVirtioHotPlug(Boolean discVirtioHotPlug) {
            if (discVirtioHotPlug == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "discVirtioHotPlug");
            }
        ...
        public Builder discVirtioHotUnplug(Boolean discVirtioHotUnplug) {
            if (discVirtioHotUnplug == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "discVirtioHotUnplug");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder imageName(String imageName) {
            if (imageName == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "imageName");
            }
        ...
        public Builder imagePassword(String imagePassword) {
            if (imagePassword == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "imagePassword");
            }
        ...
        public Builder licenceType(String licenceType) {
            if (licenceType == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "licenceType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder nicHotPlug(Boolean nicHotPlug) {
            if (nicHotPlug == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "nicHotPlug");
            }
        ...
        public Builder nicHotUnplug(Boolean nicHotUnplug) {
            if (nicHotUnplug == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "nicHotUnplug");
            }
        ...
        public Builder pciSlot(Integer pciSlot) {
            if (pciSlot == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "pciSlot");
            }
        ...
        public Builder ramHotPlug(Boolean ramHotPlug) {
            if (ramHotPlug == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "ramHotPlug");
            }
        ...
        public Builder requireLegacyBios(Boolean requireLegacyBios) {
            if (requireLegacyBios == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "requireLegacyBios");
            }
        ...
        public Builder sshKeys(List<String> sshKeys) {
            if (sshKeys == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "sshKeys");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetGpuServerVolume", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public GetGpuServerVolume build() {
            final var _resultValue = new GetGpuServerVolume();
