...
@CustomType
public final class GetGroupPolicyScaleInAction {
    /**
    ...
    private GetGroupPolicyScaleInAction() {}
    /**
     * @return When `amountType == ABSOLUTE`, this is the number of VMs added or removed in one step. When `amountType == PERCENTAGE`, this is a percentage value, which will be applied to the Autoscaling Group&#39;s current `targetReplicaCount` in order to derive the number of VMs that will be added or removed in one step. There will always be at least one VM added or removed.
     * 
     */
    ...
    public static Builder builder(GetGroupPolicyScaleInAction defaults) {
    ...
    public static final class Builder {
        ...
        private String terminationPolicyType;
        public Builder() {}
        public Builder(GetGroupPolicyScaleInAction defaults) {
        ...
        public Builder amount(Integer amount) {
            if (amount == null) {
              throw new MissingRequiredPropertyException("GetGroupPolicyScaleInAction", "amount");
            }
            this.amount = amount;
            return this;
        }
        ...
        public Builder amountType(String amountType) {
            if (amountType == null) {
              throw new MissingRequiredPropertyException("GetGroupPolicyScaleInAction", "amountType");
            }
        ...
        public Builder cooldownPeriod(String cooldownPeriod) {
            if (cooldownPeriod == null) {
              throw new MissingRequiredPropertyException("GetGroupPolicyScaleInAction", "cooldownPeriod");
            }
        ...
        public Builder deleteVolumes(Boolean deleteVolumes) {
            if (deleteVolumes == null) {
              throw new MissingRequiredPropertyException("GetGroupPolicyScaleInAction", "deleteVolumes");
            }
        ...
        public Builder terminationPolicyType(String terminationPolicyType) {
            if (terminationPolicyType == null) {
              throw new MissingRequiredPropertyException("GetGroupPolicyScaleInAction", "terminationPolicyType");
            }
            this.terminationPolicyType = terminationPolicyType;
            return this;
        }
        public GetGroupPolicyScaleInAction build() {
            final var _resultValue = new GetGroupPolicyScaleInAction();
