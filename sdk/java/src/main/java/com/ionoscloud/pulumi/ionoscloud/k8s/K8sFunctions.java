...
import com.ionoscloud.pulumi.ionoscloud.k8s.inputs.GetClusterArgs;
import com.ionoscloud.pulumi.ionoscloud.k8s.inputs.GetClusterPlainArgs;
import com.ionoscloud.pulumi.ionoscloud.k8s.inputs.GetClustersArgs;
import com.ionoscloud.pulumi.ionoscloud.k8s.inputs.GetClustersPlainArgs;
import com.ionoscloud.pulumi.ionoscloud.k8s.inputs.GetNodePoolArgs;
import com.ionoscloud.pulumi.ionoscloud.k8s.inputs.GetNodePoolNodesArgs;
import com.ionoscloud.pulumi.ionoscloud.k8s.inputs.GetNodePoolNodesPlainArgs;
import com.ionoscloud.pulumi.ionoscloud.k8s.inputs.GetNodePoolPlainArgs;
import com.ionoscloud.pulumi.ionoscloud.k8s.outputs.GetClusterResult;
import com.ionoscloud.pulumi.ionoscloud.k8s.outputs.GetClustersResult;
import com.ionoscloud.pulumi.ionoscloud.k8s.outputs.GetNodePoolNodesResult;
import com.ionoscloud.pulumi.ionoscloud.k8s.outputs.GetNodePoolResult;
...
public final class K8sFunctions {
     ...
     * import com.pulumi.ionoscloud.k8s.inputs.GetClustersFilterArgs;
     * import java.util.ArrayList;
     * import java.util.Arrays;
     * import java.util.Map;
     * import java.io.File;
