...
@CustomType
public final class VCPUServerVolume {
    /**
    ...
    public static Builder builder(VCPUServerVolume defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userData;
        public Builder() {}
        public Builder(VCPUServerVolume defaults) {
        ...
        public Builder diskType(String diskType) {
            if (diskType == null) {
              throw new MissingRequiredPropertyException("VCPUServerVolume", "diskType");
            }
        ...
        public VCPUServerVolume build() {
            final var _resultValue = new VCPUServerVolume();
