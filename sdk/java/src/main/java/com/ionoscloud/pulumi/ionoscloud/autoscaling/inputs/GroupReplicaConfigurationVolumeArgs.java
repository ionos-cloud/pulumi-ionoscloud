...
public final class GroupReplicaConfigurationVolumeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupReplicaConfigurationVolumeArgs Empty = new GroupReplicaConfigurationVolumeArgs();
    ...
    private GroupReplicaConfigurationVolumeArgs() {}

    private GroupReplicaConfigurationVolumeArgs(GroupReplicaConfigurationVolumeArgs $) {
    ...
    public static Builder builder(GroupReplicaConfigurationVolumeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupReplicaConfigurationVolumeArgs();
        }

        public Builder(GroupReplicaConfigurationVolumeArgs defaults) {
            $ = new GroupReplicaConfigurationVolumeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupReplicaConfigurationVolumeArgs build() {
            if ($.bootOrder == null) {
                throw new MissingRequiredPropertyException("GroupReplicaConfigurationVolumeArgs", "bootOrder");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GroupReplicaConfigurationVolumeArgs", "name");
            }
            if ($.size == null) {
                throw new MissingRequiredPropertyException("GroupReplicaConfigurationVolumeArgs", "size");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("GroupReplicaConfigurationVolumeArgs", "type");
            }
            return $;
        }
    }
