...
public final class NodePoolState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="k8sClusterId")
    private @Nullable Output<String> k8sClusterId;

    /**
     * @return [string] A k8s cluster&#39;s UUID
     * 
     */
    public Optional<Output<String>> k8sClusterId() {
        return Optional.ofNullable(this.k8sClusterId);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder k8sClusterId(@Nullable Output<String> k8sClusterId) {
