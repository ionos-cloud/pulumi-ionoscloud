...
import com.ionoscloud.pulumi.ionoscloud.vpn.inputs.WireguardGatewayConnectionArgs;
import com.ionoscloud.pulumi.ionoscloud.vpn.inputs.WireguardGatewayMaintenanceWindowArgs;
...
public final class WireguardGatewayState extends com.pulumi.resources.ResourceArgs {

    public static final WireguardGatewayState Empty = new WireguardGatewayState();
    ...
    private @Nullable Output<List<WireguardGatewayConnectionArgs>> connections;

    /**
     * @return [Block] The connection configuration for the WireGuard Gateway. This block supports fields documented below.
     * 
     */
    public Optional<Output<List<WireguardGatewayConnectionArgs>>> connections() {
    ...
    private WireguardGatewayState() {}

    private WireguardGatewayState(WireguardGatewayState $) {
    ...
    public static Builder builder(WireguardGatewayState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WireguardGatewayState();
        }

        public Builder(WireguardGatewayState defaults) {
            $ = new WireguardGatewayState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder connections(@Nullable Output<List<WireguardGatewayConnectionArgs>> connections) {
        ...
        /**
         * @param location [String] The location of the WireGuard Gateway. Supported locations: de/fra, de/fra/1, de/fra/2, de/txl, es/vit, gb/bhx, gb/lhr, us/ewr, us/las, us/mci, fr/par.
         * 
         * @return builder
         * 
         */
        ...
        public WireguardGatewayState build() {
            return $;
        }
    }
