...
import com.ionoscloud.pulumi.ionoscloud.inputs.GpuServerNicFirewallArgs;
...
public final class GpuServerNicArgs extends com.pulumi.resources.ResourceArgs {

    public static final GpuServerNicArgs Empty = new GpuServerNicArgs();
    ...
    private @Nullable Output<GpuServerNicFirewallArgs> firewall;
     ...
     * 
     */
    public Optional<Output<GpuServerNicFirewallArgs>> firewall() {
    ...
    private GpuServerNicArgs() {}

    private GpuServerNicArgs(GpuServerNicArgs $) {
    ...
    public static Builder builder(GpuServerNicArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GpuServerNicArgs();
        }

        public Builder(GpuServerNicArgs defaults) {
            $ = new GpuServerNicArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder firewall(@Nullable Output<GpuServerNicFirewallArgs> firewall) {
            $.firewall = firewall;
            return this;
        }
         ...
         * 
         */
        public Builder firewall(GpuServerNicFirewallArgs firewall) {
        ...
        public GpuServerNicArgs build() {
            if ($.lan == null) {
                throw new MissingRequiredPropertyException("GpuServerNicArgs", "lan");
            }
            return $;
        }
    }
