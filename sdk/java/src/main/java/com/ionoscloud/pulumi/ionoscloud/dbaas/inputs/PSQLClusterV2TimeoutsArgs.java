...
public final class PSQLClusterV2TimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PSQLClusterV2TimeoutsArgs Empty = new PSQLClusterV2TimeoutsArgs();
    ...
    private PSQLClusterV2TimeoutsArgs() {}

    private PSQLClusterV2TimeoutsArgs(PSQLClusterV2TimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(PSQLClusterV2TimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PSQLClusterV2TimeoutsArgs();
        }

        public Builder(PSQLClusterV2TimeoutsArgs defaults) {
            $ = new PSQLClusterV2TimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PSQLClusterV2TimeoutsArgs build() {
            return $;
        }
    }
