...
class TopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: [string] The location of the Kafka Cluster Topic. Possible values: `de/fra`, `de/txl`. If this is not set and if no value is provided for the `IONOS_API_URL` env var, the default `location` will be: `de/fra`.
        ...
        :param pulumi.Input[_builtins.int] number_of_partitions: [int] The number of partitions of the topic. Partitions allow for parallel
               ...
               Default value: 3.
        :param pulumi.Input[_builtins.int] replication_factor: [int] The number of replicas of the topic. The replication factor determines how many
        ...
        :param pulumi.Input[_builtins.int] retention_time: [int] This configuration controls the maximum time we will retain a log before we will
        ...
        :param pulumi.Input[_builtins.int] segment_bytes: [int] This configuration controls the segment file size for the log. Retention and
...
@pulumi.type_token("ionoscloud:kafka/topic:Topic")
class Topic(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="numberOfPartitions")
    def number_of_partitions(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        [int] The number of partitions of the topic. Partitions allow for parallel
        processing of messages. The partition count must be greater than or equal to the replication factor. Minimum value: 1.
        Default value: 3.
    ...
    @_builtins.property
    @pulumi.getter(name="segmentBytes")
    def segment_bytes(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        [int] This configuration controls the segment file size for the log. Retention and
        cleaning is always done a file at a time so a larger segment size means fewer files but less granular control over
        retention. Default value: 1073741824.
