...
class GetDistributionResult:
    ...
    def public_endpoint_v4(self) -> _builtins.str:
        """
    ...
    def public_endpoint_v6(self) -> _builtins.str:
        """
...
def get_distribution(domain: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain: Domain of an existing distribution that you want to search for. Search by domain is case-insensitive. The whole resource domain is required if `partial_match` parameter is not set to true.
    :param _builtins.str id: ID of the distribution you want to search for.
    :param _builtins.bool partial_match: Whether partial matching is allowed or not when using domain argument. Default value is false.
