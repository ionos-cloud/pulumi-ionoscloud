...
class FirewallArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_ip: [string] Only traffic originating from the respective IPv4 address is allowed. Value null allows all source IPs.
        ...
        :param pulumi.Input[_builtins.str] target_ip: [string] In case the target NIC has multiple IP addresses, only traffic directed to the respective IP address of the NIC is allowed. Value null allows all target IPs.
        :param pulumi.Input[_builtins.str] type: [string] The type of firewall rule. If is not specified, it will take the default value INGRESS.
        """
...
@pulumi.type_token("ionoscloud:compute/firewall:Firewall")
class Firewall(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="icmpCode")
    def icmp_code(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        [int] Defines the allowed code (from 0 to 254) if protocol ICMP is chosen.
        """
        return pulumi.get(self, "icmp_code")
    ...
    @_builtins.property
    @pulumi.getter(name="icmpType")
    def icmp_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        [string] Defines the allowed code (from 0 to 254) if protocol ICMP is chosen. Value null allows all codes.
        """
        return pulumi.get(self, "icmp_type")
    ...
    @_builtins.property
    @pulumi.getter(name="portRangeEnd")
    def port_range_end(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        [int] Defines the end range of the allowed port (from 1 to 65534) if the protocol TCP or UDP is chosen. Leave portRangeStart and portRangeEnd null to allow all ports.
        """
        return pulumi.get(self, "port_range_end")
    ...
    @_builtins.property
    @pulumi.getter(name="portRangeStart")
    def port_range_start(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        [int] Defines the start range of the allowed port (from 1 to 65534) if protocol TCP or UDP is chosen. Leave portRangeStart and portRangeEnd null to allow all ports.
        """
        return pulumi.get(self, "port_range_start")
    ...
    @_builtins.property
    @pulumi.getter(name="sourceMac")
    def source_mac(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        [string] Only traffic originating from the respective MAC address is allowed. Valid format: aa:bb:cc:dd:ee:ff. Value null allows all source MAC address. Valid format: aa:bb:cc:dd:ee:ff.
        """
        return pulumi.get(self, "source_mac")
