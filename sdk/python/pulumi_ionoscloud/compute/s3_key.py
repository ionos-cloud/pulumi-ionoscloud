...
class S3KeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_id: [string] The UUID of the user owning the IONOS Object Storage Key.
        :param pulumi.Input[_builtins.bool] active: [boolean] Whether the IONOS Object Storage is active / enabled or not - Please keep in mind this is only required on create. Default value in true
        """
...
class _S3KeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] active: [boolean] Whether the IONOS Object Storage is active / enabled or not - Please keep in mind this is only required on create. Default value in true
        :param pulumi.Input[_builtins.str] secret_key: The IONOS Object Storage Secret key.
        :param pulumi.Input[_builtins.str] user_id: [string] The UUID of the user owning the IONOS Object Storage Key.
        """
        if active is not None:
            pulumi.set(__self__, "active", active)
...
@pulumi.type_token("ionoscloud:compute/s3Key:S3Key")
class S3Key(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            active: pulumi.Input[Optional[_builtins.bool]] = None,
            secret_key: pulumi.Input[Optional[_builtins.str]] = None,
            user_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'S3Key':
        """
