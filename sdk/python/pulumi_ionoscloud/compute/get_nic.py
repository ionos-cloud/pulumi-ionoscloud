...
def get_nic(datacenter_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str datacenter_id: [string] The ID of a Virtual Data Center.
    ...
    :param _builtins.str server_id: [string] The ID of a server.
    """
    __args__ = dict()
...
def get_nic_output(datacenter_id: pulumi.Input[Optional[_builtins.str]] = None,
