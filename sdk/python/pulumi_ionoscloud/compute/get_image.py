...
def get_image(cloud_init: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_init: Cloud init compatibility ("NONE" or "V1"). Exact match.
    :param _builtins.str description: description of the image
    :param _builtins.str image_alias: Image alias of the image you are searching for. Exact match. E.g. =`centos:latest`, `ubuntu:latest`
    :param _builtins.str location: Id of the existing image's location. Exact match. Possible values: `de/fra`, `de/txl`, `gb/lhr`, `es/vit`, `us/ewr`, `us/las`
    :param _builtins.str name: Name of an existing image that you want to search for. It will return an exact match if one exists, otherwise it will retrieve partial matches.
    :param _builtins.str type: The image type, HDD or CD-ROM. Exact match.
    :param _builtins.str version: The version of the image that you want to search for.
