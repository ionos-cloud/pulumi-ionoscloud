...
class IPFailoverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip: [string] The reserved IP address to be used in the IP failover group.
    ...
    @_builtins.property
    @pulumi.getter
    def nicuuid(self) -> pulumi.Input[_builtins.str]:
        """
...
@pulumi.type_token("ionoscloud:compute/iPFailover:IPFailover")
class IPFailover(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="lanId")
    def lan_id(self) -> pulumi.Output[_builtins.str]:
        """
        [string] The ID of a LAN.
        """
        return pulumi.get(self, "lan_id")
