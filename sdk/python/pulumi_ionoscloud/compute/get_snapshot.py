...
def get_snapshot(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: UUID of an existing snapshot that you want to search for.
    :param _builtins.str location: Existing snapshot's location.
    :param _builtins.str name: Name of an existing snapshot that you want to search for.
    :param _builtins.int size: The size of the snapshot to look for.
