...
class ServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vm_state: [string] Sets the power state of the server. E.g: `RUNNING`, `SHUTOFF` or `SUSPENDED`. SUSPENDED state is only valid for cube. SHUTOFF state is only valid for enterprise.
        """
...
@pulumi.type_token("ionoscloud:compute/server:Server")
class Server(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="templateUuid")
    def template_uuid(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        [string] The UUID of the template for creating a CUBE server; the available templates for CUBE servers can be found on the templates resource
        """
        return pulumi.get(self, "template_uuid")
