...
def get_gpus(datacenter_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:compute/getGpus:getGpus', __args__, opts=opts, typ=GetGpusResult).value
...
def get_gpus_output(datacenter_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:compute/getGpus:getGpus', __args__, opts=opts, typ=GetGpusResult)
