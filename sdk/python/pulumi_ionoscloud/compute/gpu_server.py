...
@pulumi.type_token("ionoscloud:compute/gPUServer:GPUServer")
class GPUServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="ionoscloud:index/gpuServer:GpuServer")])
