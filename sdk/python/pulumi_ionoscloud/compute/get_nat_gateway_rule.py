...
class GetNatGatewayRuleResult:
    ...
    def natgateway_id(self) -> _builtins.str:
    ...
    def source_subnet(self) -> _builtins.str:
        """
    ...
    def target_subnet(self) -> _builtins.str:
        """
...
def get_nat_gateway_rule(datacenter_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ID of the NAT gateway rule you want to search for.
    ...
    :param _builtins.str name: Name of an existing NAT gateway rule that you want to search for.
    :param _builtins.str natgateway_id: Nat Gateway's UUID.
    """
    __args__ = dict()
