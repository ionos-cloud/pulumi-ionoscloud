...
def get_ip_failover(datacenter_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str datacenter_id: The ID of the datacenter containing the ip failover datasource
    :param _builtins.str ip: The reserved IP address to be used in the IP failover group.
    :param _builtins.str lan_id: The id of the lan of which the IP failover belongs
    """
    __args__ = dict()
