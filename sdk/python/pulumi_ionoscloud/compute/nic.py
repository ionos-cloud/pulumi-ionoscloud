...
class NicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] dhcp: [Boolean] Indicates if the NIC should get an IP address using DHCP (true) or not (false).
        :param pulumi.Input[_builtins.bool] dhcpv6: [Boolean] Indicates if the NIC should get an IPv6 address using DHCP (true) or not (false).
        :param pulumi.Input[_builtins.bool] firewall_active: [Boolean] If this resource is set to true and is nested under a server resource firewall, with open SSH port, resource must be nested under the NIC.
        :param pulumi.Input[_builtins.str] firewall_type: [String] The type of firewall rules that will be allowed on the NIC. If it is not specified it will take the default value INGRESS
...
class _NicState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] datacenter_id: [string] The ID of a Virtual Data Center.
        :param pulumi.Input[_builtins.int] device_number: The Logical Unit Number (LUN) of the storage volume. Null if this NIC was created from CloudAPI and no DCD changes were done on the Datacenter.
        :param pulumi.Input[_builtins.bool] dhcp: [Boolean] Indicates if the NIC should get an IP address using DHCP (true) or not (false).
        :param pulumi.Input[_builtins.bool] dhcpv6: [Boolean] Indicates if the NIC should get an IPv6 address using DHCP (true) or not (false).
        :param pulumi.Input[_builtins.bool] firewall_active: [Boolean] If this resource is set to true and is nested under a server resource firewall, with open SSH port, resource must be nested under the NIC.
        :param pulumi.Input[_builtins.str] firewall_type: [String] The type of firewall rules that will be allowed on the NIC. If it is not specified it will take the default value INGRESS
...
@pulumi.type_token("ionoscloud:compute/nic:Nic")
class Nic(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="firewallActive")
    def firewall_active(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        [Boolean] If this resource is set to true and is nested under a server resource firewall, with open SSH port, resource must be nested under the NIC.
        """
        return pulumi.get(self, "firewall_active")
    ...
    @_builtins.property
    @pulumi.getter(name="ipv6Ips")
    def ipv6_ips(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        [list] Collection of IPv6 addresses assigned to a NIC. Explicitly assigned public IPs need to come from the NIC's Ipv6 CIDR block, Passing value null or empty array will assign an IPv6 address automatically from the NIC's CIDR block.
        """
        return pulumi.get(self, "ipv6_ips")
    ...
    @_builtins.property
    @pulumi.getter
    def lan(self) -> pulumi.Output[_builtins.int]:
        """
        [integer] The LAN ID the NIC will sit on.
        """
        return pulumi.get(self, "lan")
    ...
    @_builtins.property
    @pulumi.getter(name="pciSlot")
    def pci_slot(self) -> pulumi.Output[_builtins.int]:
        """
        The PCI slot number of the Nic.
        """
        return pulumi.get(self, "pci_slot")
