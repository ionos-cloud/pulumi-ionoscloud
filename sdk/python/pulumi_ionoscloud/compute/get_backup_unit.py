...
def get_backup_unit(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ID of the backup unit you want to search for.
           
           Either `name` or `id` must be provided. If none, or both are provided, the datasource will return an error.
    :param _builtins.str name: Name of an existing backup unit that you want to search for.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
