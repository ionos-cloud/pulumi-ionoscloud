...
def get_resource(resource_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_id: The ID of the specific resource to retrieve information about.
    :param _builtins.str resource_type: The specific type of resources to retrieve information about.
    """
    __args__ = dict()
