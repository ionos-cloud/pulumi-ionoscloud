...
def get_ip_block(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ID of an existing Ip Block that you want to search for.
    :param _builtins.str location: The regional location for this IP Block: us/las, us/ewr, de/fra, de/fkb.
    :param _builtins.str name: Name of an existing Ip Block that you want to search for.
    :param _builtins.int size: The number of IP addresses to reserve for this block.
    """
    __args__ = dict()
    __args__['id'] = id
