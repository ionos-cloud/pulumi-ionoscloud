...
__all__ = [
    'GetGpuServerResult',
    'AwaitableGetGpuServerResult',
    'get_gpu_server',
    'get_gpu_server_output',
]

warnings.warn("""ionoscloud.index/getgpuserver.getGpuServer has been deprecated in favor of ionoscloud.compute/getgpuserver.getGPUServer""", DeprecationWarning)

@pulumi.output_type
class GetGpuServerResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def cdroms(self) -> Sequence['outputs.GetGpuServerCdromResult']:
        """
        list of
        """
    ...
    @_builtins.property
    @pulumi.getter
    def nics(self) -> Sequence['outputs.GetGpuServerNicResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def volumes(self) -> Sequence['outputs.GetGpuServerVolumeResult']:
        """
        list of
        """
...
class AwaitableGetGpuServerResult(GetGpuServerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGpuServerResult(
...
def get_gpu_server(datacenter_id: Optional[_builtins.str] = None,
    ...
    """
    pulumi.log.warn("""get_gpu_server is deprecated: ionoscloud.index/getgpuserver.getGpuServer has been deprecated in favor of ionoscloud.compute/getgpuserver.getGPUServer""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getGpuServer:getGpuServer', __args__, opts=opts, typ=GetGpuServerResult).value

    return AwaitableGetGpuServerResult(
...
def get_gpu_server_output(datacenter_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:index/getGpuServer:getGpuServer', __args__, opts=opts, typ=GetGpuServerResult)
