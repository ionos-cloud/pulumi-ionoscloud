...
def get_zone(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: [string] The ID of the DNS Zone you want to search for.
    :param _builtins.str name: [string] The name of the DNS Zone you want to search for.
