...
def get_record(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: [string] The ID of the DNS Record you want to search for.
    :param _builtins.str name: [string] The name of the DNS Record you want to search for.
    ...
    :param _builtins.str zone_id: [string] The ID of the DNS Zone in which the DNS Record can be found.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_record_output(id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
