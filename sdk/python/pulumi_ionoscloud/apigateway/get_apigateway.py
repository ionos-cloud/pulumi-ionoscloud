...
def get_apigateway(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ID of an existing API Gateway that you want to search for.
...
def get_apigateway_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
