...
class ApigatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] logs: [bool] Enable or disable logging. Defaults to `false`. **NOTE**: Central Logging must be enabled through the Logging API to enable this feature.
        :param pulumi.Input[_builtins.bool] metrics: [bool] Enable or disable metrics. Defaults to `false`.
        :param pulumi.Input[_builtins.str] name: [string] The name of the API Gateway.
        """
...
class _ApigatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] metrics: [bool] Enable or disable metrics. Defaults to `false`.
        :param pulumi.Input[_builtins.str] name: [string] The name of the API Gateway.
        :param pulumi.Input[_builtins.str] public_endpoint: [string] The public endpoint of the API Gateway.
        """
        if custom_domains is not None:
            pulumi.set(__self__, "custom_domains", custom_domains)
        if logs is not None:
...
@pulumi.type_token("ionoscloud:apigateway/apigateway:Apigateway")
class Apigateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metrics: Optional[pulumi.Input[_builtins.bool]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            public_endpoint: Optional[pulumi.Input[_builtins.str]] = None) -> 'Apigateway':
        """
