...
class GetRouteResult:
    ...
    @_builtins.property
    @pulumi.getter
    def websocket(self) -> _builtins.bool:
        """
...
def get_route(gateway_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str gateway_id: The ID of the API Gateway that the route belongs to.
    :param _builtins.str id: ID of an existing API Gateway Route that you want to search for.
    :param _builtins.str name: Name of an existing API Gateway Route that you want to search for.
    """
    __args__ = dict()
...
def get_route_output(gateway_id: Optional[pulumi.Input[_builtins.str]] = None,
