...
__all__ = [
    ...
    'MonitoringPipelineTimeoutsArgsDict',
...
if not MYPY:
    class MonitoringPipelineTimeoutsArgsDict(TypedDict):
    ...
    MonitoringPipelineTimeoutsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class MonitoringPipelineTimeoutsArgs:
