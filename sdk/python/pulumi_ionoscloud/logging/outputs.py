...
class PipelineLog(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str protocol: [string] "Protocol to use as intake. Possible values are: http, tcp."
...
class PipelineLogDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int retention_in_days: [int] Defines the number of days a log record should be kept in loki. Works with loki destination type only. Can be one of: 7, 14, 30.
        :param _builtins.str type: [string] The internal output stream to send logs to.
        """
...
class GetPipelineLogDestinationResult(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.int retention_in_days: [int] Defines the number of days a log record should be kept in loki. Works with loki destination type only.
        :param _builtins.str type: [string] The internal output stream to send logs to.
        """
        pulumi.set(__self__, "retention_in_days", retention_in_days)
        pulumi.set(__self__, "type", type)
