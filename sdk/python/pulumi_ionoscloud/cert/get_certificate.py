...
def get_certificate(certificate: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate: Certificate body.
    :param _builtins.str certificate_chain: Certificate chain.
    :param _builtins.str id: ID of the certificate you want to search for.
           
           Either `name` or `id` must be provided, or both. If none are provided, the datasource will return an error.
    :param _builtins.str name: Name of an existing certificate that you want to search for.
    """
    __args__ = dict()
