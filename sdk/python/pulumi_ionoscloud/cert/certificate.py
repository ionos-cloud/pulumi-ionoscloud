...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] certificate: [string] The certificate body. Pem encoded. Immutable.
        :param pulumi.Input[_builtins.str] private_key: [string] The certificate private key. Immutable. Sensitive.
        :param pulumi.Input[_builtins.str] certificate_chain: [string] The certificate chain. Pem encoded. Immutable.
        :param pulumi.Input[_builtins.str] name: [string] The certificate name
        """
...
@pulumi.type_token("ionoscloud:cert/certificate:Certificate")
