...
class GetAutoCertificateResult:
    ...
    def last_issued_certificate_id(self) -> _builtins.str:
        """
...
def get_auto_certificate(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: [string] The location of the auto-certificate. Available locations: `de/fra`, `de/fra/1`, `de/fra/2`.
