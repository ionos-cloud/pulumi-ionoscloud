...
def get_auto_certificate_provider(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: [string] The location of the provider. Available locations: `de/fra`, `de/fra/1`, `de/fra/2`
