...
class FirewallArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: (Computed)[string] The type of firewall rule. If is not specified, it will take the default value INGRESS.
        """
    ...
    def nsg_id(self) -> pulumi.Input[_builtins.str]:
        """
...
@pulumi.type_token("ionoscloud:nsg/firewall:Firewall")
