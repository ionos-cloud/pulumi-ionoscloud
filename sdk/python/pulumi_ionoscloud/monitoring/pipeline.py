...
class PipelineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: [string] The location of the Monitoring pipeline. Default is `de/fra`. It can be one of `de/fra`, `de/fra/2`, `de/txl`, `es/vit`, `gb/bhx`, `gb/lhr`,`fr/par`, `us/mci`. If this is not set and if no value is provided for the `IONOS_API_URL_MONITORING` env var, the default `location` will be: `de/fra`.
        :param pulumi.Input[_builtins.str] name: [string] The name of the Monitoring pipeline.
        """
...
class _PipelineState:
    def __init__(__self__, *,
                 grafana_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] grafana_endpoint: [string] The endpoint of the Grafana instance.
        :param pulumi.Input[_builtins.str] http_endpoint: [string] The HTTP endpoint of the monitoring instance.
        :param pulumi.Input[_builtins.str] key: (Sensitive)[string] The key used to connect to the monitoring pipeline.
    ...
    def grafana_endpoint(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def grafana_endpoint(self, value: pulumi.Input[Optional[_builtins.str]]):
...
@pulumi.type_token("ionoscloud:monitoring/pipeline:Pipeline")
class Pipeline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            timeouts: pulumi.Input[Optional[Union['PipelineTimeoutsArgs', 'PipelineTimeoutsArgsDict']]] = None) -> 'Pipeline':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="grafanaEndpoint")
    def grafana_endpoint(self) -> pulumi.Output[_builtins.str]:
        """
        [string] The endpoint of the Grafana instance.
        """
        return pulumi.get(self, "grafana_endpoint")
