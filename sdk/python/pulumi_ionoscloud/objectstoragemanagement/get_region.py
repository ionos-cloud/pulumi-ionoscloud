...
class GetRegionResult:
    ...
    def storage_classes(self) -> Sequence[_builtins.str]:
        """
...
def get_region(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: Id of an existing object storage Region that you want to search for.
    """
    __args__ = dict()
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('ionoscloud:objectstoragemanagement/getRegion:getRegion', __args__, opts=opts, typ=GetRegionResult).value
...
def get_region_output(id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:objectstoragemanagement/getRegion:getRegion', __args__, opts=opts, typ=GetRegionResult)
