...
def get_in_memory_db_replica_set(display_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The location of the InMemoryDB Replica Set. Available locations: `de/fra`, `de/fra/1`, `de/fra/2`, `de/txl`, `es/vit`, `gb/bhx`, `gb/lhr`, `us/ewr`, `us/las`, `us/mci`, `fr/par`
