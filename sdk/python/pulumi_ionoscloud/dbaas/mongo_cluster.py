...
class MongoClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] storage_type: (Computed)[String] The storage type used in your cluster. Required for enterprise edition.
        :param pulumi.Input[_builtins.str] template_id: [string] The unique ID of the template, which specifies the number of cores, storage size, and memory. Updates to the value of the field force the cluster to be re-created. Required for playground and business editions. Must not be provided for enterprise edition.
        :param pulumi.Input[_builtins.str] type: (Computed)[string]The cluster type, either `replicaset` or `sharded-cluster`.
        """
    ...
    def mongodb_version(self, value: pulumi.Input[_builtins.str]):
...
class _MongoClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MongoClusterBackupArgs'] backup: [list]
        :param pulumi.Input['MongoClusterBiConnectorArgs'] bi_connector: (Computed)The MongoDB Connector for Business Intelligence allows you to query a MongoDB database using SQL commands to aid in data analysis.
        :param pulumi.Input[_builtins.str] connection_string: [string] The physical location where the cluster will be created. This will be where all of your instances live. Updates to the value of the field force the cluster to be re-created. Available locations: de/txl, gb/lhr, es/vit
        :param pulumi.Input['MongoClusterConnectionsArgs'] connections: [List] Details about the network connection for your cluster. Updates to the value of the field force the cluster to be re-created.
        :param pulumi.Input[_builtins.int] cores: (Computed)[int] The number of CPU cores per replica. Required for enterprise edition.
        :param pulumi.Input[_builtins.str] display_name: [string] The name of your cluster. Updates to the value of the field force the cluster to be re-created.
        :param pulumi.Input[_builtins.str] edition: (Computed)[string] Cluster edition. Playground, business or enterprise.
...
@pulumi.type_token("ionoscloud:dbaas/mongoCluster:MongoCluster")
class MongoCluster(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def shards(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        [int]The total number of shards in the cluster.
        """
        return pulumi.get(self, "shards")
