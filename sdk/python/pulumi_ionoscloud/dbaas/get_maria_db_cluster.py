...
class GetMariaDBClusterResult:
    ...
    def mariadb_version(self) -> _builtins.str:
        """
...
def get_maria_db_cluster(display_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str display_name: [string] Display Name of an existing cluster that you want to search for.
