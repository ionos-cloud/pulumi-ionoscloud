...
class InMemoryDBReplicaSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: [string] The location of your replica set. Updates to the value of the field force the replica set to be re-created. If this is not set and if no value is provided for the `IONOS_API_URL` env var, the default `location` will be: `de/fra`.
...
class _InMemoryDBReplicaSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InMemoryDBReplicaSetCredentialsArgs'] credentials: [object] Credentials for the InMemoryDB replicaset, only one type of password can be used since they are mutually exclusive. These values are used to create the initial InMemoryDB user, updating any of these will force recreation of the replica set resource.
        :param pulumi.Input[_builtins.str] display_name: [string] The human-readable name of your replica set.
        :param pulumi.Input[_builtins.str] dns_name: [string] The DNS name pointing to your replica set. Will be used to connect to the active/standalone instance.
...
@pulumi.type_token("ionoscloud:dbaas/inMemoryDBReplicaSet:InMemoryDBReplicaSet")
class InMemoryDBReplicaSet(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="initialSnapshotId")
    def initial_snapshot_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        [string] The ID of a snapshot to restore the replica set from. If set, the replica set will be created from the snapshot.
        """
        return pulumi.get(self, "initial_snapshot_id")
