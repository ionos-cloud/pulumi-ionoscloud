...
def get_inmemorydb_snapshot(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID of the InMemoryDB Snapshot.
    :param _builtins.str location: The location of the InMemoryDB Snapshot.
    """
    __args__ = dict()
    __args__['id'] = id
