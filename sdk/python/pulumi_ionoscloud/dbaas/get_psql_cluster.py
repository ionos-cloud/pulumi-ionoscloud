...
def get_psql_cluster(display_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str display_name: Display Name of an existing cluster that you want to search for.
...
def get_psql_cluster_output(display_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
