...
class GetObjectResult:
    ...
    def object_lock_legal_hold(self) -> _builtins.str:
        """
    ...
    def request_payer(self) -> _builtins.str:
        """
    ...
    def server_side_encryption_context(self) -> _builtins.str:
        """
    ...
    def server_side_encryption_customer_algorithm(self) -> _builtins.str:
        """
    ...
    def server_side_encryption_customer_key(self) -> _builtins.str:
        """
    ...
    def server_side_encryption_customer_key_md5(self) -> _builtins.str:
        """
...
def get_object(bucket: Optional[_builtins.str] = None,
    ...
    :param _builtins.str bucket: [string] The name of the bucket where the object is stored.
    :param _builtins.str key: [string] The name of the object.
    :param _builtins.str range: [string] Downloads the specified range bytes of an object. For more information about the HTTP Range header
    :param _builtins.str version_id: [string] The version of the object.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:objectstorage/getObject:getObject', __args__, opts=opts, typ=GetObjectResult).value
...
def get_object_output(bucket: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:objectstorage/getObject:getObject', __args__, opts=opts, typ=GetObjectResult)
