...
def get_objects(bucket: Optional[_builtins.str] = None,
    ...
    :param _builtins.str bucket: [string] The name of the bucket where the objects are stored.
    :param _builtins.str delimiter: [string] A character used to group keys.
    :param _builtins.str encoding_type: [string] Specifies the encoding method used to encode the object keys in the response. Default is url.
    :param _builtins.bool fetch_owner: [bool] If set to true, the response includes the owner field in the metadata.
    :param _builtins.int max_keys: [int] Sets the maximum number of keys returned in the response body.Default is 1000.
    :param _builtins.str prefix: [string] Limits the response to keys that begin with the specified prefix.
    :param _builtins.str start_after: [string] Specifies the key to start after when listing objects in a bucket.
    """
    __args__ = dict()
