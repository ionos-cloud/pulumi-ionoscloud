...
def get_bucket_object(bucket: Optional[str] = None,
    ...
    example = ionoscloud.objectstorage.get_bucket_object(bucket="example",
        key="object")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:objectstorage/getBucketObject:getBucketObject', __args__, opts=opts, typ=GetBucketObjectResult).value
...
def get_bucket_object_output(bucket: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:objectstorage/getBucketObject:getBucketObject', __args__, opts=opts, typ=GetBucketObjectResult)
