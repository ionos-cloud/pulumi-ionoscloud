...
class PublicAccessBlockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] block_public_acls: [bool] Indicates that access to the bucket via Access Control Lists (ACLs) that grant public access is blocked. In other words, ACLs that allow public access are not permitted.
        :param pulumi.Input[_builtins.bool] block_public_policy: [bool] Blocks public access to the bucket via bucket policies. Bucket policies that grant public access will not be allowed.
        :param pulumi.Input[_builtins.bool] ignore_public_acls: [bool] Instructs the system to ignore any ACLs that grant public access. Even if ACLs are set to allow public access, they will be disregarded.
        :param pulumi.Input[_builtins.bool] restrict_public_buckets: [bool] Restricts access to buckets that have public policies. Buckets with policies that grant public access will have their access restricted.
        """
...
@pulumi.type_token("ionoscloud:objectstorage/publicAccessBlock:PublicAccessBlock")
class PublicAccessBlock(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="blockPublicAcls")
    def block_public_acls(self) -> pulumi.Output[_builtins.bool]:
        """
        [bool] Indicates that access to the bucket via Access Control Lists (ACLs) that grant public access is blocked. In other words, ACLs that allow public access are not permitted.
        """
        return pulumi.get(self, "block_public_acls")
    ...
    @_builtins.property
    @pulumi.getter(name="blockPublicPolicy")
    def block_public_policy(self) -> pulumi.Output[_builtins.bool]:
        """
        [bool] Blocks public access to the bucket via bucket policies. Bucket policies that grant public access will not be allowed.
        """
        return pulumi.get(self, "block_public_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="ignorePublicAcls")
    def ignore_public_acls(self) -> pulumi.Output[_builtins.bool]:
        """
        [bool] Instructs the system to ignore any ACLs that grant public access. Even if ACLs are set to allow public access, they will be disregarded.
        """
        return pulumi.get(self, "ignore_public_acls")
    ...
    @_builtins.property
    @pulumi.getter(name="restrictPublicBuckets")
    def restrict_public_buckets(self) -> pulumi.Output[_builtins.bool]:
        """
        [bool] Restricts access to buckets that have public policies. Buckets with policies that grant public access will have their access restricted.
        """
        return pulumi.get(self, "restrict_public_buckets")
