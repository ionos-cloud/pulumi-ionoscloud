...
class GetBalancerResult:
    ...
    """
    def __init__(__self__, central_logging=None, datacenter_id=None, flowlogs=None, id=None, ips=None, lb_private_ips=None, listener_lan=None, location=None, logging_format=None, name=None, target_lan=None):
