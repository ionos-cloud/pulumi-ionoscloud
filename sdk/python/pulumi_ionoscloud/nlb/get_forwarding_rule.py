...
class GetForwardingRuleResult:
    ...
    def networkloadbalancer_id(self) -> _builtins.str:
...
def get_forwarding_rule(datacenter_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ID of the network load balancer forwarding rule you want to search for.
    ...
    :param _builtins.str name: Name of an existing network load balancer forwarding rule that you want to search for.
    :param _builtins.str networkloadbalancer_id: Network Load Balancer's UUID.
    """
    __args__ = dict()
...
def get_forwarding_rule_output(datacenter_id: pulumi.Input[Optional[_builtins.str]] = None,
