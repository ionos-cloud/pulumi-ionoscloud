...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] allow_replace: [bool] When set to true, allows the update of immutable fields by first destroying and then re-creating the cluster.
        ...
        :param pulumi.Input[_builtins.str] location: [string] This attribute is mandatory if the cluster is private. The location must be enabled for your contract, or you must have a data center at that location. This property is not adjustable.
        ...
        :param pulumi.Input[_builtins.str] nat_gateway_ip: [string] The NAT gateway IP of the cluster if the cluster is private. This attribute is immutable. Must be a reserved IP in the same location as the cluster's location. This attribute is mandatory if the cluster is private.
        :param pulumi.Input[_builtins.str] node_subnet: [string] The node subnet of the cluster, if the cluster is private. This attribute is optional and immutable. Must be a valid CIDR notation for an IPv4 network prefix of 16 bits length.
        :param pulumi.Input[_builtins.bool] public: [boolean] Indicates if the cluster is public or private. This attribute is immutable.
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] public: [boolean] Indicates if the cluster is public or private. This attribute is immutable.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterS3BucketArgs']]] s3_buckets: [list] List of IONOS Object Storage buckets configured for K8s usage. For now it contains only an IONOS Object Storage bucket used to store K8s API audit logs.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] viable_node_pool_versions: [list] List of versions that may be used for node pools under this cluster
        """
        if allow_replace is not None:
            pulumi.set(__self__, "allow_replace", allow_replace)
        if api_subnet_allow_lists is not None:
...
@pulumi.type_token("ionoscloud:k8s/cluster:Cluster")
class Cluster(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="nodeSubnet")
    def node_subnet(self) -> pulumi.Output[_builtins.str]:
        """
        [string] The node subnet of the cluster, if the cluster is private. This attribute is optional and immutable. Must be a valid CIDR notation for an IPv4 network prefix of 16 bits length.
        """
        return pulumi.get(self, "node_subnet")
    ...
    @_builtins.property
    @pulumi.getter(name="viableNodePoolVersions")
    def viable_node_pool_versions(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        [list] List of versions that may be used for node pools under this cluster
        """
        return pulumi.get(self, "viable_node_pool_versions")
