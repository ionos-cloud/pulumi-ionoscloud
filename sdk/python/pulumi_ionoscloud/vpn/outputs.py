...
class IpsecTunnelAuth(dict):
    ...
    def __init__(__self__, *,
                 ...
                 psk_key: Optional[_builtins.str] = None):
        """
        :param _builtins.str method: [string] The authentication method to use for IPSec Authentication. Possible values: `PSK`.
               Default value: `PSK`.
        :param _builtins.str psk_key: [string] The pre-shared key to use for IPSec Authentication. **Note**: Required if method is
               PSK.
        """
    ...
    def psk_key(self) -> Optional[_builtins.str]:
        """
...
class IpsecTunnelEsp(dict):
    ...
    def __init__(__self__, *,
                 diffie_hellman_group: Optional[_builtins.str] = None,
                 encryption_algorithm: Optional[_builtins.str] = None,
                 integrity_algorithm: Optional[_builtins.str] = None,
                 lifetime: Optional[_builtins.int] = None):
        """
        :param _builtins.str diffie_hellman_group: [string] The Diffie-Hellman Group to use for IPSec Encryption. Possible
        ...
        :param _builtins.str encryption_algorithm: [string] The encryption algorithm to use for IPSec Encryption. Possible
        ...
        :param _builtins.str integrity_algorithm: [string] The integrity algorithm to use for IPSec Encryption. Possible
               values: `SHA256`, `SHA384`, `SHA512`, `AES-XCBC`. Default value: `SHA256`.
        :param _builtins.int lifetime: [string] The phase lifetime in seconds. Minimum value: `3600`. Maximum value: `86400`.
               Default value: `86400`.
        """
    ...
    def diffie_hellman_group(self) -> Optional[_builtins.str]:
        """
    ...
    def integrity_algorithm(self) -> Optional[_builtins.str]:
        """
...
class WireguardPeerEndpoint(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str host: [string] The hostname or IPV4 address that the WireGuard Server will connect to.
        :param _builtins.int port: [int] The port that the WireGuard Server will connect to. Defaults to `51820`.
        """
...
class GetIpsecTunnelAuthResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str method: The Authentication Method to use for IPSec Authentication.
        """
        pulumi.set(__self__, "method", method)
...
class GetIpsecTunnelEspResult(dict):
    def __init__(__self__, *,
                 diffie_hellman_group: _builtins.str,
                 encryption_algorithm: _builtins.str,
                 integrity_algorithm: _builtins.str,
                 lifetime: _builtins.int):
        """
        :param _builtins.str diffie_hellman_group: The Diffie-Hellman Group to use for IPSec Encryption.
        :param _builtins.str encryption_algorithm: The encryption algorithm to use for IPSec Encryption.
        :param _builtins.str integrity_algorithm: The integrity algorithm to use for IPSec Encryption.
        :param _builtins.int lifetime: The phase lifetime in seconds.
        """
        pulumi.set(__self__, "diffie_hellman_group", diffie_hellman_group)
        pulumi.set(__self__, "encryption_algorithm", encryption_algorithm)
        pulumi.set(__self__, "integrity_algorithm", integrity_algorithm)
    ...
    @_builtins.property
    @pulumi.getter(name="diffieHellmanGroup")
    def diffie_hellman_group(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="integrityAlgorithm")
    def integrity_algorithm(self) -> _builtins.str:
        """
...
class GetWireguardPeerEndpointResult(dict):
    def __init__(__self__, *,
                 ...
                 port: _builtins.int):
        """
        :param _builtins.str host: Hostname or IPV4 address that the WireGuard Server will connect to.
        :param _builtins.int port: Port that the WireGuard Server will connect to. Default: 51820
        """
        pulumi.set(__self__, "host", host)
        pulumi.set(__self__, "port", port)
