...
def get_wireguard_gateway(description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: [String] The location of the WireGuard Gateway. Supported locations: de/fra, de/fra/1, de/fra/2, de/txl, es/vit, gb/bhx, gb/lhr, us/ewr, us/las, us/mci, fr/par.
...
def get_wireguard_gateway_output(description: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
