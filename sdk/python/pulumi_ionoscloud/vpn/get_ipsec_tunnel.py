...
def get_ipsec_tunnel(gateway_id: Optional[_builtins.str] = None,
    ...
    * `peer_network_cidrs` - The network CIDRs on the "Right" side that are allowed to connect to the IPSec
    ...
    :param _builtins.str location: The location of the IPSec Gateway Tunnel. Supported locations: de/fra, de/fra/1, de/fra/2, de/txl, es/vit, gb/lhr, us/ewr, us/las, us/mci, fr/par.
