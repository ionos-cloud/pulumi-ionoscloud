...
class GroupArgs:
    def __init__(__self__, *,
                 ...
                 max_replica_count: pulumi.Input[_builtins.int],
        ...
        :param pulumi.Input[_builtins.str] datacenter_id: [string] Unique identifier for the resource
        :param pulumi.Input[_builtins.int] max_replica_count: [int] The maximum value for the number of replicas on a VM Auto Scaling Group. Must be >= 0 and <= 200. Will be enforced for both automatic and manual changes.
        :param pulumi.Input[_builtins.int] min_replica_count: [int] The minimum value for the number of replicas on a VM Auto Scaling Group. Must be >= 0 and <= 200. Will be enforced for both automatic and manual changes.
    ...
    def max_replica_count(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def max_replica_count(self, value: pulumi.Input[_builtins.int]):
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] datacenter_id: [string] Unique identifier for the resource
        :param pulumi.Input[_builtins.str] location: Location of the data center.
        :param pulumi.Input[_builtins.int] max_replica_count: [int] The maximum value for the number of replicas on a VM Auto Scaling Group. Must be >= 0 and <= 200. Will be enforced for both automatic and manual changes.
        :param pulumi.Input[_builtins.int] min_replica_count: [int] The minimum value for the number of replicas on a VM Auto Scaling Group. Must be >= 0 and <= 200. Will be enforced for both automatic and manual changes.
        :param pulumi.Input[_builtins.str] name: [string] User-defined name for the Autoscaling Group.
        :param pulumi.Input['GroupPolicyArgs'] policy: [List] Specifies the behavior of this Autoscaling Group. A policy consists of Triggers and Actions, whereby an Action is some kind of automated behavior, and a Trigger is defined by the circumstances under which the Action is triggered. Currently, two separate Actions, namely Scaling In and Out are supported, triggered through Thresholds defined on a given Metric.
...
@pulumi.type_token("ionoscloud:autoscaling/group:Group")
class Group(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="maxReplicaCount")
    def max_replica_count(self) -> pulumi.Output[_builtins.int]:
        """
        [int] The maximum value for the number of replicas on a VM Auto Scaling Group. Must be >= 0 and <= 200. Will be enforced for both automatic and manual changes.
        """
        return pulumi.get(self, "max_replica_count")
    ...
    @_builtins.property
    @pulumi.getter(name="minReplicaCount")
    def min_replica_count(self) -> pulumi.Output[_builtins.int]:
        """
        [int] The minimum value for the number of replicas on a VM Auto Scaling Group. Must be >= 0 and <= 200. Will be enforced for both automatic and manual changes.
        """
        return pulumi.get(self, "min_replica_count")
