...
class GetShareResult:
    ...
    def nfs_path(self) -> _builtins.str:
        """
...
def get_share(client_groups: Optional[Sequence[Union['GetShareClientGroupArgs', 'GetShareClientGroupArgsDict']]] = None,
    ...
    :param _builtins.str location: The location where the Network File Storage share is located. Available locations: `de/fra`, `de/fra/1`, `de/fra/2`, `de/txl`, `fr/par`, `gb/lhr`, `es/vit`, `us/las`, `us/ewr`, `us/mci`.
    ...
    :param _builtins.int uid: The user ID that will own the exported directory. If not set, **anonymous** (`512`) will be used.
    """
    __args__ = dict()
...
def get_share_output(client_groups: pulumi.Input[Optional[Optional[Sequence[Union['GetShareClientGroupArgs', 'GetShareClientGroupArgsDict']]]]] = None,
                     cluster_id: pulumi.Input[Optional[_builtins.str]] = None,
                     gid: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                     ...
                     quota: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
