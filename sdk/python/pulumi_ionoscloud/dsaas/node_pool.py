...
class NodePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cluster_id: [string] The UUID of an existing Dataplatform cluster.
        :param pulumi.Input[_builtins.int] node_count: [int] The number of nodes that make up the node pool. Must be set with a minimum value of 1.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] annotations: [map] Key-value pairs attached to node pool resource as [Kubernetes annotations](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/).
        ...
        :param pulumi.Input[_builtins.str] availability_zone: [string] The availability zone of the virtual datacenter region where the node pool resources should be provisioned. Must be set with one of the values `AUTO`, `ZONE_1` or `ZONE_2`. The default value is `AUTO`.
        :param pulumi.Input[_builtins.int] cores_count: [int] The number of CPU cores per node. Must be set with a minimum value of 1. The default value is `4`.
        :param pulumi.Input[_builtins.str] cpu_family: [string] A valid CPU family name or `AUTO` if the platform shall choose the best fitting option. Available CPU architectures can be retrieved from the datacenter resource. The default value is `AUTO`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: [map] Key-value pairs attached to the node pool resource as [Kubernetes labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/).
        ...
        :param pulumi.Input[_builtins.str] name: [string] The name of your node pool. Must be 63 characters or less and must be empty or begin and end with an alphanumeric character ([a-z0-9A-Z]). It can contain dashes (-), underscores (_), dots (.), and alphanumerics in-between.
        :param pulumi.Input[_builtins.int] ram_size: [int] The RAM size for one node in MB. Must be set in multiples of `1024`MB, with a minimum size is of `2048`MB. The default value is `4096`.
        :param pulumi.Input[_builtins.int] storage_size: [int] The size of the volume in GB. The size must be greater than `10`GB. The default value is `20`.
        :param pulumi.Input[_builtins.str] storage_type: [int] The type of hardware for the volume. Must be set with one of the values `HDD` or `SSD`. The default value is `SSD`.
        """
...
class _NodePoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] cores_count: [int] The number of CPU cores per node. Must be set with a minimum value of 1. The default value is `4`.
        :param pulumi.Input[_builtins.str] cpu_family: [string] A valid CPU family name or `AUTO` if the platform shall choose the best fitting option. Available CPU architectures can be retrieved from the datacenter resource. The default value is `AUTO`.
        :param pulumi.Input[_builtins.str] datacenter_id: The UUID of the virtual data center (VDC) in which the nodepool is provisioned
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: [map] Key-value pairs attached to the node pool resource as [Kubernetes labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/).
        :param pulumi.Input[Sequence[pulumi.Input['NodePoolMaintenanceWindowArgs']]] maintenance_windows: Starting time of a weekly 4 hour-long window, during which maintenance might occur in hh:mm:ss format
        :param pulumi.Input[_builtins.str] name: [string] The name of your node pool. Must be 63 characters or less and must be empty or begin and end with an alphanumeric character ([a-z0-9A-Z]). It can contain dashes (-), underscores (_), dots (.), and alphanumerics in-between.
        :param pulumi.Input[_builtins.int] node_count: [int] The number of nodes that make up the node pool. Must be set with a minimum value of 1.
        ...
        :param pulumi.Input[_builtins.int] storage_size: [int] The size of the volume in GB. The size must be greater than `10`GB. The default value is `20`.
        :param pulumi.Input[_builtins.str] storage_type: [int] The type of hardware for the volume. Must be set with one of the values `HDD` or `SSD`. The default value is `SSD`.
        :param pulumi.Input[_builtins.str] version: The version of the Data Platform.
        """
        if annotations is not None:
            pulumi.set(__self__, "annotations", annotations)
        if auto_scaling is not None:
...
@pulumi.type_token("ionoscloud:dsaas/nodePool:NodePool")
