...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] datacenter_id: [string] The UUID of the virtual data center (VDC) the cluster is provisioned.
        ...
        :param pulumi.Input[_builtins.str] name: [string] The name of your cluster. Must be 63 characters or less and must be empty or begin and end with an alphanumeric character ([a-z0-9A-Z]). It can contain dashes (-), underscores (_), dots (.), and alphanumerics in-between.
        :param pulumi.Input[_builtins.str] version: [int] The version of the Data Platform.
        """
...
@pulumi.type_token("ionoscloud:dsaas/cluster:Cluster")
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            maintenance_windows: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterMaintenanceWindowArgs', 'ClusterMaintenanceWindowArgsDict']]]]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None) -> 'Cluster':
        """
