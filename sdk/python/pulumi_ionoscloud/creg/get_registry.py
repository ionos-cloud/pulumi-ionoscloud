...
def get_registry(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ID of the container registry you want to search for.
    :param _builtins.str name: Name of an existing container registry that you want to search for. Search by name is case-insensitive. The whole resource name is required if `partial_match` parameter is not set to true.
