...
class LoggingPipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 logs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['LoggingPipelineLogArgs', 'LoggingPipelineLogArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ## Import
        ...
        :param pulumi.Input[str] location: [string] The location of the Logging pipeline. Default: `de/txl` One of `de/fra`, `de/txl`, `gb/lhr`, `es/vit`, `fr/par`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LoggingPipelineLogArgs', 'LoggingPipelineLogArgsDict']]]] logs: [list] Pipeline logs, a list that contains elements with the following structure:
        :param pulumi.Input[str] name: [string] The name of the Logging pipeline.
        """
        ...
    @overload
