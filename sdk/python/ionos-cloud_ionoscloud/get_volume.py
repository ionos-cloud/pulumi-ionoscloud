...
class GetVolumeResult:
    ...
    """
    def __init__(__self__, availability_zone=None, backup_unit_id=None, boot_server=None, bus=None, cpu_hot_plug=None, datacenter_id=None, device_number=None, disc_virtio_hot_plug=None, disc_virtio_hot_unplug=None, disk_type=None, id=None, image=None, image_alias=None, image_password=None, licence_type=None, name=None, nic_hot_plug=None, nic_hot_unplug=None, ram_hot_plug=None, size=None, sshkey=None, user_data=None):
...
def get_volume(datacenter_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getVolume:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
