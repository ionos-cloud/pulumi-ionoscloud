...
class S3KeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] user_id: [string] The UUID of the user owning the S3 Key.
        :param pulumi.Input[bool] active: [boolean] Whether the S3 is active / enabled or not - Please keep in mind this is only required on create. Default value in true
        """
...
class _S3KeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] active: [boolean] Whether the S3 is active / enabled or not - Please keep in mind this is only required on create. Default value in true
        :param pulumi.Input[str] secret_key: The S3 Secret key.
        :param pulumi.Input[str] user_id: [string] The UUID of the user owning the S3 Key.
        """
        if active is not None:
            pulumi.set(__self__, "active", active)
