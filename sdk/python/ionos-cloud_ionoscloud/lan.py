...
class LanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] pcc: [String] The unique id of a `ionoscloud.PrivateCrossconnect` resource, in order. It needs to be ensured that IP addresses of the NICs of all LANs connected to a given Cross Connect is not duplicated and belongs to the same subnet range
