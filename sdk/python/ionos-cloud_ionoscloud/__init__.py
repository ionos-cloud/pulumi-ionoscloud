...
if typing.TYPE_CHECKING:
    ...
    config = __config
    import ionos-cloud_ionoscloud.dbaas as __dbaas
    dbaas = __dbaas
    import ionos-cloud_ionoscloud.k8s as __k8s
    k8s = __k8s
else:
    compute = _utilities.lazy_import('ionos-cloud_ionoscloud.compute')
    config = _utilities.lazy_import('ionos-cloud_ionoscloud.config')
    dbaas = _utilities.lazy_import('ionos-cloud_ionoscloud.dbaas')
    k8s = _utilities.lazy_import('ionos-cloud_ionoscloud.k8s')
...
[
 ...
 },
 {
  ...
  "fqn": "ionos-cloud_ionoscloud.dbaas",
  "classes": {
 ...
 },
 {
  "pkg": "ionoscloud",
  "mod": "k8s/cluster",
  "fqn": "ionos-cloud_ionoscloud.k8s",
  "classes": {
