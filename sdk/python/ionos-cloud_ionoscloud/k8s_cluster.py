...
class K8sClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['K8sClusterS3BucketArgs']]] s3_buckets: [list] List of S3 bucket configured for K8s usage. For now it contains only an S3 bucket used to store K8s API audit logs.
        """
...
class K8sCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] node_subnet: [string] The node subnet of the cluster, if the cluster is private. This attribute is optional and immutable. Must be a valid CIDR notation for an IPv4 network prefix of 16 bits length.
        :param pulumi.Input[bool] public: [boolean] Indicates if the cluster is public or private. This attribute is immutable.
        :param pulumi.Input[Sequence[pulumi.Input[Union['K8sClusterS3BucketArgs', 'K8sClusterS3BucketArgsDict']]]] s3_buckets: [list] List of S3 bucket configured for K8s usage. For now it contains only an S3 bucket used to store K8s API audit logs.
        """
        ...
    @overload
    def __init__(__self__,
