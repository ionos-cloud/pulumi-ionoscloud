...
class CdnDistributionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CdnDistributionRoutingRuleArgs']]] routing_rules: [list] The routing rules for the distribution.
...
class CdnDistribution(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 certificate_id: Optional[pulumi.Input[str]] = None,
                 domain: Optional[pulumi.Input[str]] = None,
                 routing_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CdnDistributionRoutingRuleArgs', 'CdnDistributionRoutingRuleArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] certificate_id: [string] The ID of the certificate to use for the distribution. You can create certificates with the certificate resource.
        :param pulumi.Input[str] domain: [string] The domain of the distribution.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CdnDistributionRoutingRuleArgs', 'CdnDistributionRoutingRuleArgsDict']]]] routing_rules: [list] The routing rules for the distribution.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            public_endpoint_v6: Optional[pulumi.Input[str]] = None,
            resource_urn: Optional[pulumi.Input[str]] = None,
            routing_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CdnDistributionRoutingRuleArgs', 'CdnDistributionRoutingRuleArgsDict']]]]] = None) -> 'CdnDistribution':
        """
