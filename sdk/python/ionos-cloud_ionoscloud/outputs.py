...
__all__ = [
    ...
    'VcpuServerVolume',
    'VpnIpsecGatewayConnection',
    'VpnIpsecTunnelAuth',
    'VpnIpsecTunnelEsp',
    'VpnIpsecTunnelIke',
    'VpnWireguardGatewayConnection',
...
class ApplicationLoadbalancerFlowlog(dict):
    def __init__(__self__, *,
        ...
        :param str bucket: [string] Specifies the S3 IONOS bucket where the flow log data will be stored. The bucket must exist. Immutable, forces re-creation.
...
@pulumi.output_type
class K8sClusterMaintenanceWindow(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "dayOfTheWeek":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in K8sClusterMaintenanceWindow. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        K8sClusterMaintenanceWindow.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class K8sNodePoolAutoScaling(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "maxNodeCount":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in K8sNodePoolAutoScaling. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        K8sNodePoolAutoScaling.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class K8sNodePoolLan(dict):
    def __init__(__self__, *,
                 id: int,
                 dhcp: Optional[bool] = None,
                 routes: Optional[Sequence['outputs.K8sNodePoolLanRoute']] = None):
        """
        ...
        :param Sequence['K8sNodePoolLanRouteArgs'] routes: An array of additional LANs attached to worker nodes
        """
        pulumi.set(__self__, "id", id)
        if dhcp is not None:
            pulumi.set(__self__, "dhcp", dhcp)
    ...
    @property
    @pulumi.getter
    def routes(self) -> Optional[Sequence['outputs.K8sNodePoolLanRoute']]:
        """
...
@pulumi.output_type
class K8sNodePoolLanRoute(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "gatewayIp":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in K8sNodePoolLanRoute. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        K8sNodePoolLanRoute.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class K8sNodePoolMaintenanceWindow(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "dayOfTheWeek":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in K8sNodePoolMaintenanceWindow. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        K8sNodePoolMaintenanceWindow.__key_warning(key)
        return super().__getitem__(key)
...
class NicFlowlog(dict):
    def __init__(__self__, *,
        ...
        :param str bucket: Specifies the S3 IONOS bucket where the flow log data will be stored. The bucket must exist. Immutable, update forces re-creation.
...
@pulumi.output_type
class PgClusterConnectionPooler(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "poolMode":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in PgClusterConnectionPooler. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        PgClusterConnectionPooler.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class PgClusterConnections(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "datacenterId":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in PgClusterConnections. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        PgClusterConnections.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class PgClusterCredentials(dict):
    def __init__(__self__, *,
                 password: str,
                 username: str):
        """
...
@pulumi.output_type
class PgClusterFromBackup(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "backupId":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in PgClusterFromBackup. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        PgClusterFromBackup.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class PgClusterMaintenanceWindow(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "dayOfTheWeek":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in PgClusterMaintenanceWindow. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        PgClusterMaintenanceWindow.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class VpnIpsecGatewayConnection(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "datacenterId":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VpnIpsecGatewayConnection. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VpnIpsecGatewayConnection.__key_warning(key)
        return super().__getitem__(key)
...
class VpnIpsecTunnelAuth(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VpnIpsecTunnelAuth. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VpnIpsecTunnelAuth.__key_warning(key)
        return super().__getitem__(key)
...
class VpnIpsecTunnelEsp(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VpnIpsecTunnelEsp. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VpnIpsecTunnelEsp.__key_warning(key)
        return super().__getitem__(key)
...
class VpnIpsecTunnelIke(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VpnIpsecTunnelIke. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VpnIpsecTunnelIke.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class VpnWireguardGatewayConnection(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "datacenterId":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VpnWireguardGatewayConnection. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VpnWireguardGatewayConnection.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class VpnWireguardPeerEndpoint(dict):
    def __init__(__self__, *,
                 host: str,
                 port: Optional[int] = None):
        """
...
class GetApplicationLoadbalancerFlowlogResult(dict):
    def __init__(__self__, *,
        ...
        :param str bucket: Specifies the S3 IONOS bucket where the flow log data will be stored. The bucket must exist. Immutable, forces re-creation.
...
class GetAutoscalingGroupReplicaConfigurationNicFlowLogResult(dict):
    def __init__(__self__, *,
        ...
        :param str bucket: The S3 bucket name of an existing IONOS Cloud S3 bucket.
...
class GetK8sClustersClusterResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['GetK8sClustersClusterS3BucketArgs'] s3_buckets: List of S3 bucket configured for K8s usage. For now it contains only an S3 bucket used to store K8s API audit logs.
...
class GetK8sClustersClusterS3BucketResult(dict):
    def __init__(__self__, *,
                 name: str):
        """
        :param str name: Name of the S3 bucket
        """
        pulumi.set(__self__, "name", name)
...
class GetNicFlowlogResult(dict):
    def __init__(__self__, *,
        ...
        :param str bucket: Specifies the S3 IONOS bucket where the flow log data will be stored. The bucket must exist.
        :param str direction: Specifies the traffic direction pattern. Valid values: INGRESS, EGRESS, BIDIRECTIONAL.
    ...
    def bucket(self) -> str:
        """
        Specifies the S3 IONOS bucket where the flow log data will be stored. The bucket must exist.
        """
        return pulumi.get(self, "bucket")
...
class GetPgBackupsClusterBackupResult(dict):
    def __init__(__self__, *,
        ...
        :param str location: The S3 location where the backups will be stored.
