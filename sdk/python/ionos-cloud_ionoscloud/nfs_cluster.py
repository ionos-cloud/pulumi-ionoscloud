...
class NfsCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 connections: Optional[pulumi.Input[Union['NfsClusterConnectionsArgs', 'NfsClusterConnectionsArgsDict']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 nfs: Optional[pulumi.Input[Union['NfsClusterNfsArgs', 'NfsClusterNfsArgsDict']]] = None,
                 size: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['NfsClusterConnectionsArgs', 'NfsClusterConnectionsArgsDict']] connections: The network connections for the Network File Storage Cluster.
        :param pulumi.Input[str] location: The location where the Network File Storage cluster is located.
               - `de/fra` - Frankfurt
               - `de/txl` - Berlin
        :param pulumi.Input[str] name: The name of the Network File Storage cluster.
