...
def get_s3_key(active: Optional[bool] = None,
    ...
    :param bool active: The state of the s3 key
    :param str id: ID of the s3 key you want to search for.
    :param str user_id: [string] The UUID of the user owning the S3 Key.
    """
    __args__ = dict()
