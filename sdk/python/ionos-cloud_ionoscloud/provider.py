...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] s3_access_key: Access key for IONOS S3 operations.
        :param pulumi.Input[str] s3_region: Region for IONOS S3 operations.
        :param pulumi.Input[str] s3_secret_key: Secret key for IONOS S3 operations.
