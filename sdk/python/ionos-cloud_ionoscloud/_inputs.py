...
class ApplicationLoadbalancerFlowlogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] bucket: [string] Specifies the S3 IONOS bucket where the flow log data will be stored. The bucket must exist. Immutable, forces re-creation.
...
class NicFlowlogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] bucket: Specifies the S3 IONOS bucket where the flow log data will be stored. The bucket must exist. Immutable, update forces re-creation.
