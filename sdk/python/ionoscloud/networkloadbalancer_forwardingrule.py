...
__all__ = ['NetworkloadbalancerForwardingruleArgs', 'NetworkloadbalancerForwardingrule']

@pulumi.input_type
class NetworkloadbalancerForwardingruleArgs:
    def __init__(__self__, *,
                 ...
                 targets: pulumi.Input[Sequence[pulumi.Input['NetworkloadbalancerForwardingruleTargetArgs']]],
                 health_check: Optional[pulumi.Input['NetworkloadbalancerForwardingruleHealthCheckArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkloadbalancerForwardingruleTargetArgs']]] targets: [Set] Array of items in that collection.
        :param pulumi.Input['NetworkloadbalancerForwardingruleHealthCheckArgs'] health_check: Health check attributes for Network Load Balancer forwarding rule target.
    ...
    @property
    @pulumi.getter
    def targets(self) -> pulumi.Input[Sequence[pulumi.Input['NetworkloadbalancerForwardingruleTargetArgs']]]:
        """
    ...
    @targets.setter
    def targets(self, value: pulumi.Input[Sequence[pulumi.Input['NetworkloadbalancerForwardingruleTargetArgs']]]):
        pulumi.set(self, "targets", value)

    @property
    @pulumi.getter(name="healthCheck")
    def health_check(self) -> Optional[pulumi.Input['NetworkloadbalancerForwardingruleHealthCheckArgs']]:
        """
    ...
    @health_check.setter
    def health_check(self, value: Optional[pulumi.Input['NetworkloadbalancerForwardingruleHealthCheckArgs']]):
...
@pulumi.input_type
class _NetworkloadbalancerForwardingruleState:
    def __init__(__self__, *,
                 ...
                 targets: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkloadbalancerForwardingruleTargetArgs']]]] = None):
        """
    ...
    @property
    @pulumi.getter
    def targets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['NetworkloadbalancerForwardingruleTargetArgs']]]]:
        """
        [Set] Array of items in that collection.
        """
        return pulumi.get(self, "targets")
    ...
    @targets.setter
    def targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkloadbalancerForwardingruleTargetArgs']]]]):
        pulumi.set(self, "targets", value)


class NetworkloadbalancerForwardingrule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 algorithm: Optional[pulumi.Input[str]] = None,
                 datacenter_id: Optional[pulumi.Input[str]] = None,
                 health_check: Optional[pulumi.Input[Union['NetworkloadbalancerForwardingruleHealthCheckArgs', 'NetworkloadbalancerForwardingruleHealthCheckArgsDict']]] = None,
                 listener_ip: Optional[pulumi.Input[str]] = None,
                 listener_port: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 networkloadbalancer_id: Optional[pulumi.Input[str]] = None,
                 protocol: Optional[pulumi.Input[str]] = None,
                 targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkloadbalancerForwardingruleTargetArgs', 'NetworkloadbalancerForwardingruleTargetArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        example_networkloadbalancer_forwardingrule = ionoscloud.NetworkloadbalancerForwardingrule("exampleNetworkloadbalancerForwardingrule",
            datacenter_id=example_datacenter.id,
            networkloadbalancer_id=example_networkloadbalancer.id,
            algorithm="SOURCE_IP",
            protocol="TCP",
            listener_ip="10.12.118.224",
            listener_port=8081,
            targets=[ionoscloud.NetworkloadbalancerForwardingruleTargetArgs(
                ip="22.231.2.2",
                port=8080,
                weight=123,
                proxy_protocol="v1",
                health_check=ionoscloud.NetworkloadbalancerForwardingruleTargetHealthCheckArgs(
                    check=True,
                    check_interval=1000,
                ),
            )])
        ...
        :param pulumi.Input[str] algorithm: [string] Algorithm for the balancing.
        :param pulumi.Input[str] datacenter_id: [string] A Datacenter's UUID.
        :param pulumi.Input[Union['NetworkloadbalancerForwardingruleHealthCheckArgs', 'NetworkloadbalancerForwardingruleHealthCheckArgsDict']] health_check: Health check attributes for Network Load Balancer forwarding rule target.
        :param pulumi.Input[str] listener_ip: [string] Listening IP. (inbound)
        :param pulumi.Input[int] listener_port: [int] Listening port number. (inbound) (range: 1 to 65535)
        :param pulumi.Input[str] name: [string] A name of that Network Load Balancer forwarding rule.
        :param pulumi.Input[str] protocol: [string] Protocol of the balancing.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NetworkloadbalancerForwardingruleTargetArgs', 'NetworkloadbalancerForwardingruleTargetArgsDict']]]] targets: [Set] Array of items in that collection.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param NetworkloadbalancerForwardingruleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NetworkloadbalancerForwardingruleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NetworkloadbalancerForwardingruleArgs.__new__(NetworkloadbalancerForwardingruleArgs)
        ...
        super(NetworkloadbalancerForwardingrule, __self__).__init__(
            'ionoscloud:index/networkloadbalancerForwardingrule:NetworkloadbalancerForwardingrule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            networkloadbalancer_id: Optional[pulumi.Input[str]] = None,
            protocol: Optional[pulumi.Input[str]] = None,
            targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkloadbalancerForwardingruleTargetArgs', 'NetworkloadbalancerForwardingruleTargetArgsDict']]]]] = None) -> 'NetworkloadbalancerForwardingrule':
        """
        ...
        __props__ = _NetworkloadbalancerForwardingruleState.__new__(_NetworkloadbalancerForwardingruleState)
        ...
        __props__.__dict__["protocol"] = protocol
        __props__.__dict__["targets"] = targets
        return NetworkloadbalancerForwardingrule(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="healthCheck")
    def health_check(self) -> pulumi.Output['outputs.NetworkloadbalancerForwardingruleHealthCheck']:
        """
        Health check attributes for Network Load Balancer forwarding rule target.
        """
        return pulumi.get(self, "health_check")
    ...
    @property
    @pulumi.getter
    def targets(self) -> pulumi.Output[Sequence['outputs.NetworkloadbalancerForwardingruleTarget']]:
        """
        [Set] Array of items in that collection.
        """
        return pulumi.get(self, "targets")
