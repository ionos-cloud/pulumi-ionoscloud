...
def get_nfs_share(client_groups: Optional[Sequence[pulumi.InputType['GetNfsShareClientGroupArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetNfsShareClientGroupArgs']] client_groups: The groups of clients are the systems connecting to the Network File Storage cluster. Each client group supports the following:
...
def get_nfs_share_output(client_groups: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetNfsShareClientGroupArgs']]]]] = None,
