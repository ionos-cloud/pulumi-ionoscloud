...
class GetNfsShareResult:
    ...
    def client_groups(self) -> Sequence['outputs.GetNfsShareClientGroupResult']:
        """
...
def get_nfs_share(client_groups: Optional[Sequence[Union['GetNfsShareClientGroupArgs', 'GetNfsShareClientGroupArgsDict']]] = None,
    ...
    :param Sequence[Union['GetNfsShareClientGroupArgs', 'GetNfsShareClientGroupArgsDict']] client_groups: The groups of clients are the systems connecting to the Network File Storage cluster. Each client group supports the following:
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getNfsShare:getNfsShare', __args__, opts=opts, typ=GetNfsShareResult).value
...
def get_nfs_share_output(client_groups: Optional[pulumi.Input[Optional[Sequence[Union['GetNfsShareClientGroupArgs', 'GetNfsShareClientGroupArgsDict']]]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNfsShareResult]:
    """
    Returns information about shares of Network File Storage (NFS) on IonosCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:index/getNfsShare:getNfsShare', __args__, opts=opts, typ=GetNfsShareResult)
    return __ret__.apply(lambda __response__: GetNfsShareResult(
