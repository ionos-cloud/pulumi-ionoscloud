...
__all__ = [
    'GetK8sNodePoolResult',
    'AwaitableGetK8sNodePoolResult',
    'get_k8s_node_pool',
    'get_k8s_node_pool_output',
]

@pulumi.output_type
class GetK8sNodePoolResult:
    """
    ...
    def auto_scalings(self) -> Sequence['outputs.GetK8sNodePoolAutoScalingResult']:
        """
    ...
    @property
    @pulumi.getter
    def lans(self) -> Sequence['outputs.GetK8sNodePoolLanResult']:
        """
    ...
    def maintenance_windows(self) -> Sequence['outputs.GetK8sNodePoolMaintenanceWindowResult']:
        """
...
class AwaitableGetK8sNodePoolResult(GetK8sNodePoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetK8sNodePoolResult(
...
def get_k8s_node_pool(id: Optional[str] = None,
                      ...
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetK8sNodePoolResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getK8sNodePool:getK8sNodePool', __args__, opts=opts, typ=GetK8sNodePoolResult).value

    return AwaitableGetK8sNodePoolResult(
...
def get_k8s_node_pool_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                             k8s_cluster_id: Optional[pulumi.Input[str]] = None,
                             name: Optional[pulumi.Input[Optional[str]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetK8sNodePoolResult]:
    """
    The **k8s Node Pool** data source can be used to search for and return existing k8s Node Pools.
    If a single match is found, it will be returned. If your search results in multiple matches, an error will be returned.
    When this happens, please refine your search string so that it is specific enough to return only one result.
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:index/getK8sNodePool:getK8sNodePool', __args__, opts=opts, typ=GetK8sNodePoolResult)
    return __ret__.apply(lambda __response__: GetK8sNodePoolResult(
