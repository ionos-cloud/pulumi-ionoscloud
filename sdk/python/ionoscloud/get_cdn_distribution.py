...
class GetCdnDistributionResult:
    ...
    def routing_rules(self) -> Sequence['outputs.GetCdnDistributionRoutingRuleResult']:
        """
...
def get_cdn_distribution(domain: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getCdnDistribution:getCdnDistribution', __args__, opts=opts, typ=GetCdnDistributionResult).value
