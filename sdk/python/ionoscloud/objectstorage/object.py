...
class ObjectArgs:
    def __init__(__self__, *,
                 ...
                 server_side_encryption_context: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] content: [string] Inline content of the object.
        ...
        :param pulumi.Input[str] mfa: [string]The concatenation of the authentication device's serial number, a space, and the value displayed on your authentication device.
        ...
        :param pulumi.Input[str] request_payer: [string] Confirms that the requester knows that they will be charged for the request.
        ...
        :param pulumi.Input[str] server_side_encryption_context: [string] Specifies the IONOS Object Storage Encryption Context for object encryption.
        ...
        :param pulumi.Input[str] source: [string] The path to the file to upload.
    ...
    def server_side_encryption_context(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def server_side_encryption_context(self, value: Optional[pulumi.Input[str]]):
...
class Object(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            version_id: Optional[pulumi.Input[str]] = None,
            website_redirect: Optional[pulumi.Input[str]] = None) -> 'Object':
        """
    ...
    @property
    @pulumi.getter(name="serverSideEncryptionContext")
    def server_side_encryption_context(self) -> pulumi.Output[Optional[str]]:
        """
        [string] Specifies the IONOS Object Storage Encryption Context for object encryption.
        """
        return pulumi.get(self, "server_side_encryption_context")
