...
def get_s3_objects(bucket: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:objectstorage/getS3Objects:getS3Objects', __args__, opts=opts, typ=GetS3ObjectsResult).value
...
def get_s3_objects_output(bucket: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:objectstorage/getS3Objects:getS3Objects', __args__, opts=opts, typ=GetS3ObjectsResult)
