...
def get_server(datacenter_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getServer:getServer', __args__, opts=opts, typ=GetServerResult).value
...
def get_server_output(datacenter_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['type'] = type
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:index/getServer:getServer', __args__, opts=opts, typ=GetServerResult)
