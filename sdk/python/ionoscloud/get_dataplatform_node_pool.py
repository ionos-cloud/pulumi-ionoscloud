...
__all__ = [
    'GetDataplatformNodePoolResult',
    'AwaitableGetDataplatformNodePoolResult',
    'get_dataplatform_node_pool',
    'get_dataplatform_node_pool_output',
]

@pulumi.output_type
class GetDataplatformNodePoolResult:
    """
    ...
    def maintenance_windows(self) -> Sequence['outputs.GetDataplatformNodePoolMaintenanceWindowResult']:
        """
...
class AwaitableGetDataplatformNodePoolResult(GetDataplatformNodePoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataplatformNodePoolResult(
...
def get_dataplatform_node_pool(cluster_id: Optional[str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataplatformNodePoolResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getDataplatformNodePool:getDataplatformNodePool', __args__, opts=opts, typ=GetDataplatformNodePoolResult).value

    return AwaitableGetDataplatformNodePoolResult(
