...
warnings.warn("""ionoscloud.index/mongouser.MongoUser has been deprecated in favor of ionoscloud.dbaas/mongouser.MongoUser""", DeprecationWarning)
...
class MongoUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 username: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MongoUser is deprecated: ionoscloud.index/mongouser.MongoUser has been deprecated in favor of ionoscloud.dbaas/mongouser.MongoUser""")
        ...
        super(MongoUser, __self__).__init__(
            'ionoscloud:index/mongoUser:MongoUser',
            resource_name,
            __props__,
            opts)
