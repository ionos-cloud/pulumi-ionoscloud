...
class GetContainerRegistryResult:
    ...
    @property
    @pulumi.getter
    def features(self) -> Sequence['outputs.GetContainerRegistryFeatureResult']:
        return pulumi.get(self, "features")

    @property
    @pulumi.getter(name="garbageCollectionSchedules")
    def garbage_collection_schedules(self) -> Sequence['outputs.GetContainerRegistryGarbageCollectionScheduleResult']:
    ...
    def maintenance_windows(self) -> Sequence['outputs.GetContainerRegistryMaintenanceWindowResult']:
    ...
    def storage_usages(self) -> Sequence['outputs.GetContainerRegistryStorageUsageResult']:
...
def get_container_registry(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getContainerRegistry:getContainerRegistry', __args__, opts=opts, typ=GetContainerRegistryResult).value
