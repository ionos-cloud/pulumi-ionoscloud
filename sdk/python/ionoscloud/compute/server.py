...
class ServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] boot_cdrom: ***DEPRECATED*** Please refer to ionoscloud.ServerBootDeviceSelection (Optional)(Computed)[string] The associated boot drive, if any. Must be the UUID of a bootable CDROM image that can be retrieved using the ionoscloud.getImage data source.
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="ionoscloud:index/server:Server")])
