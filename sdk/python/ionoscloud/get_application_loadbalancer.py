...
__all__ = [
    ...
    'get_application_loadbalancer_output',
]
...
class GetApplicationLoadbalancerResult:
    ...
    @property
    @pulumi.getter
    def flowlogs(self) -> Sequence['outputs.GetApplicationLoadbalancerFlowlogResult']:
        """
...
def get_application_loadbalancer(datacenter_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getApplicationLoadbalancer:getApplicationLoadbalancer', __args__, opts=opts, typ=GetApplicationLoadbalancerResult).value
