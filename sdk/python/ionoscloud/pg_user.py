...
warnings.warn("""ionoscloud.index/pguser.PgUser has been deprecated in favor of ionoscloud.dbaas/psqluser.PSQLUser""", DeprecationWarning)
...
class PgUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PgUser resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        super(PgUser, __self__).__init__(
            'ionoscloud:index/pgUser:PgUser',
            resource_name,
            __props__,
            opts)
