...
warnings.warn("""ionoscloud.dbaas/getmariadbbackups.getMariadbBackups has been deprecated in favor of ionoscloud.index/getmariadbbackups.getMariadbBackups""", DeprecationWarning)
...
def get_mariadb_backups(backup_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mariadb_backups is deprecated: ionoscloud.dbaas/getmariadbbackups.getMariadbBackups has been deprecated in favor of ionoscloud.index/getmariadbbackups.getMariadbBackups""")
    __args__ = dict()
