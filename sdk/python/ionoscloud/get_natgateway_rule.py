...
def get_natgateway_rule(datacenter_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getNatgatewayRule:getNatgatewayRule', __args__, opts=opts, typ=GetNatgatewayRuleResult).value
