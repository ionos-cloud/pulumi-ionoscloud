...
warnings.warn("""ionoscloud.index/pgdatabase.PgDatabase has been deprecated in favor of ionoscloud.dbaas/psqldatabase.PSQLDatabase""", DeprecationWarning)
...
class PgDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(PgDatabase, __self__).__init__(
            'ionoscloud:index/pgDatabase:PgDatabase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            cluster_id: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            owner: Optional[pulumi.Input[str]] = None) -> 'PgDatabase':
        """
