...
__all__ = ['K8sNodePoolArgs', 'K8sNodePool']

@pulumi.input_type
class K8sNodePoolArgs:
    def __init__(__self__, *,
                 ...
                 auto_scaling: Optional[pulumi.Input['K8sNodePoolAutoScalingArgs']] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 lans: Optional[pulumi.Input[Sequence[pulumi.Input['K8sNodePoolLanArgs']]]] = None,
                 maintenance_window: Optional[pulumi.Input['K8sNodePoolMaintenanceWindowArgs']] = None,
        ...
        :param pulumi.Input['K8sNodePoolAutoScalingArgs'] auto_scaling: [string] Wether the Node Pool should autoscale. For more details, please check the API documentation
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: [map] A key/value map of labels
        :param pulumi.Input[Sequence[pulumi.Input['K8sNodePoolLanArgs']]] lans: [list] A list of numeric LAN id's you want this node pool to be part of. For more details, please check the API documentation, as well as the example above
        :param pulumi.Input['K8sNodePoolMaintenanceWindowArgs'] maintenance_window: See the **maintenance_window** section in the example above
    ...
    def auto_scaling(self) -> Optional[pulumi.Input['K8sNodePoolAutoScalingArgs']]:
        """
    ...
    @auto_scaling.setter
    def auto_scaling(self, value: Optional[pulumi.Input['K8sNodePoolAutoScalingArgs']]):
    ...
    @property
    @pulumi.getter
    def lans(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['K8sNodePoolLanArgs']]]]:
        """
    ...
    @lans.setter
    def lans(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['K8sNodePoolLanArgs']]]]):
        pulumi.set(self, "lans", value)

    @property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> Optional[pulumi.Input['K8sNodePoolMaintenanceWindowArgs']]:
        """
    ...
    def maintenance_window(self, value: Optional[pulumi.Input['K8sNodePoolMaintenanceWindowArgs']]):
...
class K8sNodePool(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 allow_replace: Optional[pulumi.Input[bool]] = None,
                 annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 auto_scaling: Optional[pulumi.Input[Union['K8sNodePoolAutoScalingArgs', 'K8sNodePoolAutoScalingArgsDict']]] = None,
                 availability_zone: Optional[pulumi.Input[str]] = None,
                 cores_count: Optional[pulumi.Input[int]] = None,
                 cpu_family: Optional[pulumi.Input[str]] = None,
                 datacenter_id: Optional[pulumi.Input[str]] = None,
                 ...
                 k8s_version: Optional[pulumi.Input[str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 lans: Optional[pulumi.Input[Sequence[pulumi.Input[Union['K8sNodePoolLanArgs', 'K8sNodePoolLanArgsDict']]]]] = None,
                 maintenance_window: Optional[pulumi.Input[Union['K8sNodePoolMaintenanceWindowArgs', 'K8sNodePoolMaintenanceWindowArgsDict']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 node_count: Optional[pulumi.Input[int]] = None,
                 public_ips: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ram_size: Optional[pulumi.Input[int]] = None,
        ...
        example_k8s_node_pool = ionoscloud.K8sNodePool("exampleK8sNodePool",
            datacenter_id=example_datacenter.id,
            k8s_cluster_id=example_k8s_cluster.id,
            k8s_version=example_k8s_cluster.k8s_version,
            maintenance_window=ionoscloud.K8sNodePoolMaintenanceWindowArgs(
                day_of_the_week="Monday",
                time="09:00:00Z",
            ),
            auto_scaling=ionoscloud.K8sNodePoolAutoScalingArgs(
                min_node_count=1,
                max_node_count=2,
            ),
            ...
            lans=[ionoscloud.K8sNodePoolLanArgs(
                id=example_lan.id,
                dhcp=True,
                routes=[ionoscloud.K8sNodePoolLanRouteArgs(
                    network="1.2.3.5/24",
        ...
        **Note:** Set `create_before_destroy` on the lan resource if you want to remove it from the nodepool during an update. This is to ensure that the nodepool is updated before the lan is destroyed.
        ...
        :param pulumi.Input[bool] allow_replace: When set to true, allows the update of immutable fields by destroying and re-creating the node pool
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] annotations: [map] A key/value map of annotations
        :param pulumi.Input[Union['K8sNodePoolAutoScalingArgs', 'K8sNodePoolAutoScalingArgsDict']] auto_scaling: [string] Wether the Node Pool should autoscale. For more details, please check the API documentation
        :param pulumi.Input[str] availability_zone: [string] - The desired Compute availability zone - See the API documentation for more information. *This attribute is immutable*.
        :param pulumi.Input[int] cores_count: [int] - The CPU cores count for each node of the node pool. *This attribute is immutable*.
        :param pulumi.Input[str] cpu_family: [string] The desired CPU Family - See the API documentation for more information. *This attribute is immutable*.
        :param pulumi.Input[str] datacenter_id: [string] A Datacenter's UUID
        ...
        :param pulumi.Input[str] k8s_version: [string] The desired Kubernetes Version. For supported values, please check the API documentation. Downgrades are not supported. The provider will ignore downgrades of patch level.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: [map] A key/value map of labels
        :param pulumi.Input[Sequence[pulumi.Input[Union['K8sNodePoolLanArgs', 'K8sNodePoolLanArgsDict']]]] lans: [list] A list of numeric LAN id's you want this node pool to be part of. For more details, please check the API documentation, as well as the example above
        :param pulumi.Input[Union['K8sNodePoolMaintenanceWindowArgs', 'K8sNodePoolMaintenanceWindowArgsDict']] maintenance_window: See the **maintenance_window** section in the example above
        :param pulumi.Input[str] name: [string] The name of the Kubernetes Cluster. *This attribute is immutable*.
        :param pulumi.Input[int] node_count: [int] - The desired number of nodes in the node pool
        :param pulumi.Input[Sequence[pulumi.Input[str]]] public_ips: [list] A list of public IPs associated with the node pool; must have at least `node_count + 1` elements
        :param pulumi.Input[int] ram_size: [int] - The desired amount of RAM, in MB. *This attribute is immutable*.
    ...
    def __init__(__self__,
        ...
        **Note:** Set `create_before_destroy` on the lan resource if you want to remove it from the nodepool during an update. This is to ensure that the nodepool is updated before the lan is destroyed.
        ...
        :param str resource_name: The name of the resource.
        :param K8sNodePoolArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(K8sNodePoolArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = K8sNodePoolArgs.__new__(K8sNodePoolArgs)
        ...
        super(K8sNodePool, __self__).__init__(
            'ionoscloud:index/k8sNodePool:K8sNodePool',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ram_size: Optional[pulumi.Input[int]] = None,
            storage_size: Optional[pulumi.Input[int]] = None,
            storage_type: Optional[pulumi.Input[str]] = None) -> 'K8sNodePool':
        """
        ...
        __props__ = _K8sNodePoolState.__new__(_K8sNodePoolState)
        ...
        __props__.__dict__["storage_size"] = storage_size
        __props__.__dict__["storage_type"] = storage_type
        return K8sNodePool(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="autoScaling")
    def auto_scaling(self) -> pulumi.Output[Optional['outputs.K8sNodePoolAutoScaling']]:
        """
        [string] Wether the Node Pool should autoscale. For more details, please check the API documentation
        """
        return pulumi.get(self, "auto_scaling")
    ...
    @property
    @pulumi.getter
    def lans(self) -> pulumi.Output[Optional[Sequence['outputs.K8sNodePoolLan']]]:
        """
        [list] A list of numeric LAN id's you want this node pool to be part of. For more details, please check the API documentation, as well as the example above
        """
        return pulumi.get(self, "lans")
    ...
    @property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> pulumi.Output['outputs.K8sNodePoolMaintenanceWindow']:
        """
        See the **maintenance_window** section in the example above
        """
        return pulumi.get(self, "maintenance_window")
