...
__all__ = [
    'GetVpnIpsecGatewayResult',
    'AwaitableGetVpnIpsecGatewayResult',
    'get_vpn_ipsec_gateway',
    'get_vpn_ipsec_gateway_output',
]

@pulumi.output_type
class GetVpnIpsecGatewayResult:
    """
    ...
    @property
    @pulumi.getter
    def connections(self) -> Sequence['outputs.GetVpnIpsecGatewayConnectionResult']:
        """
...
class AwaitableGetVpnIpsecGatewayResult(GetVpnIpsecGatewayResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVpnIpsecGatewayResult(
...
def get_vpn_ipsec_gateway(id: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVpnIpsecGatewayResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getVpnIpsecGateway:getVpnIpsecGateway', __args__, opts=opts, typ=GetVpnIpsecGatewayResult).value

    return AwaitableGetVpnIpsecGatewayResult(
...
def get_vpn_ipsec_gateway_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                 location: Optional[pulumi.Input[str]] = None,
                                 name: Optional[pulumi.Input[Optional[str]]] = None,
                                 version: Optional[pulumi.Input[Optional[str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVpnIpsecGatewayResult]:
    """
    The **VPN IPSec Gateway data source** can be used to search for and return an existing IPSec Gateway.
    You can provide a string for the name parameter which will be compared with provisioned IPSec Gateways.
    If a single match is found, it will be returned. If your search results in multiple matches, an error will be returned.
    ...
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:index/getVpnIpsecGateway:getVpnIpsecGateway', __args__, opts=opts, typ=GetVpnIpsecGatewayResult)
    return __ret__.apply(lambda __response__: GetVpnIpsecGatewayResult(
