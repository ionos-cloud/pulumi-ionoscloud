...
class LanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ipv6_cidr_block: IPv6 CIDR block assigned to the LAN. Can be set to 'AUTO' for an automatically assigned address or the address can be
               explicitly supplied.
        """
...
warnings.warn("""ionoscloud.index/lan.Lan has been deprecated in favor of ionoscloud.compute/lan.Lan""", DeprecationWarning)
...
class Lan(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Lan resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
                 ...
                 public: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""Lan is deprecated: ionoscloud.index/lan.Lan has been deprecated in favor of ionoscloud.compute/lan.Lan""")
