...
def get_auto_certificate_provider(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getAutoCertificateProvider:getAutoCertificateProvider', __args__, opts=opts, typ=GetAutoCertificateProviderResult).value
...
def get_auto_certificate_provider_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAutoCertificateProviderResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('ionoscloud:index/getAutoCertificateProvider:getAutoCertificateProvider', __args__, opts=opts, typ=GetAutoCertificateProviderResult)
