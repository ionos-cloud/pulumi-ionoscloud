...
__all__ = [
    ...
    'get_inmemorydb_replicaset',
    'get_inmemorydb_replicaset_output',
]
...
def get_inmemorydb_replicaset(display_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getInmemorydbReplicaset:getInmemorydbReplicaset', __args__, opts=opts, typ=GetInmemorydbReplicasetResult).value
