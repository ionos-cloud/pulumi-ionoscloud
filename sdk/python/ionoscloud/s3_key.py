...
warnings.warn("""ionoscloud.index/s3key.S3Key has been deprecated in favor of ionoscloud.compute/s3key.S3Key""", DeprecationWarning)
...
class S3Key(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""S3Key is deprecated: ionoscloud.index/s3key.S3Key has been deprecated in favor of ionoscloud.compute/s3key.S3Key""")
