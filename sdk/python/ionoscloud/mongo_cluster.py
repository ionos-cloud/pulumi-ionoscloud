...
warnings.warn("""ionoscloud.index/mongocluster.MongoCluster has been deprecated in favor of ionoscloud.dbaas/mongocluster.MongoCluster""", DeprecationWarning)
...
class MongoCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(MongoCluster, __self__).__init__(
            'ionoscloud:index/mongoCluster:MongoCluster',
            resource_name,
            __props__,
            opts)
