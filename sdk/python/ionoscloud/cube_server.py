...
class CubeServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] boot_cdrom: ***DEPRECATED*** Please refer to ionoscloud.ServerBootDeviceSelection (Optional)[string] The associated boot drive, if any. Must be the UUID of a bootable CDROM image that can be retrieved using the ionoscloud.getImage data source.
