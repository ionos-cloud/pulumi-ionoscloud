...
warnings.warn("""ionoscloud.index/inmemorydbreplicaset.InmemorydbReplicaset has been deprecated in favor of ionoscloud.dbaas/inmemorydbreplicaset.InMemoryDBReplicaSet""", DeprecationWarning)
...
class InmemorydbReplicaset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(InmemorydbReplicaset, __self__).__init__(
            'ionoscloud:index/inmemorydbReplicaset:InmemorydbReplicaset',
            resource_name,
            __props__,
            opts)
