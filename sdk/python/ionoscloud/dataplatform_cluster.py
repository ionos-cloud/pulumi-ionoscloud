...
class DataplatformClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] datacenter_id: The UUID of the virtual data center (VDC) in which the cluster is provisioned
        :param pulumi.Input[Sequence[pulumi.Input['DataplatformClusterLanArgs']]] lans: A list of LANs you want this node pool to be part of
        :param pulumi.Input[Sequence[pulumi.Input['DataplatformClusterMaintenanceWindowArgs']]] maintenance_windows: Starting time of a weekly 4 hour-long window, during which maintenance might occur in hh:mm:ss format
        :param pulumi.Input[str] name: The name of your cluster. Must be 63 characters or less and must be empty or begin and end with an alphanumeric
...
warnings.warn("""ionoscloud.index/dataplatformcluster.DataplatformCluster has been deprecated in favor of ionoscloud.dsaas/cluster.Cluster""", DeprecationWarning)
...
class DataplatformCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DataplatformCluster resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] datacenter_id: The UUID of the virtual data center (VDC) in which the cluster is provisioned
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DataplatformClusterLanArgs']]]] lans: A list of LANs you want this node pool to be part of
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DataplatformClusterMaintenanceWindowArgs']]]] maintenance_windows: Starting time of a weekly 4 hour-long window, during which maintenance might occur in hh:mm:ss format
        :param pulumi.Input[str] name: The name of your cluster. Must be 63 characters or less and must be empty or begin and end with an alphanumeric
               character ([a-z0-9A-Z]). It can contain dashes (-), underscores (_), dots (.), and alphanumerics in-between.
        :param pulumi.Input[str] version: The version of the Data Platform.
        """
    ...
    def _internal_init(__self__,
                 ...
                 version: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DataplatformCluster is deprecated: ionoscloud.index/dataplatformcluster.DataplatformCluster has been deprecated in favor of ionoscloud.dsaas/cluster.Cluster""")
