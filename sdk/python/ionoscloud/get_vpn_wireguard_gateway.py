...
__all__ = [
    'GetVpnWireguardGatewayResult',
    'AwaitableGetVpnWireguardGatewayResult',
    'get_vpn_wireguard_gateway',
    'get_vpn_wireguard_gateway_output',
]

@pulumi.output_type
class GetVpnWireguardGatewayResult:
    """
    ...
    @property
    @pulumi.getter
    def connections(self) -> Sequence['outputs.GetVpnWireguardGatewayConnectionResult']:
        """
...
class AwaitableGetVpnWireguardGatewayResult(GetVpnWireguardGatewayResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVpnWireguardGatewayResult(
...
def get_vpn_wireguard_gateway(description: Optional[str] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVpnWireguardGatewayResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getVpnWireguardGateway:getVpnWireguardGateway', __args__, opts=opts, typ=GetVpnWireguardGatewayResult).value

    return AwaitableGetVpnWireguardGatewayResult(
