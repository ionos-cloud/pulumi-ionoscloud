...
warnings.warn("""ionoscloud.index/backupunit.BackupUnit has been deprecated in favor of ionoscloud.compute/backupunit.BackupUnit""", DeprecationWarning)
...
class BackupUnit(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 password: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BackupUnit is deprecated: ionoscloud.index/backupunit.BackupUnit has been deprecated in favor of ionoscloud.compute/backupunit.BackupUnit""")
        ...
        super(BackupUnit, __self__).__init__(
            'ionoscloud:index/backupUnit:BackupUnit',
            resource_name,
            __props__,
            opts)
