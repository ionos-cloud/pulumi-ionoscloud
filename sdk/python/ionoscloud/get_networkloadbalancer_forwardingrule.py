...
__all__ = [
    'GetNetworkloadbalancerForwardingruleResult',
    'AwaitableGetNetworkloadbalancerForwardingruleResult',
    'get_networkloadbalancer_forwardingrule',
    'get_networkloadbalancer_forwardingrule_output',
]

@pulumi.output_type
class GetNetworkloadbalancerForwardingruleResult:
    """
    ...
    def health_checks(self) -> Sequence['outputs.GetNetworkloadbalancerForwardingruleHealthCheckResult']:
        """
    ...
    @property
    @pulumi.getter
    def targets(self) -> Sequence['outputs.GetNetworkloadbalancerForwardingruleTargetResult']:
        """
...
class AwaitableGetNetworkloadbalancerForwardingruleResult(GetNetworkloadbalancerForwardingruleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkloadbalancerForwardingruleResult(
...
def get_networkloadbalancer_forwardingrule(datacenter_id: Optional[str] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkloadbalancerForwardingruleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ionoscloud:index/getNetworkloadbalancerForwardingrule:getNetworkloadbalancerForwardingrule', __args__, opts=opts, typ=GetNetworkloadbalancerForwardingruleResult).value

    return AwaitableGetNetworkloadbalancerForwardingruleResult(
