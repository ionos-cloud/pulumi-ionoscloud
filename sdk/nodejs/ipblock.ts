...
/**
 * @deprecated ionoscloud.index/ipblock.Ipblock has been deprecated in favor of ionoscloud.compute/ipblock.IPBlock
 */
export class Ipblock extends pulumi.CustomResource {
    ...
    public readonly ipConsumers!: pulumi.Output<outputs.IpblockIpConsumer[]>;
