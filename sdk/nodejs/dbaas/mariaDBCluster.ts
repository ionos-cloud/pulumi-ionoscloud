...
export class MariaDBCluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly connections: pulumi.Output<outputs.dbaas.MariaDBClusterConnections>;
    /**
     ...
     */
    declare public readonly maintenanceWindow: pulumi.Output<outputs.dbaas.MariaDBClusterMaintenanceWindow>;
    /**
    ...
    constructor(name: string, argsOrState?: MariaDBClusterArgs | MariaDBClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["mariadbVersion"] = state?.mariadbVersion;
            ...
            if (args?.mariadbVersion === undefined && !opts.urn) {
            ...
            resourceInputs["mariadbVersion"] = args?.mariadbVersion;
