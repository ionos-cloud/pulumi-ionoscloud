...
export class IpsecTunnel extends pulumi.CustomResource {
     ...
     */
    declare public readonly esps: pulumi.Output<outputs.vpn.IpsecTunnelEsp[]>;
    /**
     ...
     */
    declare public readonly remoteHost: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: IpsecTunnelArgs | IpsecTunnelState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["cloudNetworkCidrs"] = state?.cloudNetworkCidrs;
            resourceInputs["description"] = state?.description;
            resourceInputs["esps"] = state?.esps;
            resourceInputs["gatewayId"] = state?.gatewayId;
            resourceInputs["ike"] = state?.ike;
