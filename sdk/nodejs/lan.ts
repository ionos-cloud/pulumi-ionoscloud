...
/**
 * @deprecated ionoscloud.index/lan.Lan has been deprecated in favor of ionoscloud.compute/lan.Lan
 */
export class Lan extends pulumi.CustomResource {
    ...
    public readonly ipFailovers!: pulumi.Output<outputs.LanIpFailover[]>;
    /**
