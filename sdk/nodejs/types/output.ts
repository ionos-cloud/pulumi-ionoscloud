...
export interface GetContractsContract {
     ...
     */
    resourceLimits: outputs.GetContractsContractResourceLimits;
    /**
     * The contract status.
     */
    status: string;
...
export interface GetContractsContractResourceLimits {
    /**
...
export interface GetDnsReverseRecordsReverseRecord {
    /**
...
export interface GetGpuServerCdrom {
    /**
...
export interface GetGpuServerNic {
    /**
    ...
    firewallRules: outputs.GetGpuServerNicFirewallRule[];
    firewallType: string;
    /**
     * ID of the server you want to search for.
     *
...
export interface GetGpuServerNicFirewallRule {
    icmpCode: number;
    icmpType: number;
    /**
     * ID of the server you want to search for.
...
export interface GetGpuServerVolume {
    /**
...
export interface GetKafkaUsersUser {
    /**
     * the ID of the user;
     */
    id: string;
...
export interface GpuServerNic {
     ...
     */
    firewall?: outputs.GpuServerNicFirewall;
    firewallActive?: boolean;
    firewallType: string;
    id: string;
    /**
...
export namespace compute {
    ...
    export interface GPUServerNic {
         ...
         * Firewall rules created in the server resource. The rules can also be created as separate resources outside the server resource
         */
        firewall?: outputs.compute.GPUServerNicFirewall;
        firewallActive?: boolean;
        firewallType: string;
        id: string;
        /**
    ...
    export interface GetGPUServerNic {
        ...
        dhcpv6?: boolean;
        firewallActive: boolean;
        firewallRules: outputs.compute.GetGPUServerNicFirewallRule[];
        firewallType: string;
        /**
         * ID of the server you want to search for.
         *
...
export namespace objectstorage {
    export interface BucketLifecycleConfigurationRule {
         ...
         * A filter.
         */
        filter?: outputs.objectstorage.BucketLifecycleConfigurationRuleFilter;
        /**
