...
export class Crossconnect extends pulumi.CustomResource {
     ...
     */
    declare public readonly connectableDatacenters: pulumi.Output<outputs.compute.CrossconnectConnectableDatacenter[]>;
    /**
     ...
     */
    declare public readonly peers: pulumi.Output<outputs.compute.CrossconnectPeer[]>;
