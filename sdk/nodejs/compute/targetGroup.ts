...
export class TargetGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ionoscloud:compute/targetGroup:TargetGroup';
     ...
     */
    declare public readonly healthCheck: pulumi.Output<outputs.compute.TargetGroupHealthCheck>;
    /**
     * Http health check attributes for Target Group
     */
    declare public readonly httpHealthCheck: pulumi.Output<outputs.compute.TargetGroupHttpHealthCheck>;
    /**
     ...
     */
    declare public readonly targets: pulumi.Output<outputs.compute.TargetGroupTarget[]>;
    ...
    constructor(name: string, argsOrState?: TargetGroupArgs | TargetGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.protocolVersion === undefined && !opts.urn) {
