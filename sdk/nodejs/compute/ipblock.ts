...
export class IPBlock extends pulumi.CustomResource {
     ...
     */
    declare public readonly ipConsumers: pulumi.Output<outputs.compute.IPBlockIpConsumer[]>;
    /**
    ...
    constructor(name: string, argsOrState?: IPBlockArgs | IPBlockState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ipConsumers"] = state?.ipConsumers;
            ...
            resourceInputs["ipConsumers"] = args?.ipConsumers;
