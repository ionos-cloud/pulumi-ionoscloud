...
export class CubeServer extends pulumi.CustomResource {
     ...
     * See the Nic section.
     */
    declare public readonly nic: pulumi.Output<outputs.compute.CubeServerNic>;
    /**
     ...
     */
    declare public readonly volume: pulumi.Output<outputs.compute.CubeServerVolume>;
    ...
    constructor(name: string, argsOrState?: CubeServerArgs | CubeServerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.nic === undefined && !opts.urn) {
...
export interface CubeServerState {
     ...
     * See the Nic section.
     */
    nic?: pulumi.Input<inputs.compute.CubeServerNic | undefined>;
    /**
     * The associated IP address.
     */
     ...
     * See the Volume section.
     */
    volume?: pulumi.Input<inputs.compute.CubeServerVolume | undefined>;
}
