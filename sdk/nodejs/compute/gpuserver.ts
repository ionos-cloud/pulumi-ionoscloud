...
export class GPUServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ionoscloud:compute/gPUServer:GPUServer';
     ...
     * See the Nic section.
     */
    declare public readonly nic: pulumi.Output<outputs.compute.GPUServerNic | undefined>;
    /**
     ...
     */
    declare public readonly volume: pulumi.Output<outputs.compute.GPUServerVolume>;
    ...
    constructor(name: string, argsOrState?: GPUServerArgs | GPUServerState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "ionoscloud:index/gpuServer:GpuServer" }] };
...
export interface GPUServerState {
     ...
     * See the Nic section.
     */
    nic?: pulumi.Input<inputs.compute.GPUServerNic | undefined>;
    /**
     * The associated IP address.
     */
     ...
     * See the Volume section.
     */
    volume?: pulumi.Input<inputs.compute.GPUServerVolume | undefined>;
}
...
export interface GPUServerArgs {
     ...
     * See the Volume section.
     */
    volume: pulumi.Input<inputs.compute.GPUServerVolume>;
}
