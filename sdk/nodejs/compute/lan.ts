...
export class Lan extends pulumi.CustomResource {
     ...
     */
    declare public readonly ipFailovers: pulumi.Output<outputs.compute.LanIpFailover[]>;
    /**
     ...
     */
    declare public /*out*/ readonly ipv4CidrBlock: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly pcc: pulumi.Output<string | undefined>;
    /**
