...
/**
 * @deprecated ionoscloud.index/mongocluster.MongoCluster has been deprecated in favor of ionoscloud.dbaas/mongocluster.MongoCluster
 */
export class MongoCluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MongoClusterState, opts?: pulumi.CustomResourceOptions): MongoCluster {
        pulumi.log.warn("MongoCluster is deprecated: ionoscloud.index/mongocluster.MongoCluster has been deprecated in favor of ionoscloud.dbaas/mongocluster.MongoCluster")
     ...
     * analysis.
     */
    public readonly biConnector!: pulumi.Output<outputs.MongoClusterBiConnector>;
    /**
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<outputs.MongoClusterMaintenanceWindow>;
    /**
