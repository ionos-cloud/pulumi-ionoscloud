...
export function getRegion(args: GetRegionArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionResult> {
    ...
    return pulumi.runtime.invoke("ionoscloud:objectstoragemanagement/getRegion:getRegion", {
        "id": args.id,
    }, opts);
}
...
export interface GetRegionResult {
     ...
     */
    readonly capability: outputs.objectstoragemanagement.GetRegionCapability;
    /**
...
export function getRegionOutput(args: GetRegionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("ionoscloud:objectstoragemanagement/getRegion:getRegion", {
        "id": args.id,
    }, opts);
}
