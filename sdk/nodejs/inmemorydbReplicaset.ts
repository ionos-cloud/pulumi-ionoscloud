...
/**
 * @deprecated ionoscloud.index/inmemorydbreplicaset.InmemorydbReplicaset has been deprecated in favor of ionoscloud.dbaas/inmemorydbreplicaset.InMemoryDBReplicaSet
 */
export class InmemorydbReplicaset extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InmemorydbReplicasetState, opts?: pulumi.CustomResourceOptions): InmemorydbReplicaset {
        pulumi.log.warn("InmemorydbReplicaset is deprecated: ionoscloud.index/inmemorydbreplicaset.InmemorydbReplicaset has been deprecated in favor of ionoscloud.dbaas/inmemorydbreplicaset.InMemoryDBReplicaSet")
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<outputs.InmemorydbReplicasetMaintenanceWindow>;
    /**
