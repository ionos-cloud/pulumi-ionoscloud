...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "ionoscloud:dsaas/cluster:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "ionoscloud:dsaas/nodePool:NodePool":
...
pulumi.runtime.registerResourceModule("ionoscloud", "dsaas/cluster", _module)
pulumi.runtime.registerResourceModule("ionoscloud", "dsaas/nodePool", _module)
