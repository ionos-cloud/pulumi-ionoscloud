 ...
 * ## Import
 *
 * Resource Dataplatform Cluster can be imported using the `clusterId`, e.g.
 *
 * ```sh
...
export class Cluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly lans: pulumi.Output<outputs.dsaas.ClusterLan[] | undefined>;
    /**
     * Starting time of a weekly 4 hour-long window, during which maintenance might occur in hh:mm:ss format
     */
    declare public readonly maintenanceWindows: pulumi.Output<outputs.dsaas.ClusterMaintenanceWindow[]>;
    /**
