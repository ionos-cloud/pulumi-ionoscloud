...
/**
 * @deprecated ionoscloud.index/pgcluster.PgCluster has been deprecated in favor of ionoscloud.dbaas/psqlcluster.PSQLCluster
 */
export class PgCluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PgClusterState, opts?: pulumi.CustomResourceOptions): PgCluster {
        pulumi.log.warn("PgCluster is deprecated: ionoscloud.index/pgcluster.PgCluster has been deprecated in favor of ionoscloud.dbaas/psqlcluster.PSQLCluster")
     ...
     */
    public readonly connectionPooler!: pulumi.Output<outputs.PgClusterConnectionPooler>;
    /**
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<outputs.PgClusterMaintenanceWindow>;
    /**
    ...
    constructor(name: string, argsOrState?: PgClusterArgs | PgClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PgCluster.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface PgClusterState {
     ...
     * Configuration options for the connection pooler
     */
    connectionPooler?: pulumi.Input<inputs.PgClusterConnectionPooler>;
    /**
     * Details about the network connection for your cluster.
     */
