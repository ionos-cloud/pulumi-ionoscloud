...
export function getApigateway(args?: GetApigatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetApigatewayResult> {
    ...
    return pulumi.runtime.invoke("ionoscloud:apigateway/getApigateway:getApigateway", {
        "id": args.id,
        "name": args.name,
...
export interface GetApigatewayResult {
    readonly customDomains: outputs.apigateway.GetApigatewayCustomDomain[];
    readonly id: string;
...
export function getApigatewayOutput(args?: GetApigatewayOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApigatewayResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("ionoscloud:apigateway/getApigateway:getApigateway", {
        "id": args.id,
        "name": args.name,
        "partialMatch": args.partialMatch,
    }, opts);
