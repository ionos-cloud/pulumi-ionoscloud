 ...
 * ```
 *
 * The resource can be imported using the `gatewayId`, for example:
 *
 * ```sh
...
export class Apigateway extends pulumi.CustomResource {
     ...
     */
    declare public readonly customDomains: pulumi.Output<outputs.apigateway.ApigatewayCustomDomain[] | undefined>;
    /**
