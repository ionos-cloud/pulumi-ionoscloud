 ...
 * ```
 */
export function getContainerRegistryTokenOutput(args: GetContainerRegistryTokenOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerRegistryTokenResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
