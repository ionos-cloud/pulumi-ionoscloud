 ...
 * ```
 */
export function getVpnWireguardGatewayOutput(args: GetVpnWireguardGatewayOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVpnWireguardGatewayResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
