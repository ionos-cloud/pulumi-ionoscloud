...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ionoscloud:kafka/cluster:Cluster';
     ...
     */
    declare public /*out*/ readonly brokerAddresses: pulumi.Output<string[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ClusterArgs | ClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["brokerAddresses"] = state?.brokerAddresses;
