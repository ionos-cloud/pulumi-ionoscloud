...
export class Pipeline extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly grafanaEndpoint: pulumi.Output<string>;
    /**
     * [string] The HTTP endpoint of the monitoring instance.
     */
    declare public /*out*/ readonly httpEndpoint: pulumi.Output<string>;
    /**
    ...
    declare public readonly timeouts: pulumi.Output<outputs.monitoring.PipelineTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PipelineArgs | PipelineState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["grafanaEndpoint"] = state?.grafanaEndpoint;
