...
export class PublicAccessBlock extends pulumi.CustomResource {
     ...
     */
    declare public readonly blockPublicAcls: pulumi.Output<boolean>;
    /**
     * [bool] Blocks public access to the bucket via bucket policies. Bucket policies that grant public access will not be allowed.
     */
    declare public readonly blockPublicPolicy: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly ignorePublicAcls: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly restrictPublicBuckets: pulumi.Output<boolean>;
