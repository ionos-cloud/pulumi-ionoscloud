...
export function getObject(args: GetObjectArgs, opts?: pulumi.InvokeOptions): Promise<GetObjectResult> {
    ...
    return pulumi.runtime.invoke("ionoscloud:objectstorage/getObject:getObject", {
        "bucket": args.bucket,
        "key": args.key,
        "range": args.range,
...
export function getObjectOutput(args: GetObjectOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetObjectResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("ionoscloud:objectstorage/getObject:getObject", {
        "bucket": args.bucket,
        "key": args.key,
        "range": args.range,
        "versionId": args.versionId,
