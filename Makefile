...
bin/$(PROVIDER)-v$(VERSION_GENERIC)-%.tar.gz:
	@mkdir -p dist
	@# $< is the last dependency (the binary path from above) e.g. bin/linux-amd64/pulumi-resource-ionoscloud
	@# $@ is the current target e.g. bin/pulumi-resource-ionoscloud-v1.2.3-linux-amd64.tar.gz
